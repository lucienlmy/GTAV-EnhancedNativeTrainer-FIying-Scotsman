...
namespace PLAYER
{
	...
	static void SET_PLAYER_WANTED_CENTRE_POSITION(Ped* player, float x, BOOL y, BOOL z) { invoke<Void>(0x520E541A97A13354, player, x, y, z); } // 0x520E541A97A13354 0xF261633A
	...
	static void REPORT_POLICE_SPOTTED_PLAYER(Player player) { invoke<Void>(0xDC64D2C53493ED12, player); } // 0xDC64D2C53493ED12 0xD15C4B1C
	...
	//static BOOL _SET_ACHIEVEMENT_PROGRESSION(int achievement, int progress) { return invoke<BOOL>(0xC2AFFFDABBDC2C5C, achievement, progress); } // 0xC2AFFFDABBDC2C5C
	static Cam _GET_ACHIEVEMENT_PROGRESSION(Any p0) { return invoke<Cam>(0x1C186837D0619335, p0); } // 0x1C186837D0619335
	...
	static void SET_PLAYER_TARGET_LEVEL(int targetLevel) { invoke<Void>(0x5702B917B99DB1CD, targetLevel); } // 0x5702B917B99DB1CD
	...
	static void SPECIAL_ABILITY_CHARGE_ON_MISSION_FAILED(Player player) { invoke<Void>(0xC9A763D8FE87436A, player); } // 0xC9A763D8FE87436A 0x4136829A
	...
	static void SET_AUTO_GIVE_SCUBA_GEAR_WHEN_EXIT_VEHICLE(Player player, BOOL toggle) { invoke<Void>(0xD2B315B6689D537D, player, toggle); } // 0xD2B315B6689D537D 0xA25D767E
	...
	static BOOL IS_PLAYER_BATTLE_AWARE(Player player) { return invoke<BOOL>(0x38D28DA81E4E9BF9, player); } // 0x38D28DA81E4E9BF9 0x013B4F72
	...
	static void EXTEND_WORLD_BOUNDARY_FOR_PLAYER(float x, float y, float z) { invoke<Void>(0x5006D96C995A5827, x, y, z); } // 0x5006D96C995A5827
	...
	static void SET_PLAYER_LEAVE_PED_BEHIND(Player player, BOOL toggle) { invoke<Void>(0xFF300C7649724A0B, player, toggle); } // 0xFF300C7649724A0B 0xAD8383FA
	...
	static void SET_PLAYER_BLUETOOTH_STATE(BOOL player, ScrHandle state) { invoke<Void>(0x5DC40A8869C22141, player, state); } // 0x5DC40A8869C22141
	static BOOL IS_PLAYER_BLUETOOTH_ENABLE(Player player) { return invoke<BOOL>(0x65FAEE425DE637B0, player); } // 0x65FAEE425DE637B0
	static void _0x5501B7A5CDB79D37(Player player) { invoke<Void>(0x5501B7A5CDB79D37, player); } // 0x5501B7A5CDB79D37
	static int GET_PLAYER_FAKE_WANTED_LEVEL(Player player) { return invoke<int>(0x56105E599CAB0EFA, player); } // 0x56105E599CAB0EFA
}
...
namespace ENTITY
{
	...
	static float _GET_ENTITY_ANIM_DURATION(char* animDict, char* animName) { return invoke<float>(0xFEDDF04D62B8D790, animDict, animName); } // 0xFEDDF04D62B8D790
	...
	static Vector3 _GET_ENTITY_BONE_COORDS(Entity entity, int boneIndex) { return invoke<Vector3>(0x44A8FCB8ED227738, entity, boneIndex); } // 0x44A8FCB8ED227738
	...
	static BOOL _IS_ENTITY_COLLISON_DISABLED(Entity entity) { return invoke<BOOL>(0xCCF1E97BEFDAE480, entity); } // 0xCCF1E97BEFDAE480
	static void SET_ENTITY_COMPLETELY_DISABLE_COLLISION(Entity entity, BOOL toggle, BOOL keepPhysics) { invoke<Void>(0x9EBC85ED0FFFE51C, entity, toggle, keepPhysics); } // 0x9EBC85ED0FFFE51C
	...
	static void SET_CAN_AUTO_VAULT_ON_ENTITY(Entity entity, BOOL p1) { invoke<Void>(0xE12ABE5E3A389A6C, entity, p1); } // 0xE12ABE5E3A389A6C 0x44767B31
	static void SET_CAN_CLIMB_ON_ENTITY(Entity entity, BOOL p1) { invoke<Void>(0xA80AE305E0A3044F, entity, p1); } // 0xA80AE305E0A3044F 0xE224A6A5
...
namespace PED
{
	static Ped CREATE_PED(int pedType, Hash modelHash, float x, float y, float z, float heading, BOOL networkHandle, BOOL p7) { return invoke<Ped>(0xD49F9B0955C367DE, pedType, modelHash, x, y, z, heading, networkHandle, p7); } // 0xD49F9B0955C367DE 0x0389EF71
	static void DELETE_PED(Ped* ped) { invoke<Void>(0x9614299DCB53E54B, ped); } // 0x9614299DCB53E54B 0x13EFB9A0
	static Ped CLONE_PED(Ped ped, float heading, BOOL networkHandle, BOOL p3) { return invoke<Ped>(0xEF29A16337FACADB, ped, heading, networkHandle, p3); } // 0xEF29A16337FACADB 0x8C8A8D6E
	...
	static Ped CREATE_PED_INSIDE_VEHICLE(Vehicle vehicle, int pedType, Hash modelHash, int seat, BOOL networkHandle, BOOL p5) { return invoke<Ped>(0x7DD959874C1FD534, vehicle, pedType, modelHash, seat, networkHandle, p5); } // 0x7DD959874C1FD534 0x3000F092
	...
	static void _0x061CB768363D6424(Ped ped, BOOL toggle) { invoke<Void>(0x061CB768363D6424, ped, toggle); } // 0x061CB768363D6424 0x7DA12905
	...
	static BOOL _IS_PED_OPENING_A_DOOR(Ped ped) { return invoke<BOOL>(0x26AF0E8E30BD2A2C, ped); } // 0x26AF0E8E30BD2A2C
	...
	static Entity _CREATE_PARACHUTE_OBJECT(Ped ped, BOOL p1, BOOL p2) { return invoke<Entity>(0x8C4F3BF23B6237DB, ped, p1, p2); } // 0x8C4F3BF23B6237DB
	...
	static void SET_PED_HIGHLY_PERCEPTIVE(Ped ped, BOOL toggle) { invoke<Void>(0x52D59AB61DDC05DD, ped, toggle); } // 0x52D59AB61DDC05DD 0x9A2180FF
	...
	static BOOL IS_PED_IN_HIGH_COVER(Ped ped) { return invoke<BOOL>(0x6A03BF943D767C93, ped); } // 0x6A03BF943D767C93
	...
	static Any _GET_TIME_OF_LAST_PED_WEAPON_DAMAGE(Ped ped, Any weaponHash) { return invoke<Any>(0x36B77BB84687C318, ped, weaponHash); } // 0x36B77BB84687C318
	...
	static void SET_PED_VEHICLE_FORCED_SEAT_USAGE(Ped ped, Vehicle vehicle, int seatIndex, int flags) { invoke<Void>(0x952F06BEECD775CC, ped, vehicle, seatIndex, flags); } // 0x952F06BEECD775CC
	static void CLEAR_ALL_PED_VEHICLE_FORCED_SEAT_USAGE(Ped ped) { invoke<Void>(0xE6CA85E7259CE16B, ped); } // 0xE6CA85E7259CE16B
	...
	static void _SET_PED_COVER_CLIPSET_OVERRIDE(Ped ped, char* p1) { invoke<Void>(0x9DBA107B4937F809, ped, p1); } // 0x9DBA107B4937F809
	static void _CLEAR_PED_COVER_CLIPSET_OVERRIDE(Any p0) { invoke<Void>(0xC79196DCB36F6121, p0); } // 0xC79196DCB36F6121
	...
	static void _GET_PED_HAIR_RGB_COLOR(int hairColorIndex, int* outR, int* outG, int* outB) { invoke<Void>(0x4852FC386E2E1BB5, hairColorIndex, outR, outG, outB); } // 0x4852FC386E2E1BB5
	static void _GET_PED_MAKEUP_RGB_COLOR(int makeupColorIndex, int* outR, int* outG, int* outB) { invoke<Void>(0x013E5CFC38CD5387, makeupColorIndex, outR, outG, outB); } // 0x013E5CFC38CD5387
	static BOOL _IS_PED_HAIR_COLOR_VALID_2(int colorID) { return invoke<BOOL>(0xED6D8E27A43B8CDE, colorID); } // 0xED6D8E27A43B8CDE
	static int _0xEA9960D07DADCF10(Any p0) { return invoke<int>(0xEA9960D07DADCF10, p0); } // 0xEA9960D07DADCF10
	static BOOL _IS_PED_LIPSTICK_COLOR_VALID_2(int colorID) { return invoke<BOOL>(0x3E802F11FBE27674, colorID); } // 0x3E802F11FBE27674
	static BOOL _IS_PED_BLUSH_COLOR_VALID_2(int colorID) { return invoke<BOOL>(0xF41B5D290C99A3D6, colorID); } // 0xF41B5D290C99A3D6
	...
	static void SET_HEAD_BLEND_PALETTE_COLOR(Ped ped, int r, int g, int b, int id) { invoke<Void>(0xCC9682B8951C5229, ped, r, g, b, id); } // 0xCC9682B8951C5229 0x57E5B3F9
	static void DISABLE_HEAD_BLEND_PALETTE_COLOR(Ped ped) { invoke<Void>(0xA21C118553BBDF02, ped); } // 0xA21C118553BBDF02 0xC6F36292
	...
	static Any SET_PED_PRELOAD_VARIATION_DATA(Ped ped, int p1, int drawableId, int textureId) { return invoke<Any>(0x39D55A620FCB6A3A, ped, p1, drawableId, textureId); } // 0x39D55A620FCB6A3A 0x45F3BDFB
	static BOOL HAS_PED_PRELOAD_VARIATION_DATA_FINISHED(Ped ped) { return invoke<BOOL>(0x66680A92700F43DF, ped); } // 0x66680A92700F43DF 0xC6517D52
	static void RELEASE_PED_PRELOAD_VARIATION_DATA(Ped ped) { invoke<Void>(0x5AAB586FFEC0FD96, ped); } // 0x5AAB586FFEC0FD96 0x6435F67F
	...
	static BOOL HAS_PED_PRELOAD_PROP_DATA_FINISHED(Ped ped) { return invoke<BOOL>(0x784002A632822099, ped); } // 0x784002A632822099 0x3B0CA391
	static void RELEASE_PED_PRELOAD_PROP_DATA(Ped ped) { invoke<Void>(0xF79F9DEF0AADE61A, ped); } // 0xF79F9DEF0AADE61A 0xFD103BA7
	...
	static void DROP_AMBIENT_PROP(Ped ped) { invoke<Void>(0xAFF4710E2A0A6C12, ped); } // 0xAFF4710E2A0A6C12
	...
	static void CLEAR_PED_PARACHUTE_PACK_VARIATION(Ped ped) { invoke<Void>(0x1280804F7CFD2D6C, ped); } // 0x1280804F7CFD2D6C 0x7BCD8991
	static void _SET_PED_SCUBA_GEAR_VARIATION(Ped ped) { invoke<Void>(0x36C6984C3ED0C911, ped); } // 0x36C6984C3ED0C911
	static void CLEAR_PED_SCUBA_GEAR_VARIATION(Ped ped) { invoke<Void>(0xB50EB4CCB29704AC, ped); } // 0xB50EB4CCB29704AC 0x080275EE
	...
	static void SET_DRIVER_RACING_MODIFIER(Ped driver, float modifier) { invoke<Void>(0xDED5AF5A0EA4B297, driver, modifier); } // 0xDED5AF5A0EA4B297 0x6D55B3B3
	...
	static BOOL IS_PED_RUNNING_MELEE_TASK(Ped ped) { return invoke<BOOL>(0xD1871251F3B5ACD7, ped); } // 0xD1871251F3B5ACD7
	...
	static void SET_PED_DEFENSIVE_SPHERE_ATTACHED_TO_VEHICLE(Ped ped, Vehicle target, float xOffset, float yOffset, float zOffset, float radius, BOOL p6) { invoke<Void>(0xE4723DB6E736CCFF, ped, target, xOffset, yOffset, zOffset, radius, p6); } // 0xE4723DB6E736CCFF 0x4763B2C6
	...
	static BOOL IS_PED_DEFENSIVE_AREA_ACTIVE(Ped ped, BOOL p1) { return invoke<BOOL>(0xBA63D9FE45412247, ped, p1); } // 0xBA63D9FE45412247
	...
	static void CLEAR_PED_ENV_DIRT(Ped ped) { invoke<Void>(0x6585D955A68452A5, ped); } // 0x6585D955A68452A5 0xA993915F
	...
	static Any SET_PED_PANIC_EXIT_SCENARIO(Ped ped, float x, float y, float z) { return invoke<Any>(0xFE07FF6495D52E2A, ped, x, y, z); } // 0xFE07FF6495D52E2A 0x59DE73AC
	...
	static void SET_PED_CAN_TORSO_REACT_IK(Ped ped, BOOL p1) { invoke<Void>(0xF5846EDB26A98A24, ped, p1); } // 0xF5846EDB26A98A24 0x7B0040A8
	static void SET_PED_CAN_TORSO_VEHICLE_IK(Ped ped, BOOL p1) { invoke<Void>(0x6647C5F6F5792496, ped, p1); } // 0x6647C5F6F5792496 0x0FDA62DE
	...
	static void SET_PED_CLOTH_PACKAGE_INDEX(Ped ped, int p1) { invoke<Void>(0x78C4E9961DB3EB5B, ped, p1); } // 0x78C4E9961DB3EB5B 0xFC942D7C
	...
	static void _BLOCK_PED_DEAD_BODY_SHOCKING_EVENTS(Ped ped, BOOL toggle) { invoke<Void>(0xE43A13C9E4CCCBCF, ped, toggle); } // 0xE43A13C9E4CCCBCF 0xFF1F6AEB
	...
	static BOOL IS_PED_PERFORMING_MELEE_ACTION(Ped ped) { return invoke<BOOL>(0xDCCA191DF9980FD7, ped); } // 0xDCCA191DF9980FD7 0x139C0875
	...
	static BOOL IS_PED_PERFORMING_DEPENDENT_COMBO_LIMIT(Ped ped) { return invoke<BOOL>(0xEBD0EDBA5BE957CF, ped); } // 0xEBD0EDBA5BE957CF 0x9BE7C860
	...
	static BOOL WAS_PED_KNOCKED_OUT(Ped ped) { return invoke<BOOL>(0x61767F73EACEED21, ped); } // 0x61767F73EACEED21 0x3993092B
	...
	static void SET_PED_INCREASED_AVOIDANCE_RADIUS(Ped ped) { invoke<Void>(0x570389D1C3DE3C6B, ped); } // 0x570389D1C3DE3C6B 0x59C52BE6
	static void SET_PED_BLOCKS_PATHING_WHEN_DEAD(Ped ped, BOOL p1) { invoke<Void>(0x576594E8D64375E2, ped, p1); } // 0x576594E8D64375E2 0x1D87DDC1
	...
	static BOOL IS_PED_HEADING_TOWARDS_POSITION(Ped ped, float x, float y, float z, float p4) { return invoke<BOOL>(0xFCF37A457CB96DC0, ped, x, y, z, p4); } // 0xFCF37A457CB96DC0 0x45037B9B
	static void REQUEST_PED_VISIBILITY_TRACKING(Ped ped) { invoke<Void>(0x7D7A2E43E74E2EB8, ped); } // 0x7D7A2E43E74E2EB8 0x840D24D3
	...
	static BOOL CAN_PED_SEE_HATED_PED(Ped ped1, Ped ped2) { return invoke<BOOL>(0x6CD5A433374D4CFB, ped1, ped2); } // 0x6CD5A433374D4CFB 0x74A0F291
	...
	static void SET_PED_ENVEFF_COLOR_MODULATOR(Ped ped, int r, int g, int b) { invoke<Void>(0xD69411AA0CEBF9E9, ped, r, g, b); } // 0xD69411AA0CEBF9E9 0x87A0C174
	...
	static BOOL IS_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(int sceneID) { return invoke<BOOL>(0x7F2F4F13AC5257EF, sceneID); } // 0x7F2F4F13AC5257EF 0x72CF2514
	...
	static BOOL _HAS_STREAMED_PED_ASSETS_LOADED(Ped ped) { return invoke<BOOL>(0x7350823473013C02, ped); } // 0x7350823473013C02 0xF9FB4B71
	...
	static void SET_MOVEMENT_MODE_OVERRIDE(Ped ped, char* name) { invoke<Void>(0x781DE8FA214E87D2, ped, name); } // 0x781DE8FA214E87D2
	...
	static Any REGISTER_PEDHEADSHOT_TRANSPARENT(Ped ped) { return invoke<Any>(0x953563CE563143AF, ped); } // 0x953563CE563143AF 0x4DD03628
	...
	static BOOL REQUEST_PEDHEADSHOT_IMG_UPLOAD(int id) { return invoke<BOOL>(0xF0DAEF2F545BEE25, id); } // 0xF0DAEF2F545BEE25 0x10F2C023
	static void RELEASE_PEDHEADSHOT_IMG_UPLOAD(int id) { invoke<Void>(0x5D517B27CF6ECD04, id); } // 0x5D517B27CF6ECD04 0x0DBB2FA7
	static Any IS_PEDHEADSHOT_IMG_UPLOAD_AVAILABLE() { return invoke<Any>(0xEBB376779A760AA8); } // 0xEBB376779A760AA8 0x810158F8
	static Any HAS_PEDHEADSHOT_IMG_UPLOAD_FAILED() { return invoke<Any>(0x876928DDDFCCC9CD); } // 0x876928DDDFCCC9CD 0x05023F8F
	static Any HAS_PEDHEADSHOT_IMG_UPLOAD_SUCCEEDED() { return invoke<Any>(0xE8A169E666CBC541); } // 0xE8A169E666CBC541 0xAA39FD6C
	static void SET_PED_HEATSCALE_OVERRIDE(Any p0, Any p1) { invoke<Void>(0xC1F6EBF9A3D55538, p0, p1); } // 0xC1F6EBF9A3D55538 0xEF9142DB
	static void DISABLE_PED_HEATSCALE_OVERRIDE(Ped ped) { invoke<Void>(0x600048C60D5C2C51, ped); } // 0x600048C60D5C2C51 0x0688DE64
	...
	static void SET_FORCE_FOOTSTEP_UPDATE(Ped ped, BOOL toggle) { invoke<Void>(0x129466ED55140F8D, ped, toggle); } // 0x129466ED55140F8D 0x37DBC2AD
	static void SET_FORCE_STEP_TYPE(Ped ped, BOOL p1, int type, int p3) { invoke<Void>(0xCB968B53FC7F916D, ped, p1, type, p3); } // 0xCB968B53FC7F916D 0xC0F1BC91
	static BOOL IS_ANY_HOSTILE_PED_NEAR_POINT(Ped ped, float x, float y, float z, float range) { return invoke<BOOL>(0x68772DB2B2526F9F, ped, x, y, z, range); } // 0x68772DB2B2526F9F 0x1A464167
	...
	static void SET_POP_CONTROL_SPHERE_THIS_FRAME(float x, float y, float z, float p3, float p4) { invoke<Void>(0xD8C3BE3EE94CAF2D, x, y, z, p3, p4); } // 0xD8C3BE3EE94CAF2D 0x4BBE5E2C
...
namespace VEHICLE
{
	...
	static BOOL IS_SEAT_WARP_ONLY(Vehicle vehicle, BOOL seatIndex) { return invoke<BOOL>(0xF7F203E31F96F6A1, vehicle, seatIndex); } // 0xF7F203E31F96F6A1 0x769E5CF2
	static BOOL IS_TURRET_SEAT(Vehicle vehicle, Any seatIndex) { return invoke<BOOL>(0xE33FFA906CE74880, vehicle, seatIndex); } // 0xE33FFA906CE74880
	...
	static Any HAS_VEHICLE_PHONE_EXPLOSIVE_DEVICE() { return invoke<Any>(0x6ADAABD3068C5235); } // 0x6ADAABD3068C5235 0xA4E69134
	...
	static void FORCE_SUBMARINE_SURFACE_MODE(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x33506883545AC0DF, vehicle, toggle); } // 0x33506883545AC0DF 0x54E9EE75
	...
	static void _SET_BOAT_FROZEN_WHEN_ANCHORED(Vehicle vehicle, BOOL toggle) { invoke<Void>(0xE3EBAAE484798530, vehicle, toggle); } // 0xE3EBAAE484798530 0x0ED84792
	static void _SET_FORCED_BOAT_LOCATION_WHEN_ANCHORED(Vehicle vehicle, BOOL toggle) { invoke<Void>(0xB28B1FE5BFADD7F5, vehicle, toggle); } // 0xB28B1FE5BFADD7F5 0xA739012A
	static void _SET_BOAT_ANCHOR_BUOYANCY_COEFFICIENT(Vehicle vehicle, float value) { invoke<Void>(0xE842A9398079BD82, vehicle, value); } // 0xE842A9398079BD82 0x66FA450C
	static void SET_BOAT_SINKS_WHEN_WRECKED(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x8F719973E1445BA2, vehicle, toggle); } // 0x8F719973E1445BA2 0x35614622
	...
	static void SET_FORKLIFT_FORK_HEIGHT(Vehicle vehicle, float height) { invoke<Void>(0x37EBBF3117BD6A25, vehicle, height); } // 0x37EBBF3117BD6A25 0x943A6CFC
	...
	static Vehicle _GET_VEHICLE_ATTACHED_TO_ENTITY(Entity entity) { return invoke<Vehicle>(0x375E7FC44F21C8AB, entity); } // 0x375E7FC44F21C8AB 0x70DD5E25
	static BOOL _IS_HANDLER_FRAME_ABOVE_CONTAINER(Vehicle vehicle, Entity container) { return invoke<BOOL>(0x89D630CF5EA96D23, vehicle, container); } // 0x89D630CF5EA96D23 0xFBF5536A
	...
	static void DETACH_CONTAINER_FROM_HANDLER_FRAME(Vehicle vehicle) { invoke<Void>(0x7C0043FDFF6436BC, vehicle); } // 0x7C0043FDFF6436BC 0x0F11D01F
	...
	static void SET_BOAT_DISABLE_AVOIDANCE(Vehicle vehicle, BOOL p1) { invoke<Void>(0x0A6A279F3AA4FD70, vehicle, p1); } // 0x0A6A279F3AA4FD70 0x4C0E4031
	static BOOL IS_HELI_LANDING_AREA_BLOCKED(Vehicle vehicle) { return invoke<BOOL>(0x634148744F385576, vehicle); } // 0x634148744F385576 0x6346B7CC
	static void SET_HELI_TURBULENCE_SCALAR(Vehicle vehicle, float p1) { invoke<Void>(0xE6F13851780394DA, vehicle, p1); } // 0xE6F13851780394DA 0xCCB41A55
	...
	static void _SET_VEHICLE_USE_PLAYER_LIGHT_SETTINGS(Vehicle vehicle, BOOL p1) { invoke<Void>(0xC45C27EF50F36ADC, vehicle, p1); } // 0xC45C27EF50F36ADC 0x4221E435
	...
	static void ATTACH_VEHICLE_ON_TO_TRAILER(Vehicle vehicle, Vehicle trailer, float offsetX, float offsetY, float offsetZ, float coordsX, float coordsY, float coordsZ, float rotationX, float rotationY, float rotationZ, float disableColls) { invoke<Void>(0x16B5E274BDE402F8, vehicle, trailer, offsetX, offsetY, offsetZ, coordsX, coordsY, coordsZ, rotationX, rotationY, rotationZ, disableColls); } // 0x16B5E274BDE402F8 0x12AC1A16
	static void STABILISE_ENTITY_ATTACHED_TO_HELI(Vehicle vehicle, Entity entity, float p2) { invoke<Void>(0x374706271354CB18, vehicle, entity, p2); } // 0x374706271354CB18 0x40C4763F
	...
	static void SET_TRAILER_INVERSE_MASS_SCALE(Vehicle vehicle, float p1) { invoke<Void>(0x2A8F319B392E7B3F, vehicle, p1); } // 0x2A8F319B392E7B3F 0xE74E85CE
	static void SET_TRAILER_LEGS_RAISED(Vehicle vehicle) { invoke<Void>(0x95CF53B3D687F9FA, vehicle); } // 0x95CF53B3D687F9FA 0x06C47A6F
	...
	static void SET_TRAIN_TRACK_SPAWN_FREQUENCY(int trackIndex, int frequency) { invoke<Void>(0x21973BBF8D17EDFA, trackIndex, frequency); } // 0x21973BBF8D17EDFA 0xD5774FB7
	...
	static Vector3 GET_POSITION_OF_VEHICLE_RECORDING_ID_AT_TIME(int id, float time) { return invoke<Vector3>(0x92523B76657A517D, id, time); } // 0x92523B76657A517D 0xF31973BB
	...
	static Vector3 GET_ROTATION_OF_VEHICLE_RECORDING_ID_AT_TIME(int id, float time) { return invoke<Vector3>(0xF0F2103EFAF8CBA7, id, time); } // 0xF0F2103EFAF8CBA7 0x4D1C15C2
	...
	static void _SET_VEHICLE_LIGHTS_CAN_BE_VISIBLY_DAMAGED(Vehicle vehicle, BOOL p1) { invoke<Void>(0x1AA8A837D2169D94, vehicle, p1); } // 0x1AA8A837D2169D94 0x009AB49E
	...
	static void _SET_VEHICLE_CAN_ENGINE_OPERATE_ON_FIRE(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x206BC5DC9D1AC70A, vehicle, toggle); } // 0x206BC5DC9D1AC70A
	static void SET_VEHICLE_CAN_LEAK_OIL(Vehicle vehicle, BOOL p1) { invoke<Void>(0x51BB2D88D31A914B, vehicle, p1); } // 0x51BB2D88D31A914B 0x88F0F7E7
	static void SET_VEHICLE_CAN_LEAK_PETROL(Vehicle vehicle, BOOL p1) { invoke<Void>(0x192547247864DFDD, vehicle, p1); } // 0x192547247864DFDD 0x90D6EE57
	...
	static void SET_DISABLE_VEHICLE_ENGINE_FIRES(Vehicle vehicle, BOOL p1) { invoke<Void>(0x91A0BD635321F145, vehicle, p1); } // 0x91A0BD635321F145 0x1784BA1A
	...
	static void SET_DISABLE_PRETEND_OCCUPANTS(Vehicle vehicle, BOOL p1) { invoke<Void>(0x25367DE49D64CF16, vehicle, p1); } // 0x25367DE49D64CF16 0xCBD98BA1
	...
	static void SET_VEHICLE_DISABLE_TOWING(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x2B6747FAA9DB9D6B, vehicle, toggle); } // 0x2B6747FAA9DB9D6B 0x95A9ACCB
	...
	static void SET_VEHICLE_TANK_TURRET_POSITION(Vehicle vehicle, float position, BOOL p2) { invoke<Void>(0x56B94C6D7127DFBA, vehicle, position, p2); } // 0x56B94C6D7127DFBA 0xB1A52EF7
	static void _0x1093408B4B9D1146(Any p0, float p1) { invoke<Void>(0x1093408B4B9D1146, p0, p1); } // 0x1093408B4B9D1146 0xF30C566F
	static void SET_VEHICLE_FLIGHT_NOZZLE_POSITION(Vehicle vehicle, float direction) { invoke<Void>(0x30D779DE7C4F6DD3, vehicle, direction); } // 0x30D779DE7C4F6DD3 0xA7DF64D7
	static void SET_VEHICLE_FLIGHT_NOZZLE_POSITION_IMMEDIATE(Vehicle vehicle, float direction) { invoke<Void>(0x9AA47FFF660CB932, vehicle, direction); } // 0x9AA47FFF660CB932 0xDD7936F5
	...
	static void SET_CONVERTIBLE_ROOF_LATCH_STATE(Vehicle vehicle, BOOL state) { invoke<Void>(0x1A78AD3D8240536F, vehicle, state); } // 0x1A78AD3D8240536F 0x0858678C
	static float GET_VEHICLE_ESTIMATED_MAX_SPEED(Vehicle vehicle) { return invoke<float>(0x53AF99BAA671CA47, vehicle); } // 0x53AF99BAA671CA47 0x7D1A0616
	...
	static float GET_VEHICLE_MODEL_MAX_BRAKING_MAX_MODS(Hash modelHash) { return invoke<float>(0xBFBA3BA79CFF7EBF, modelHash); } // 0xBFBA3BA79CFF7EBF 0xF3A7293F
	...
	static float GET_VEHICLE_CLASS_ESTIMATED_MAX_SPEED(int vehicleClass) { return invoke<float>(0x00C09F246ABEDD82, vehicleClass); } // 0x00C09F246ABEDD82 0xCE67162C
	...
	static Any _ADD_SPEED_ZONE_FOR_COORD(float x, float y, float z, float radius, float speed, BOOL p5) { return invoke<Any>(0x2CE544C68FB812A0, x, y, z, radius, speed, p5); } // 0x2CE544C68FB812A0 0xD6685803
	...
	static Any ADD_VEHICLE_COMBAT_ANGLED_AVOIDANCE_AREA(float p0, float p1, float p2, float p3, float p4, float p5, float p6) { return invoke<Any>(0x54B0F614960F4A5F, p0, p1, p2, p3, p4, p5, p6); } // 0x54B0F614960F4A5F 0x5AB26C2B
	static void REMOVE_VEHICLE_COMBAT_AVOIDANCE_AREA(Any p0) { invoke<Void>(0xE30524E1871F481D, p0); } // 0xE30524E1871F481D 0xEF05F807
	static BOOL _IS_ANY_PASSENGER_RAPPELING_FROM_VEHICLE(Vehicle vehicle) { return invoke<BOOL>(0x291E373D483E7EE7, vehicle); } // 0x291E373D483E7EE7 0xD656E7E5
	...
	static void _SET_BOAT_BOOM_POSITION_RATIO(Vehicle vehicle, float ratio) { invoke<Void>(0xF488C566413B4232, vehicle, ratio); } // 0xF488C566413B4232 0xA25CCB8C
	...
	static float GET_BOAT_BOOM_POSITION_RATIO(Vehicle vehicle) { return invoke<float>(0x6636C535F6CC2725, vehicle); } // 0x6636C535F6CC2725 0x7C8D6464
	...
	static void SET_VEHICLE_USE_ALTERNATE_HANDLING(Vehicle vehicle, BOOL p1) { invoke<Void>(0x1D97D1E3A70A649F, vehicle, p1); } // 0x1D97D1E3A70A649F 0xA03E42DF
	...
	static void SET_LAST_DRIVEN_VEHICLE(Any p0) { invoke<Void>(0xACFB2463CC22BED2, p0); } // 0xACFB2463CC22BED2 0xD1B71A25
	static Vehicle GET_LAST_DRIVEN_VEHICLE() { return invoke<Vehicle>(0xB2D06FAEDE65B577); } // 0xB2D06FAEDE65B577 0xFEB0C0C8
	static void CLEAR_LAST_DRIVEN_VEHICLE() { invoke<Void>(0xE01903C47C7AC89E); } // 0xE01903C47C7AC89E
	static void SET_VEHICLE_HAS_BEEN_DRIVEN_FLAG(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x02398B627547189C, vehicle, toggle); } // 0x02398B627547189C 0x08CD58F9
	...
	static void SET_VEHICLE_CAN_SAVE_IN_GARAGE(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x428BACCDF5E26EAD, vehicle, toggle); } // 0x428BACCDF5E26EAD 0x1604C2F5
	...
	static Any _GET_VEHICLE_NUMBER_OF_BROKEN_BONES(Vehicle vehicle) { return invoke<Any>(0x2C8CBFE1EA5FC631, vehicle); } // 0x2C8CBFE1EA5FC631 0xABC99E21
	static void _0x4D9D109F63FEE1D4(Any p0, BOOL p1) { invoke<Void>(0x4D9D109F63FEE1D4, p0, p1); } // 0x4D9D109F63FEE1D4 0x900C878C
	static void SET_VEHICLE_GENERATES_ENGINE_SHOCKING_EVENTS(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x279D50DE5652D935, vehicle, toggle); } // 0x279D50DE5652D935 0xB3200F72
	static void COPY_VEHICLE_DAMAGES(Vehicle sourceVehicle, Vehicle targetVehicle) { invoke<Void>(0xE44A982368A4AF23, sourceVehicle, targetVehicle); } // 0xE44A982368A4AF23 0xBAE491C7
	static void _0xF25E02CB9C5818F8() { invoke<Void>(0xF25E02CB9C5818F8); } // 0xF25E02CB9C5818F8 0xF0E59BC1
	static void SET_LIGHTS_CUTOFF_DISTANCE_TWEAK(float distance) { invoke<Void>(0xBC3CCA5844452B06, distance); } // 0xBC3CCA5844452B06 0x929801C6
	...
	static void SET_ENABLE_VEHICLE_SLIPSTREAMING(BOOL p0) { invoke<Void>(0xE6C0C80B8C867537, p0); } // 0xE6C0C80B8C867537 0xD2B8ACBD
	static Any _GET_VEHICLE_CURRENT_SLIPSTREAM_DRAFT(Vehicle vehicle) { return invoke<Any>(0x36492C2F0D134C56, vehicle); } // 0x36492C2F0D134C56 0xA4A75FCF
	static void SET_VEHICLE_INACTIVE_DURING_PLAYBACK(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x06582AFF74894C75, vehicle, toggle); } // 0x06582AFF74894C75 0x50F89338
	static void SET_VEHICLE_ACTIVE_DURING_PLAYBACK(Vehicle vehicle, BOOL toggle) { invoke<Void>(0xDFFCEF48E511DB48, vehicle, toggle); } // 0xDFFCEF48E511DB48 0xEB7D7C27
	static BOOL IS_VEHICLE_SPRAYABLE(Vehicle vehicle) { return invoke<BOOL>(0x8D474C8FAEFF6CDE, vehicle); } // 0x8D474C8FAEFF6CDE 0x5EB00A6A
	...
	static BOOL IS_PLANE_LANDING_GEAR_INTACT(Vehicle plane) { return invoke<BOOL>(0x4198AB0022B15F87, plane); } // 0x4198AB0022B15F87 0xBD085DCA
	static BOOL ARE_PLANE_PROPELLERS_INTACT(Vehicle plane) { return invoke<BOOL>(0x755D6D5267CBBD7E, plane); } // 0x755D6D5267CBBD7E 0xABBDD5C6
	static void SET_VEHICLE_CAN_DEFORM_WHEELS(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x0CDDA42F9E360CA6, vehicle, toggle); } // 0x0CDDA42F9E360CA6 0x9B581DE7
	...
	static void SET_PLANE_TURBULENCE_MULTIPLIER(Vehicle vehicle, float multiplier) { invoke<Void>(0xAD2D28A1AFDFF131, vehicle, multiplier); } // 0xAD2D28A1AFDFF131 0xED159AE6
	...
	static void SET_CARGOBOB_PICKUP_ROPE_DAMPING_MULTIPLIER(Vehicle cargobob, Player p1) { invoke<Void>(0xCF1182F682F65307, cargobob, p1); } // 0xCF1182F682F65307
	...
	static void SET_CARGOBOB_PICKUP_MAGNET_STRENGTH(Vehicle cargobob, float p1) { invoke<Void>(0xBCBFCD9D1DAC19E2, cargobob, p1); } // 0xBCBFCD9D1DAC19E2
	static void SET_CARGOBOB_PICKUP_MAGNET_EFFECT_RADIUS(Vehicle cargobob, float p1) { invoke<Void>(0xA17BAD153B51547E, cargobob, p1); } // 0xA17BAD153B51547E
	static void SET_CARGOBOB_PICKUP_MAGNET_REDUCED_FALLOFF(Vehicle cargobob, float p1) { invoke<Void>(0x66979ACF5102FD2F, cargobob, p1); } // 0x66979ACF5102FD2F
	static void SET_CARGOBOB_PICKUP_MAGNET_PULL_ROPE_LENGTH(Vehicle cargobob, float p1) { invoke<Void>(0x6D8EAC07506291FB, cargobob, p1); } // 0x6D8EAC07506291FB
	static void SET_CARGOBOB_PICKUP_MAGNET_PULL_STRENGTH(Vehicle cargobob, float p1) { invoke<Void>(0xED8286F71A819BAA, cargobob, p1); } // 0xED8286F71A819BAA
	static void SET_CARGOBOB_PICKUP_MAGNET_FALLOFF(Vehicle vehicle, float p1) { invoke<Void>(0x685D5561680D088B, vehicle, p1); } // 0x685D5561680D088B
	static void SET_CARGOBOB_PICKUP_MAGNET_REDUCED_STRENGTH(Vehicle cargobob, Vehicle vehicle) { invoke<Void>(0xE301BD63E9E13CF0, cargobob, vehicle); } // 0xE301BD63E9E13CF0
	...
	static void _SET_VEHICLE_CLOSE_DOOR_DEFERED_ACTION(Vehicle vehicle, BOOL p1) { invoke<Void>(0x21115BCD6E44656A, vehicle, p1); } // 0x21115BCD6E44656A 0xEBC225C1
	...
	static void _SET_VEHICLE_HANDLING_HASH_FOR_AI(Vehicle vehicle, Any hash) { invoke<Void>(0x10655FAB9915623D, vehicle, hash); } // 0x10655FAB9915623D
	static void SET_VEHICLE_EXTENDED_REMOVAL_RANGE(Vehicle vehicle, int range) { invoke<Void>(0x79DF7E806202CE01, vehicle, range); } // 0x79DF7E806202CE01 0xAEF9611C
	static void SET_VEHICLE_STEERING_BIAS_SCALAR(Vehicle vehicle, float scalar) { invoke<Void>(0x9007A2F21DC108D4, vehicle, scalar); } // 0x9007A2F21DC108D4 0x585E49B6
	...
	static void CLEAR_VEHICLE_ROUTE_HISTORY(Vehicle vehicle) { invoke<Void>(0x6D6AF961B72728AE, vehicle); } // 0x6D6AF961B72728AE 0x8DD9AA0C
	...
	static void _DISABLE_PLANE_PROPELLER(Vehicle vehicle, int propeller) { invoke<Void>(0x500873A45724C863, vehicle, propeller); } // 0x500873A45724C863
	static void SET_VEHICLE_FORCE_AFTERBURNER(Vehicle vehicle, BOOL p1) { invoke<Void>(0xB055A34527CB8FD7, vehicle, p1); } // 0xB055A34527CB8FD7
	...
	static void _REQUEST_VEHICLE_DASHBOARD_SCALEFORM_MOVIE(Vehicle vehicle) { invoke<Void>(0xDBA3C090E3D74690, vehicle); } // 0xDBA3C090E3D74690
	...
	static void _GET_VEHICLE_SUSPENSION_BOUNDS(Vehicle vehicle, Vector3* out1, Vector3* out2) { invoke<Void>(0xDF7E3EEB29642C38, vehicle, out1, out2); } // 0xDF7E3EEB29642C38
	...
	static void SET_VEHICLE_KERS_ALLOWED(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x99C82F8A139F3E4E, vehicle, toggle); } // 0x99C82F8A139F3E4E
	static void _0xE16142B94664DEFD(Any p0, BOOL p1) { invoke<Void>(0xE16142B94664DEFD, p0, p1); } // 0xE16142B94664DEFD
}

namespace OBJECT
{
	static Object CREATE_OBJECT(Hash modelHash, float x, float y, float z, BOOL networkHandle, BOOL p5, BOOL dynamic) { return invoke<Object>(0x509D5878EB39E842, modelHash, x, y, z, networkHandle, p5, dynamic); } // 0x509D5878EB39E842 0x2F7AA05C
	static Object CREATE_OBJECT_NO_OFFSET(Hash modelHash, float x, float y, float z, BOOL networkHandle, BOOL p5, BOOL dynamic) { return invoke<Object>(0x9A294B2138ABB884, modelHash, x, y, z, networkHandle, p5, dynamic); } // 0x9A294B2138ABB884 0x58040420
	static void DELETE_OBJECT(Object* object) { invoke<Void>(0x539E0AE3E6634B9F, object); } // 0x539E0AE3E6634B9F 0xD6EF9DA7
	static void _SET_OBJECT_TEXTURE_VARIANT(Object* object, int paintIndex) { invoke<Void>(0x539E0AE3E6634B9F, object, paintIndex); } // 0x971DA0055324D033
	...
	static BOOL HAS_CLOSEST_OBJECT_OF_TYPE_BEEN_COMPLETELY_DESTROYED(float x, float y, float z, float radius, Hash modelHash, BOOL p5) { return invoke<BOOL>(0x46494A2475701343, x, y, z, radius, modelHash, p5); } // 0x46494A2475701343 0x7DB578DD
	...
	static Any GET_COORDS_AND_ROTATION_OF_CLOSEST_OBJECT_OF_TYPE(float x, float y, float z, float radius, Hash modelHash, Vector3* outPosition, Vector3* outRotation, int rotationOrder) { return invoke<Any>(0x163F8B586BC95F2A, x, y, z, radius, modelHash, outPosition, outRotation, rotationOrder); } // 0x163F8B586BC95F2A 0x65213FC3
	...
	static int DOOR_SYSTEM_GET_DOOR_STATE(Hash doorHash) { return invoke<int>(0x160AA1B32F6139B8, doorHash); } // 0x160AA1B32F6139B8 0xD42A41C2
	static int DOOR_SYSTEM_GET_DOOR_PENDING_STATE(Hash doorHash) { return invoke<int>(0x4BC2854478F3A749, doorHash); } // 0x4BC2854478F3A749 0xD649B7E1
	static void DOOR_SYSTEM_SET_AUTOMATIC_RATE(Hash doorHash, float rate, BOOL requestDoor, BOOL forceUpdate) { invoke<Void>(0x03C27E13B42A0E82, doorHash, rate, requestDoor, forceUpdate); } // 0x03C27E13B42A0E82 0x4F44AF21
	static void DOOR_SYSTEM_SET_AUTOMATIC_DISTANCE(Hash doorHash, float distance, BOOL requestDoor, BOOL forceUpdate) { invoke<Void>(0x9BA001CB45CBF627, doorHash, distance, requestDoor, forceUpdate); } // 0x9BA001CB45CBF627 0x47531446
	...
	static float DOOR_SYSTEM_GET_OPEN_RATIO(Hash doorHash) { return invoke<float>(0x65499865FCA6E5EC, doorHash); } // 0x65499865FCA6E5EC 0xB74C3BD7
	static void DOOR_SYSTEM_SET_SPRING_REMOVED(Hash doorHash, BOOL p1, BOOL p2, BOOL p3) { invoke<Void>(0xC485E07E4F0B7958, doorHash, p1, p2, p3); } // 0xC485E07E4F0B7958 0xB4A9A558
	static void DOOR_SYSTEM_SET_HOLD_OPEN(Hash doorHash, BOOL p1) { invoke<Void>(0xD9B71952F78A2640, doorHash, p1); } // 0xD9B71952F78A2640 0xECE58AE0
	...
	static BOOL DOOR_SYSTEM_GET_IS_PHYSICS_LOADED(Any doorHash) { return invoke<BOOL>(0xDF97CDD4FC08FD34, doorHash); } // 0xDF97CDD4FC08FD34 0x17FF9393
	static BOOL DOOR_SYSTEM_FIND_EXISTING_DOOR(float x, float y, float z, Any modelHash, Any* doorOutPointer) { return invoke<BOOL>(0x589F80B325CC82C5, x, y, z, modelHash, doorOutPointer); } // 0x589F80B325CC82C5 0xE9AE494F
	...
	static BOOL IS_PLAYER_ENTIRELY_INSIDE_GARAGE(Any garageHash, Player player, float p2, int p3) { return invoke<BOOL>(0x024A60DEB0EA69F0, garageHash, player, p2, p3); } // 0x024A60DEB0EA69F0 0xC33ED360
	static BOOL IS_PLAYER_PARTIALLY_INSIDE_GARAGE(Any garageHash, Player player, int p2) { return invoke<BOOL>(0x1761DC5D8471CBAA, garageHash, player, p2); } // 0x1761DC5D8471CBAA 0x41924877
	static BOOL ARE_ENTITIES_ENTIRELY_INSIDE_GARAGE(Any garageHash, BOOL p1, BOOL p2, BOOL p3, Any p4) { return invoke<BOOL>(0x85B6C850546FDDE2, garageHash, p1, p2, p3, p4); } // 0x85B6C850546FDDE2 0x4BD59750
	static BOOL IS_ANY_ENTITY_ENTIRELY_INSIDE_GARAGE(Any garageHash, BOOL p1, BOOL p2, BOOL p3, Any p4) { return invoke<BOOL>(0x673ED815D6E323B7, garageHash, p1, p2, p3, p4); } // 0x673ED815D6E323B7 0x7B44D659
	static BOOL IS_OBJECT_ENTIRELY_INSIDE_GARAGE(Any garageHash, Entity entity, float p2, int p3) { return invoke<BOOL>(0x372EF6699146A1E4, garageHash, entity, p2, p3); } // 0x372EF6699146A1E4 0x142C8F76
	static BOOL IS_OBJECT_PARTIALLY_INSIDE_GARAGE(Any garageHash, Entity entity, int p2) { return invoke<BOOL>(0xF0EED5A6BC7B237A, garageHash, entity, p2); } // 0xF0EED5A6BC7B237A 0x95A9AB2B
	static void _0x190428512B240692(Any garageHash, BOOL p1, BOOL p2, BOOL p3, BOOL p4) { invoke<Void>(0x190428512B240692, garageHash, p1, p2, p3, p4); } // 0x190428512B240692 0xA565E27E
	static void ENABLE_SAVING_IN_GARAGE(Hash garageHash, BOOL toggle) { invoke<Void>(0xF2E1A7133DD356A6, garageHash, toggle); } // 0xF2E1A7133DD356A6 0x43BB7E48
	...
	static void _SET_OBJECT_CAN_CLIMB_ON(Object object, BOOL toggle) { invoke<Void>(0x4D89D607CB3DD1D2, object, toggle); } // 0x4D89D607CB3DD1D2 0x19B17769
	...
	static void REMOVE_OBJECT_HIGH_DETAIL_MODEL(Any p0) { invoke<Void>(0x4A39DB43E47CF3AA, p0); } // 0x4A39DB43E47CF3AA 0xE3261B35
	...
	static void _SET_CREATE_WEAPON_OBJECT_LIGHT_SOURCE(Object object, BOOL toggle) { invoke<Void>(0xBCE595371A5FBAAF, object, toggle); } // 0xBCE595371A5FBAAF 0x3A68AA46
	static Any GET_RAYFIRE_MAP_OBJECT(float x, float y, float z, float radius, char* name) { return invoke<Any>(0xB48FCED898292E52, x, y, z, radius, name); } // 0xB48FCED898292E52 0xA286DE96
	static void SET_STATE_OF_RAYFIRE_MAP_OBJECT(Object object, int state) { invoke<Void>(0x5C29F698D404C5E1, object, state); } // 0x5C29F698D404C5E1 0x21F51560
	static Any _GET_DES_OBJECT_STATE(int handle) { return invoke<Any>(0x899BA936634A322E, handle); } // 0x899BA936634A322E 0xF1B8817A
	static BOOL DOES_RAYFIRE_MAP_OBJECT_EXIST(Object object) { return invoke<BOOL>(0x52AF537A0C5B8AAD, object); } // 0x52AF537A0C5B8AAD 0xE08C834D
	static float GET_RAYFIRE_MAP_OBJECT_ANIM_PHASE(Object object) { return invoke<float>(0x260EE4FDBDF4DB01, object); } // 0x260EE4FDBDF4DB01 0x020497DE
	...
	static BOOL IS_OBJECT_A_PICKUP(Object object) { return invoke<BOOL>(0x0378C08504160D0D, object); } // 0x0378C08504160D0D
	...
	static void _SET_LOCAL_PLAYER_CAN_USE_PICKUPS_WITH_THIS_MODEL(Hash modelHash, BOOL toggle) { invoke<Void>(0x88EAEC617CD26926, modelHash, toggle); } // 0x88EAEC617CD26926 0x3A8F1BF7
	...
	static void SET_PICKUP_GENERATION_RANGE_MULTIPLIER(float multiplier) { invoke<Void>(0x318516E02DE3ECE2, multiplier); } // 0x318516E02DE3ECE2 0x9879AC51
	...
	static BOOL IS_PICKUP_WEAPON_OBJECT_VALID(Object object) { return invoke<BOOL>(0x11D1E53A726891FE, object); } // 0x11D1E53A726891FE
...
namespace AI
{
	...
	static void SET_PED_PATH_CLIMB_COST_MODIFIER(Ped ped, float p1) { invoke<Void>(0x88E32DB8C1A4AA4B, ped, p1); } // 0x88E32DB8C1A4AA4B 0x55E06443
	...
	static void TASK_PLAY_PHONE_GESTURE_ANIMATION(Ped p0, char* p1, char* p2, char* p3, float p4, float p5, BOOL p6, BOOL p7) { invoke<Void>(0x8FBB6758B3B3E9EC, p0, p1, p2, p3, p4, p5, p6, p7); } // 0x8FBB6758B3B3E9EC 0x1582162C
	...
	static void TASK_HELI_MISSION(Ped pilot, Vehicle vehicle, Any p2, Ped pedToFollow, float posX, float posY, float posZ, int mode, float speed, float radius, float angle, int p11, int height, float p13, int p14) { invoke<Void>(0xDAD029E187A2BEB4, pilot, vehicle, p2, pedToFollow, posX, posY, posZ, mode, speed, radius, angle, p11, height, p13, p14); } // 0xDAD029E187A2BEB4 0x0C143E97
	...
	static void TASK_DRIVE_BY(Ped p0, Ped targetPed, Any p2, float targetX, float targetY, float targetZ, float p6, Any p7, BOOL p8, Hash firingPattern) { invoke<Void>(0x2F8AF0E82773A171, p0, targetPed, p2, targetX, targetY, targetZ, p6, p7, p8, firingPattern); } // 0x2F8AF0E82773A171 0x2B84D1C4
	...
	static void SET_PED_CAN_PLAY_AMBIENT_IDLES(Ped ped, BOOL p1, BOOL p2) { invoke<Void>(0x8FD89A6240813FD0, ped, p1, p2); } // 0x8FD89A6240813FD0
	...
	static void WAYPOINT_PLAYBACK_START_SHOOTING_AT_PED(Any p0, Any p1, BOOL p2, Any p3) { invoke<Void>(0xE70BA7B90F8390DC, p0, p1, p2, p3); } // 0xE70BA7B90F8390DC
	...
	static BOOL IS_TASK_MOVE_NETWORK_ACTIVE(Ped ped) { return invoke<BOOL>(0x921CE12C489C4C41, ped); } // 0x921CE12C489C4C41 0x902656EB
	static BOOL IS_TASK_MOVE_NETWORK_READY_FOR_TRANSITION(Ped ped) { return invoke<BOOL>(0x30ED88D5E0C56A37, ped); } // 0x30ED88D5E0C56A37 0x92FDBAE6
	static Any REQUEST_TASK_MOVE_NETWORK_STATE_TRANSITION(Ped ped, char* name) { return invoke<Any>(0xD01015C7316AE176, ped, name); } // 0xD01015C7316AE176 0x885724DE
	static Any _0xAB13A5565480B6D9(Any p0, Any p1) { return invoke<Any>(0xAB13A5565480B6D9, p0, p1); } // 0xAB13A5565480B6D9
	static char* GET_TASK_MOVE_NETWORK_STATE(Ped ped) { return invoke<char*>(0x717E4D1F2048376D, ped); } // 0x717E4D1F2048376D 0x96C0277B
	static void SET_TASK_MOVE_NETWORK_SIGNAL_FLOAT(Ped ped, char* signalName, float value) { invoke<Void>(0xD5BB4025AE449A4E, ped, signalName, value); } // 0xD5BB4025AE449A4E 0xA79BE783
	static void SET_TASK_MOVE_NETWORK_SIGNAL_BOOL(Ped ped, char* signalName, BOOL value) { invoke<Void>(0xB0A6CFD2C69C1088, ped, signalName, value); } // 0xB0A6CFD2C69C1088 0xF3538041
	static BOOL GET_TASK_MOVE_NETWORK_SIGNAL_BOOL(Ped ped, char* signalName) { return invoke<BOOL>(0xA7FFBA498E4AAF67, ped, signalName); } // 0xA7FFBA498E4AAF67 0x1EBB6F3D
	static BOOL GET_TASK_MOVE_NETWORK_EVENT(Ped ped, char* eventName) { return invoke<BOOL>(0xB4F47213DF45A64C, ped, eventName); } // 0xB4F47213DF45A64C 0x72FA5EF2
...
namespace GAMEPLAY
{
	...
	static char* _GET_EMPTY_STRING() { return invoke<char*>(0x24DA7D7667FD7B09); } // 0x24DA7D7667FD7B09
	...
	static Any _HAS_RESUMED_FROM_SUSPEND() { return invoke<Any>(0xE8B9C0EC9E183F35); } // 0xE8B9C0EC9E183F35
	...
	static BOOL _GET_BASE_ELEMENT_METADATA(Any* p0, Any* p1, Any p2, BOOL p3) { return invoke<BOOL>(0xB335F761606DB47C, p0, p1, p2, p3); } // 0xB335F761606DB47C
	...
	static void WATER_OVERRIDE_SET_SHOREWAVEAMPLITUDE(float amplitude) { invoke<Void>(0xB8F87EAD7533B176, amplitude); } // 0xB8F87EAD7533B176 0x625181DC
	static void WATER_OVERRIDE_SET_SHOREWAVEMINAMPLITUDE(float minAmplitude) { invoke<Void>(0xC3EAD29AB273ECE8, minAmplitude); } // 0xC3EAD29AB273ECE8 0xBEBBFDC8
	static void WATER_OVERRIDE_SET_SHOREWAVEMAXAMPLITUDE(float maxAmplitude) { invoke<Void>(0xA7A1127490312C36, maxAmplitude); } // 0xA7A1127490312C36 0x6926AB03
	static void WATER_OVERRIDE_SET_OCEANNOISEMINAMPLITUDE(float minAmplitude) { invoke<Void>(0x31727907B2C43C55, minAmplitude); } // 0x31727907B2C43C55 0xD447439D
	static void WATER_OVERRIDE_SET_OCEANWAVEAMPLITUDE(float amplitude) { invoke<Void>(0x405591EC8FD9096D, amplitude); } // 0x405591EC8FD9096D 0x584E9C59
	static void WATER_OVERRIDE_SET_OCEANWAVEMINAMPLITUDE(float minAmplitude) { invoke<Void>(0xF751B16FB32ABC1D, minAmplitude); } // 0xF751B16FB32ABC1D 0x5656D578
	static void WATER_OVERRIDE_SET_OCEANWAVEMAXAMPLITUDE(float maxAmplitude) { invoke<Void>(0xB3E6360DDE733E82, maxAmplitude); } // 0xB3E6360DDE733E82 0x0DE40C28
	static void WATER_OVERRIDE_SET_RIPPLEBUMPINESS(float bumpiness) { invoke<Void>(0x7C9C0B1EEB1F9072, bumpiness); } // 0x7C9C0B1EEB1F9072 0x98C9138B
	static void WATER_OVERRIDE_SET_RIPPLEMINBUMPINESS(float minBumpiness) { invoke<Void>(0x6216B116083A7CB4, minBumpiness); } // 0x6216B116083A7CB4 0xFB1A9CDE
	static void WATER_OVERRIDE_SET_RIPPLEMAXBUMPINESS(float maxBumpiness) { invoke<Void>(0x9F5E6BB6B34540DA, maxBumpiness); } // 0x9F5E6BB6B34540DA 0x1C0CAE89
	static void WATER_OVERRIDE_SET_RIPPLEDISTURB(float disturb) { invoke<Void>(0xB9854DFDE0D833D6, disturb); } // 0xB9854DFDE0D833D6 0x4671AC2E
	static void WATER_OVERRIDE_SET_STRENGTH(float strength) { invoke<Void>(0xC54A08C85AE4D410, strength); } // 0xC54A08C85AE4D410 0xDA02F415
	static void WATER_OVERRIDE_FADE_IN(float p0) { invoke<Void>(0xA8434F1DFF41D6E7, p0); } // 0xA8434F1DFF41D6E7 0x5F3DDEC0
	static void WATER_OVERRIDE_FADE_OUT(float p0) { invoke<Void>(0xC3C221ADDDE31A11, p0); } // 0xC3C221ADDDE31A11 0x63A89684
	...
	static BOOL GET_GROUND_Z_AND_NORMAL_FOR_3D_COORD(float x, float y, float z, float* groundZ, Vector3* normal) { return invoke<BOOL>(0x8BDC7BFC57A81E76, x, y, z, groundZ, normal); } // 0x8BDC7BFC57A81E76 0x64D91CED
	...
	static void SLERP_NEAR_QUATERNION(float t, float x, float y, float z, float w, float x1, float y1, float z1, float w1, float* outX, float* outY, float* outZ, float* outW) { invoke<Void>(0xF2F6A2FA49278625, t, x, y, z, w, x1, y1, z1, w1, outX, outY, outZ, outW); } // 0xF2F6A2FA49278625 0x87B92190
	...
	static void CLEAR_AREA_OF_PROJECTILES(float x, float y, float z, float radius, int flags) { invoke<Void>(0x0A1CB9094635D1A6, x, y, z, radius, flags); } // 0x0A1CB9094635D1A6 0x18DB5434
	...
	static Any HAVE_CREDITS_REACHED_END() { return invoke<Any>(0x075F1D57402C93BA); } // 0x075F1D57402C93BA 0x2569C9A7
	...
	static void _SET_CUSTOM_RESPAWN_POSITION(float x, float y, float z, float heading) { invoke<Void>(0x706B5EDCAA7FA663, x, y, z, heading); } // 0x706B5EDCAA7FA663
	static void _CLEAR_RESTART_CUSTOM_POSITION() { invoke<Void>(0xA2716D40842EAF79); } // 0xA2716D40842EAF79
	...
	static Any GET_IS_AUTO_SAVE_OFF() { return invoke<Any>(0x6E04F06094C87047); } // 0x6E04F06094C87047 0xA8546914
	...
	static void ADD_REPLAY_STAT_VALUE(Any p0) { invoke<Void>(0x69FE6DC87BD2A5E9, p0); } // 0x69FE6DC87BD2A5E9 0x81216EE0
	...
	static Any GET_REPLAY_STAT_MISSION_TYPE() { return invoke<Any>(0x2B626A0150E4D449); } // 0x2B626A0150E4D449 0x710E5D1E
	static Any GET_REPLAY_STAT_COUNT() { return invoke<Any>(0xDC9274A7EF6B2867); } // 0xDC9274A7EF6B2867 0xC7BD1AF0
	static Any GET_REPLAY_STAT_AT_INDEX(Any index) { return invoke<Any>(0x8098C8D6597AAE18, index); } // 0x8098C8D6597AAE18 0x22BE2423
	...
	static void ALLOW_MISSION_CREATOR_WARP(BOOL toggle) { invoke<Void>(0xDEA36202FC3382DF, toggle); } // 0xDEA36202FC3382DF 0x082BA6F2
	...
	static Any SHOULD_USE_METRIC_MEASUREMENTS() { return invoke<Any>(0xD3D15555431AB793); } // 0xD3D15555431AB793 0xBAF17315
	...
	static Any GET_COORDS_OF_PROJECTILE_TYPE_IN_AREA(float x1, float y1, float z1, float x2, float y2, float z2, Hash projHash, Vector3* projPos, BOOL ownedByPlayer) { return invoke<Any>(0x8D7A43EC6A5FEA45, x1, y1, z1, x2, y2, z2, projHash, projPos, ownedByPlayer); } // 0x8D7A43EC6A5FEA45 0x1A40454B
	static Any GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(Ped ped, Hash weaponHash, float radius, Vector3* entity, BOOL ownedByPlayer) { return invoke<Any>(0xDFB4138EEFED7B81, ped, weaponHash, radius, entity, ownedByPlayer); } // 0xDFB4138EEFED7B81 0x6BDE5CE4
	static Any _GET_PROJECTILE_NEAR_PED(Ped ped, Hash weaponhash, float p2, float p3, float p4, float p5) { return invoke<Any>(0x82FDE6A57EE4EE44, ped, weaponhash, p2, p3, p4, p5); } // 0x82FDE6A57EE4EE44 0x507BC6F7
	...
	static void SET_STUNT_JUMPS_CAN_TRIGGER(BOOL toggle) { invoke<Void>(0xD79185689F8FD5DF, toggle); } // 0xD79185689F8FD5DF 0x3C806A2D
	...
	static Any GET_NUM_SUCCESSFUL_STUNT_JUMPS() { return invoke<Any>(0x996DD1E1E02F1008); } // 0x996DD1E1E02F1008 0x006F9BA2
	static Any GET_TOTAL_SUCCESSFUL_STUNT_JUMPS() { return invoke<Any>(0x6856EC3D35C81EA4); } // 0x6856EC3D35C81EA4
	...
	static void _REGISTER_INT64_TO_SAVE(Any* p0, Any* p1) { invoke<Void>(0xA735353C77334EA0, p0, p1); } // 0xA735353C77334EA0
	...
	static void _REGISTER_TEXT_LABEL_TO_SAVE_2(Any* p0, char* name) { invoke<Void>(0x6F7794F28C6B2535, p0, name); } // 0x6F7794F28C6B2535 0xE2089749
	...
	static void BLOCK_DISPATCH_SERVICE_RESOURCE_CREATION(int dispatchService, BOOL toggle) { invoke<Void>(0x9B2BD3773123EA2F, dispatchService, toggle); } // 0x9B2BD3773123EA2F 0xE0F0684F
	...
	static BOOL CREATE_INCIDENT(int p0, float p2, float p3, float p4, int p5, float p6, int* outIncident) { return invoke<BOOL>(0x3F892CAF67444AE7, p0, p2, p3, p4, p5, p6, outIncident); } // 0x3F892CAF67444AE7 0xFC5FF7B3
	static BOOL CREATE_INCIDENT_WITH_ENTITY(int p0, Entity p1, int p2, float p3, int* outIncident) { return invoke<BOOL>(0x05983472F0494E60, p0, p1, p2, p3, outIncident); } // 0x05983472F0494E60 0xBBC35B03
	...
	static void SET_INCIDENT_REQUESTED_UNITS(int incidentId, int dispatchService, int numUnits) { invoke<Void>(0xB08B85D860E7BA3C, incidentId, dispatchService, numUnits); } // 0xB08B85D860E7BA3C 0x0242D88E
	static void _SET_INCIDENT_UNK(Any incidentId, float p1) { invoke<Void>(0xD261BA3E7E998072, incidentId, p1); } // 0xD261BA3E7E998072 0x1F38102E
	...
	static Any ADD_POP_MULTIPLIER_AREA(float x1, float y1, float z1, float x2, float y2, float z2, float p6, float p7, BOOL p8) { return invoke<Any>(0x67F6413D3220E18D, x1, y1, z1, x2, y2, z2, p6, p7, p8); } // 0x67F6413D3220E18D 0x42BF09B3
	static BOOL DOES_POP_MULTIPLIER_AREA_EXIST(int id) { return invoke<BOOL>(0x1327E2FE9746BAEE, id); } // 0x1327E2FE9746BAEE
	static void REMOVE_POP_MULTIPLIER_AREA(int id, BOOL p1) { invoke<Void>(0xB129E447A2EDA4BF, id, p1); } // 0xB129E447A2EDA4BF 0xFBDBE374
	static Any ADD_POP_MULTIPLIER_SPHERE(float p0, float p1, float p2, float p3, float p4, float p5, BOOL p6, BOOL p7) { return invoke<Any>(0x32C7A7E8C43A1F80, p0, p1, p2, p3, p4, p5, p6, p7); } // 0x32C7A7E8C43A1F80
	static void REMOVE_POP_MULTIPLIER_SPHERE(int id, BOOL p1) { invoke<Void>(0xE6869BECDD8F2403, id, p1); } // 0xE6869BECDD8F2403
	...
	static void PLAY_TENNIS_SWING_ANIM(Ped ped, char* animDict, char* animName, float p3, float p4, BOOL p5) { invoke<Void>(0xE266ED23311F24D4, ped, animDict, animName, p3, p4, p5); } // 0xE266ED23311F24D4 0xC20A7D2B
	static BOOL GET_TENNIS_SWING_ANIM_COMPLETE(Ped ped) { return invoke<BOOL>(0x17DF68D720AA77F8, ped); } // 0x17DF68D720AA77F8 0x8501E727
	static BOOL _0x19BFED045C647C49(Ped ped) { return invoke<BOOL>(0x19BFED045C647C49, ped); } // 0x19BFED045C647C49 0x1A332D2D
	static BOOL _0xE95B0C7D5BA3B96B(Ped ped) { return invoke<BOOL>(0xE95B0C7D5BA3B96B, ped); } // 0xE95B0C7D5BA3B96B
	static void PLAY_TENNIS_DIVE_ANIM(Ped ped, int p1, float p2, float p3, float p4, BOOL p5) { invoke<Void>(0x8FA9C42FC5D7C64B, ped, p1, p2, p3, p4, p5); } // 0x8FA9C42FC5D7C64B 0x0C8865DF
	...
	static void SET_DISPATCH_SPAWN_LOCATION(float x, float y, float z) { invoke<Void>(0xD10F442036302D50, x, y, z); } // 0xD10F442036302D50 0x6F009E33
	...
	static Any _ADD_DISPATCH_SPAWN_BLOCKING_ANGLED_AREA(float x1, float y1, float z1, float x2, float y2, float z2, float width) { return invoke<Any>(0x918C7B2D2FF3928B, x1, y1, z1, x2, y2, z2, width); } // 0x918C7B2D2FF3928B 0xF557BAF9
	static Any _0x2D4259F1FEB81DA9_ADD_DISPATCH_SPAWN_BLOCKING_AREA(float p0, float p1, float p2, float p3) { return invoke<Any>(0x2D4259F1FEB81DA9, p0, p1, p2, p3); } // 0x2D4259F1FEB81DA9
	...
	static void _ADD_TACTICAL_ANALYSIS_POINT(float x, float y, float z) { invoke<Void>(0xB8721407EE9C3FF6, x, y, z); } // 0xB8721407EE9C3FF6 0x24A4E0B2
	static void _CLEAR_TACTICAL_ANALYSIS_POINTS() { invoke<Void>(0xB3CD58CCA6CDA852); } // 0xB3CD58CCA6CDA852 0x66C3C59C
	static void _0x2587A48BC88DFADF(BOOL p0) { invoke<Void>(0x2587A48BC88DFADF, p0); } // 0x2587A48BC88DFADF 0xD9660339
	static void DISPLAY_ONSCREEN_KEYBOARD_WITH_LONGER_INITIAL_STRING(int p0, char* windowTitle, Any* p2, char* defaultText, char* defaultConcat1, char* defaultConcat2, char* defaultConcat3, char* defaultConcat4, char* defaultConcat5, char* defaultConcat6, char* defaultConcat7, int maxInputLength) { invoke<Void>(0xCA78CFA0366592FE, p0, windowTitle, p2, defaultText, defaultConcat1, defaultConcat2, defaultConcat3, defaultConcat4, defaultConcat5, defaultConcat6, defaultConcat7, maxInputLength); } // 0xCA78CFA0366592FE 0xD2688412
	...
	static Any ARE_PROFILE_SETTINGS_VALID() { return invoke<Any>(0x5AA3BEFA29F03AD4); } // 0x5AA3BEFA29F03AD4 0x46B5A15C
	...
	static void SCRIPT_RACE_INIT(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x0A60017F841A54F2, p0, p1, p2, p3); } // 0x0A60017F841A54F2 0x2D33F15A
	static void SCRIPT_RACE_SHUTDOWN() { invoke<Void>(0x1FF6BF9A63E5757F); } // 0x1FF6BF9A63E5757F 0xDF99925C
	...
	static BOOL SCRIPT_RACE_GET_PLAYER_SPLIT_TIME(Player player, int* p1, int* p2) { return invoke<BOOL>(0x8EF5573A1F801A5C, player, p1, p2); } // 0x8EF5573A1F801A5C 0x07FF553F
	static void _START_BENCHMARK_RECORDING() { invoke<Void>(0x92790862E36C2ADA); } // 0x92790862E36C2ADA
	static void _STOP_BENCHMARK_RECORDING() { invoke<Void>(0xC7DB36C24634F52B); } // 0xC7DB36C24634F52B
	static void _RESET_BENCHMARK_RECORDING() { invoke<Void>(0x437138B6A830166A); } // 0x437138B6A830166A
	static void _SAVE_BENCHMARK_RECORDING() { invoke<Void>(0x37DEB0AA183FB6D8); } // 0x37DEB0AA183FB6D8
	static Any _UI_IS_SINGLEPLAYER_PAUSE_MENU_ACTIVE() { return invoke<Any>(0xEA2F2061875EED90); } // 0xEA2F2061875EED90
	static Any _LANDING_MENU_IS_ACTIVE() { return invoke<Any>(0x3BBBD13E5041A79E); } // 0x3BBBD13E5041A79E
	static Any _IS_COMMAND_LINE_BENCHMARK_VALUE_SET() { return invoke<Any>(0xA049A5BE0F04F2F8); } // 0xA049A5BE0F04F2F8
	static Any _GET_BENCHMARK_ITERATIONS_FROM_COMMAND_LINE() { return invoke<Any>(0x4750FC27570311EC); } // 0x4750FC27570311EC
	static Any _GET_BENCHMARK_PASS_FROM_COMMAND_LINE() { return invoke<Any>(0x1B2366C3F2A5C8DF); } // 0x1B2366C3F2A5C8DF
	static void _FORCE_SOCIAL_CLUB_UPDATE() { invoke<Void>(0xEB6891F03362FB12); } // 0xEB6891F03362FB12
	static Any _HAS_ASYNC_INSTALL_FINISHED() { return invoke<Any>(0x14832BF2ABA53FC5); } // 0x14832BF2ABA53FC5
	static void _CLEANUP_ASYNC_INSTALL() { invoke<Void>(0xC79AE21974B01FB2); } // 0xC79AE21974B01FB2
	static BOOL _IS_IN_POWER_SAVING_MODE() { return invoke<BOOL>(0x684A41975F077262); } // 0x684A41975F077262
	static Any _GET_POWER_SAVING_MODE_DURATION() { return invoke<Any>(0xABB2FA71C83A1B72); } // 0xABB2FA71C83A1B72
	static void _SHOW_PED_IN_PAUSE_MENU(BOOL p0) { invoke<Void>(0x4EBB7E87AA0DBED4, p0); } // 0x4EBB7E87AA0DBED4
	static BOOL _GET_IS_PLAYER_IN_ANIMAL_FORM() { return invoke<BOOL>(0x9689123E3F213AA5); } // 0x9689123E3F213AA5
	static void _SET_PLAYER_ROCKSTAR_EDITOR_DISABLED(BOOL p0) { invoke<Void>(0x9D8D44ADBBA61EF2, p0); } // 0x9D8D44ADBBA61EF2
...
namespace AUDIO
{
	...
	static Any GET_IS_PRELOADED_CONVERSATION_READY() { return invoke<Any>(0xE73364DB90778FFA); } // 0xE73364DB90778FFA 0x336F3D35
	...
	static void INTERRUPT_CONVERSATION_AND_PAUSE(Ped p0, char* p1, char* p2) { invoke<Void>(0x8A694D7A68F8DC38, p0, p1, p2); } // 0x8A694D7A68F8DC38
	...
	static void PLAY_SOUND(int soundId, char* audioName, char* audioRef, BOOL p3, Any p4, BOOL p5) { invoke<Void>(0x7FF4944CC209192D, soundId, audioName, audioRef, p3, p4, p5); } // 0x7FF4944CC209192D 0xB6E1917F
	...
	static void PLAY_DEFERRED_SOUND_FRONTEND(char* soundName, char* soundsetName) { invoke<Void>(0xCADA5A0D0702381E, soundName, soundsetName); } // 0xCADA5A0D0702381E 0xC70E6CFA
	...
	static void PLAY_SOUND_FROM_COORD(int soundId, char* audioName, float x, float y, float z, char* audioRef, BOOL p6, Any p7, BOOL p8) { invoke<Void>(0x8D8686B622B88120, soundId, audioName, x, y, z, audioRef, p6, p7, p8); } // 0x8D8686B622B88120 0xCAD3E2D5
	...
	static void SET_VARIABLE_ON_UNDER_WATER_STREAM(char* name, float value) { invoke<Void>(0x733ADF241531E5C2, name, value); } // 0x733ADF241531E5C2 0x62D026BE
	...
	static void ACTIVATE_AUDIO_SLOWMO_MODE(char* p0) { invoke<Void>(0xD01005D2BA2EB778, p0); } // 0xD01005D2BA2EB778 0x59A3A17D
	static void DEACTIVATE_AUDIO_SLOWMO_MODE(char* p0) { invoke<Void>(0xDDC635D5B3262C56, p0); } // 0xDDC635D5B3262C56 0x0E387BFE
	...
	static void _SET_PED_SCREAM(Ped ped) { invoke<Void>(0x40CF0D12D142A9E8, ped); } // 0x40CF0D12D142A9E8
	static void _SET_PED_VOICE_GROUP(Ped playerPed, Hash voiceGroupHash) { invoke<Void>(0x7CDC8C3B89F661B3, playerPed, voiceGroupHash); } // 0x7CDC8C3B89F661B3
	static void _0xA5342D390CDA41D6(Any p0, BOOL p1) { invoke<Void>(0xA5342D390CDA41D6, p0, p1); } // 0xA5342D390CDA41D6
	static void STOP_CURRENT_PLAYING_SPEECH(Ped ped) { invoke<Void>(0x7A73D05A607734C7, ped); } // 0x7A73D05A607734C7
	...
	static void PLAY_ANIMAL_VOCALIZATION(Ped pedHandle, int p1, char* p2) { invoke<Void>(0xEE066C7006C49C0A, pedHandle, p1, p2); } // 0xEE066C7006C49C0A 0x498849F3
	static BOOL IS_ANIMAL_VOCALIZATION_PLAYING(Ped pedHandle) { return invoke<BOOL>(0xC265DF9FB44A9FBD, pedHandle); } // 0xC265DF9FB44A9FBD 0x0CBAF2EF
	...
	static Any IS_RADIO_FADED_OUT() { return invoke<Any>(0x0626A247D2405330); } // 0x0626A247D2405330
	...
	static BOOL DOES_PLAYER_VEH_HAVE_RADIO() { return invoke<BOOL>(0x109697E2FFBAC8A1); } // 0x109697E2FFBAC8A1 0x46B0C696
	...
	static void SET_CUSTOM_RADIO_TRACK_LIST(char* radioStation, char* trackListName, BOOL p2) { invoke<Void>(0x4E404A9361F75BB2, radioStation, trackListName, p2); } // 0x4E404A9361F75BB2 0x128C3873
	static void CLEAR_CUSTOM_RADIO_TRACK_LIST(char* radioStation) { invoke<Void>(0x1654F24A88A8E3FE, radioStation); } // 0x1654F24A88A8E3FE 0x1D766976
	...
	static void SET_RADIO_STATION_MUSIC_ONLY(char* radioStation, BOOL toggle) { invoke<Void>(0x774BD811F656A122, radioStation, toggle); } // 0x774BD811F656A122 0xB1FF7137
	static void SET_RADIO_FRONTEND_FADE_TIME(float p0) { invoke<Void>(0x2C96CDB04FCA358E, p0); } // 0x2C96CDB04FCA358E 0xC8B514E2
	static void UNLOCK_RADIO_STATION_TRACK_LIST(char* radioStation, char* trackListName) { invoke<Void>(0x031ACB6ABA18C729, radioStation, trackListName); } // 0x031ACB6ABA18C729 0xBE998184
	...
	static void _SET_VEHICLE_AUDIO(Vehicle vehicle, char* audioName) { invoke<Void>(0x4F0C413926060B38, vehicle, audioName); } // 0x4F0C413926060B38 0x33B0B007
	...
	static void SET_VEHICLE_AUDIO_ENGINE_DAMAGE_FACTOR(Vehicle vehicle, float damageFactor) { invoke<Void>(0x59E7B488451F4D3A, vehicle, damageFactor); } // 0x59E7B488451F4D3A 0x23BE6432
	...
	static void ENABLE_VEHICLE_EXHAUST_POPS(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x2BE4BC731D039D5A, vehicle, toggle); } // 0x2BE4BC731D039D5A 0x2A60A90E
	...
	static void SET_SCRIPT_UPDATE_DOOR_AUDIO(Any doorHash, BOOL toggle) { invoke<Void>(0x06C0023BED16DD6B, doorHash, toggle); } // 0x06C0023BED16DD6B 0xE61110A2
	...
	static void ENABLE_STALL_WARNING_SOUNDS(Vehicle vehicle, BOOL toggle) { invoke<Void>(0xC15907D667F7CFB2, vehicle, toggle); } // 0xC15907D667F7CFB2 0x563B635D
	...
	static Any IS_MISSION_COMPLETE_READY_FOR_UI() { return invoke<Any>(0x6F259F82D873B8B8); } // 0x6F259F82D873B8B8 0xCBE09AEC
	static void BLOCK_DEATH_JINGLE(BOOL toggle) { invoke<Void>(0xF154B8D1775B2DEC, toggle); } // 0xF154B8D1775B2DEC 0xD2858D8A
	...
	static void REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(Entity entity, float p1) { invoke<Void>(0x18EB48CFC41F2EA0, entity, p1); } // 0x18EB48CFC41F2EA0 0x308ED0EC
	...
	static Any IS_MUSIC_ONESHOT_PLAYING() { return invoke<Any>(0xA097AB275061FB21); } // 0xA097AB275061FB21 0x2705C4D5
	static Any GET_MUSIC_PLAYTIME() { return invoke<Any>(0xE7A0D23DC414507B); } // 0xE7A0D23DC414507B 0xD633C809
	static void RECORD_BROKEN_GLASS(float x, float y, float z, float radius) { invoke<Void>(0xFBE20329593DEC9D, x, y, z, radius); } // 0xFBE20329593DEC9D 0x53FC3FEC
	...
	static void OVERRIDE_PLAYER_GROUND_MATERIAL(Any hash, BOOL p1) { invoke<Void>(0xD2CC78CD3D0B50F9, hash, p1); } // 0xD2CC78CD3D0B50F9 0xC307D531
	static void _0xBF4DC1784BE94DFA(Any ped, BOOL p1, Any hash) { invoke<Void>(0xBF4DC1784BE94DFA, ped, p1, hash); } // 0xBF4DC1784BE94DFA
	static void _OVERRIDE_MICROPHONE_SETTINGS(Any hash, BOOL toggle) { invoke<Void>(0x75773E11BA459E90, hash, toggle); } // 0x75773E11BA459E90
	static void FREEZE_MICROPHONE() { invoke<Void>(0xD57AAAE0E2214D11); } // 0xD57AAAE0E2214D11
	...
	static void SET_AUDIO_SPECIAL_EFFECT_MODE(int mode) { invoke<Void>(0x12561FCBB62D5B9C, mode); } // 0x12561FCBB62D5B9C 0x62B43677
	static void SET_PORTAL_SETTINGS_OVERRIDE(char* p0, char* p1) { invoke<Void>(0x044DBAD7A7FA2BE5, p0, p1); } // 0x044DBAD7A7FA2BE5 0x8AD670EC
	static void REMOVE_PORTAL_SETTINGS_OVERRIDE(char* p0) { invoke<Void>(0xB4BBFD9CD8B3922B, p0); } // 0xB4BBFD9CD8B3922B 0xD24B4D0C
	...
	static void STOP_CUTSCENE_AUDIO() { invoke<Void>(0x806058BBDC136E06); } // 0x806058BBDC136E06
	static Any _HAS_MULTIPLAYER_AUDIO_DATA_LOADED() { return invoke<Any>(0x544810ED9DB6BBE6); } // 0x544810ED9DB6BBE6
	static Any _HAS_MULTIPLAYER_AUDIO_DATA_UNLOADED() { return invoke<Any>(0x5B50ABB1FE3746F4); } // 0x5B50ABB1FE3746F4
}
...
namespace CUTSCENE
{
	...
	static void _0x8D9DF6ECA8768583(int threadId) { invoke<Void>(0x8D9DF6ECA8768583, threadId); } // 0x8D9DF6ECA8768583 0x25A2CABC
	static BOOL CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY() { return invoke<BOOL>(0xB56BBBCC2955D9CB); } // 0xB56BBBCC2955D9CB 0xDD8878E9
	static BOOL IS_CUTSCENE_PLAYBACK_FLAG_SET(int flag) { return invoke<BOOL>(0x71B74D2AE19338D0, flag); } // 0x71B74D2AE19338D0 0x7B93CDAA
	static void SET_CUTSCENE_ENTITY_STREAMING_FLAGS(char* cutsceneEntName, int p1, int p2) { invoke<Void>(0x4C61C75BEE8184C2, cutsceneEntName, p1, p2); } // 0x4C61C75BEE8184C2 0x47DB08A9
	static void REQUEST_CUT_FILE(char* cutsceneName) { invoke<Void>(0x06A3524161C502BA, cutsceneName); } // 0x06A3524161C502BA
	static BOOL HAS_CUT_FILE_LOADED(char* cutsceneName) { return invoke<BOOL>(0xA1C996C2A744262E, cutsceneName); } // 0xA1C996C2A744262E
	static void REMOVE_CUT_FILE(char* cutsceneName) { invoke<Void>(0xD00D76A7DFC9D852, cutsceneName); } // 0xD00D76A7DFC9D852
	static Any _GET_CUT_FILE_NUM_SECTIONS(char* cutsceneName) { return invoke<Any>(0x0ABC54DE641DC0FC, cutsceneName); } // 0x0ABC54DE641DC0FC
	...
	static void SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED(char* cutsceneEntName, Ped ped, Hash modelHash) { invoke<Void>(0x2A56C06EBEF2B0D9, cutsceneEntName, ped, modelHash); } // 0x2A56C06EBEF2B0D9 0x1E7DA95E
...
namespace INTERIOR
{
	static int PIN_INTERIOR_IN_MEMORY(int interiorID) { return invoke<int>(0x2CA429C029CCF247, interiorID); } //0x2CA429C029CCF247 
	...
	static void FORCE_ROOM_FOR_GAME_VIEWPORT(int interiorID, Hash roomHashKey) { invoke<Void>(0x920D853F3E17F1DA, interiorID, roomHashKey); } // 0x920D853F3E17F1DA 0xD79803B5
	...
	static void CLEAR_ROOM_FOR_GAME_VIEWPORT() { invoke<Void>(0x23B59D8912F94246); } // 0x23B59D8912F94246 0x617DC75D
...
namespace CAM
{
	...
	static void ADD_CAM_SPLINE_NODE_USING_CAMERA_FRAME(Cam cam, Cam cam2, int p2, int p3) { invoke<Void>(0x0A9F2A468B328E74, cam, cam2, p2, p3); } // 0x0A9F2A468B328E74 0x30510511
	static void ADD_CAM_SPLINE_NODE_USING_CAMERA(Cam cam, Cam cam2, int p2, int p3) { invoke<Void>(0x0FB82563989CF4FB, cam, cam2, p2, p3); } // 0x0FB82563989CF4FB 0xBA6C085B
	static void ADD_CAM_SPLINE_NODE_USING_GAMEPLAY_FRAME(Cam cam, int p1, int p2) { invoke<Void>(0x609278246A29CA34, cam, p1, p2); } // 0x609278246A29CA34 0xB4737F03
	...
	static void SET_CAM_SPLINE_SMOOTHING_STYLE(Cam cam, int smoothingStyle) { invoke<Void>(0xD1B0F412F109EA5D, cam, smoothingStyle); } // 0xD1B0F412F109EA5D 0x15E141CE
	static BOOL GET_CAM_SPLINE_NODE_INDEX(int cam) { return invoke<BOOL>(0xB22B17DF858716A6, cam); } // 0xB22B17DF858716A6 0xF8AEB6BD
	static void SET_CAM_SPLINE_NODE_EASE(Cam cam, int p1, int p2, float p3) { invoke<Void>(0x83B8201ED82A9A2D, cam, p1, p2, p3); } // 0x83B8201ED82A9A2D 0x21D275DA
	static void SET_CAM_SPLINE_NODE_VELOCITY_SCALE(Cam cam, int p1, float scale) { invoke<Void>(0xA6385DEB180F319F, cam, p1, scale); } // 0xA6385DEB180F319F 0xA3BD9E94
	...
	static void SET_CAM_SPLINE_NODE_EXTRA_FLAGS(Cam cam, int p1, int flags) { invoke<Void>(0x7BF1A54AE67AC070, cam, p1, flags); } // 0x7BF1A54AE67AC070 0xC90B2DDC
	...
	static void SHAKE_SCRIPT_GLOBAL(char* p0, float p1) { invoke<Void>(0xF4C8CF9E353AFECA, p0, p1); } // 0xF4C8CF9E353AFECA 0x2B0F05CD
	static void ANIMATED_SHAKE_SCRIPT_GLOBAL(char* p0, char* p1, char* p2, float p3) { invoke<Void>(0xC2EAE3FB8CDBED31, p0, p1, p2, p3); } // 0xC2EAE3FB8CDBED31 0xCB75BD9C
	...
	static void SET_FLY_CAM_HORIZONTAL_RESPONSE(Cam cam, float p1, float p2, float p3) { invoke<Void>(0x503F5920162365B2, cam, p1, p2, p3); } // 0x503F5920162365B2 0x56F9ED27
	static void SET_FLY_CAM_MAX_HEIGHT(Cam cam, float height) { invoke<Void>(0xF9D02130ECDD1D77, cam, height); } // 0xF9D02130ECDD1D77 0x71570DBA
	static void SET_FLY_CAM_COORD_AND_CONSTRAIN(Cam cam, float x, float y, float z) { invoke<Void>(0xC91C6C55199308CA, cam, x, y, z); } // 0xC91C6C55199308CA 0x60B345DE
	...
	static Any _IS_AIM_CAM_THIRD_PERSON_ACTIVE() { return invoke<Any>(0x74BD83EA840F6BC9); } // 0x74BD83EA840F6BC9 0x8F320DE4
	...
	static void SET_FIRST_PERSON_AIM_CAM_ZOOM_FACTOR(float p0) { invoke<Void>(0x70894BD0915C5BCA, p0); } // 0x70894BD0915C5BCA 0x9F4AF763
	...
	static Vector3 GET_FINAL_RENDERED_IN_WHEN_FRIENDLY_ROT(Player player, int rotationOrder) { return invoke<Vector3>(0x26903D9CD1175F2C, player, rotationOrder); } // 0x26903D9CD1175F2C 0xACADF916
	static Any GET_FINAL_RENDERED_CAM_FOV() { return invoke<Any>(0x80EC114669DAEFF4); } // 0x80EC114669DAEFF4 0x721B763B
	static float GET_FINAL_RENDERED_IN_WHEN_FRIENDLY_FOV(Player player) { return invoke<float>(0x5F35F6732C3FBBA0, player); } // 0x5F35F6732C3FBBA0 0x23E3F106
	static Any GET_FINAL_RENDERED_CAM_NEAR_CLIP() { return invoke<Any>(0xD0082607100D7193); } // 0xD0082607100D7193 0x457AE195
	static Any GET_FINAL_RENDERED_CAM_FAR_CLIP() { return invoke<Any>(0xDFC8CBC606FDB0FC); } // 0xDFC8CBC606FDB0FC 0x46CB3A49
	static Any GET_FINAL_RENDERED_CAM_NEAR_DOF() { return invoke<Any>(0xA03502FC581F7D9B); } // 0xA03502FC581F7D9B 0x19297A7A
	static Any GET_FINAL_RENDERED_CAM_FAR_DOF() { return invoke<Any>(0x9780F32BCAF72431); } // 0x9780F32BCAF72431 0xF24777CA
	static Any GET_FINAL_RENDERED_CAM_MOTION_BLUR_STRENGTH() { return invoke<Any>(0x162F9D995753DC19); } // 0x162F9D995753DC19 0x38992E83
	...
	static void _SET_GAMEPLAY_HINT_ANIM_OFFSETZ(float zoffset) { invoke<Void>(0xF8BDBF3D573049A1, zoffset); } // 0xF8BDBF3D573049A1 0x72E8CD3A
	static void _SET_GAMEPLAY_HINT_ANGLE(float roll) { invoke<Void>(0xD1F8363DFAD03848, roll); } // 0xD1F8363DFAD03848 0x79472AE3
	static void _SET_GAMEPLAY_HINT_ANIM_OFFSETX(float xoffset) { invoke<Void>(0x5D7B620DAE436138, xoffset); } // 0x5D7B620DAE436138 0xFC7464A0
	static void _SET_GAMEPLAY_HINT_ANIM_OFFSETY(float yoffset) { invoke<Void>(0xC92717EF615B6704, yoffset); } // 0xC92717EF615B6704 0x3554AA0E
	...
	static void _INVALIDATE_VEHICLE_IDLE_CAM() { invoke<Void>(0x9E4CFFF989258472); } // 0x9E4CFFF989258472 0x65DDE8AF
	static void INVALIDATE_IDLE_CAM() { invoke<Void>(0xF4F2C0D4EE209E20); } // 0xF4F2C0D4EE209E20 0xD75CDD75
	static Any _0xCA9D2AA3E326D720() { return invoke<Any>(0xCA9D2AA3E326D720); } // 0xCA9D2AA3E326D720 0x96A07066
	static Any _IS_IN_VEHICLE_CAM_DISABLED() { return invoke<Any>(0x4F32C0D5A90A9B40); } // 0x4F32C0D5A90A9B40
	...
	static Ped GET_FOCUS_PED_ON_SCREEN(float p0, int p1, float p2, float p3, float p4, float p5, float p6, int p7, int p8) { return invoke<Ped>(0x89215EC747DF244A, p0, p1, p2, p3, p4, p5, p6, p7, p8); } // 0x89215EC747DF244A 0xFD99BE2B
	...
	static void _SET_GAMEPLAY_CAM_VEHICLE_CAMERA(char* vehicleName) { invoke<Void>(0x21E253A7F8DA5DFB, vehicleName); } // 0x21E253A7F8DA5DFB
	static void _SET_GAMEPLAY_CAM_VEHICLE_CAMERA_NAME(Any vehicleModel) { invoke<Void>(0x11FA5D3479C7DD47, vehicleModel); } // 0x11FA5D3479C7DD47
	static Any _0xEAF0FA793D05C592() { return invoke<Any>(0xEAF0FA793D05C592); } // 0xEAF0FA793D05C592
	static float _REPLAY_FREE_CAM_GET_MAX_RANGE() { return invoke<float>(0x8BFCEB5EA1B161B6); } // 0x8BFCEB5EA1B161B6
}
...
namespace WEAPON
{
	...
	static BOOL REFILL_AMMO_INSTANTLY(Ped ped) { return invoke<BOOL>(0x8C0D57EA686FAD87); } // 0x8C0D57EA686FAD87 0x82EEAF0F
	...
	static float GET_WEAPON_DAMAGE(Hash weaponHash, Any componentHash) { return invoke<float>(0x3133B907D8B32053, weaponHash, componentHash); } // 0x3133B907D8B32053
	...
	static Object SET_PED_SHOOT_ORDNANCE_WEAPON(Ped ped, float p1) { return invoke<Object>(0xB4C8D77C80C0421E, ped, p1); } // 0xB4C8D77C80C0421E 0xEC2E5304
...
namespace STREAMING
{
	...
	static void REQUEST_MODELS_IN_ROOM(int interiorID, char* roomName) { invoke<Void>(0x8A7A40100EDFEC58, interiorID, roomName); } // 0x8A7A40100EDFEC58 0x939243FB
	...
	static void SET_MAPDATACULLBOX_ENABLED(char* name, BOOL toggle) { invoke<Void>(0xAF12610C644A35C9, name, toggle); } // 0xAF12610C644A35C9 0x403CD434
	...
	static Any GET_PLAYER_SWITCH_JUMP_CUT_INDEX() { return invoke<Any>(0x78C0D93253149435); } // 0x78C0D93253149435 0x02BA7AC2
	...
	static void SET_PLAYER_SWITCH_ESTABLISHING_SHOT(char* name) { invoke<Void>(0x0FDE9DBFC0A6BC65, name); } // 0x0FDE9DBFC0A6BC65 0x279077B0
	...
	static BOOL IS_SWITCH_READY_FOR_DESCENT() { return invoke<BOOL>(0xDFA80CB25D0A19B3); } // 0xDFA80CB25D0A19B3 0x408F7148
	static void ENABLE_SWITCH_PAUSE_BEFORE_DESCENT() { invoke<Void>(0xD4793DFF3AF2ABCD); } // 0xD4793DFF3AF2ABCD
	static void DISABLE_SWITCH_OUTRO_FX() { invoke<Void>(0xBD605B8E0E18B3BB); } // 0xBD605B8E0E18B3BB
	...
	static void _0x95A7DABDDBB78AE7(char* iplName1, char* iplName2) { invoke<Void>(0x95A7DABDDBB78AE7, iplName1, iplName2); } // 0x95A7DABDDBB78AE7 0x9EF0A9CF
	...
	static void INIT_CREATOR_BUDGET() { invoke<Void>(0xB5A4DB34FE89B88A); } // 0xB5A4DB34FE89B88A 0xE243B2AF
	static void SHUTDOWN_CREATOR_BUDGET() { invoke<Void>(0xCCE26000E9A6FAD7); } // 0xCCE26000E9A6FAD7 0x897A510F
	static BOOL ADD_MODEL_TO_CREATOR_BUDGET(Hash modelHash) { return invoke<BOOL>(0x0BC3144DEB678666, modelHash); } // 0x0BC3144DEB678666 0xC0E83320
	static void REMOVE_MODEL_FROM_CREATOR_BUDGET(Any modelHash) { invoke<Void>(0xF086AD9354FAC3A3, modelHash); } // 0xF086AD9354FAC3A3 0x1C576388
	static Any _GET_USED_CREATOR_MODEL_MEMORY_PERCENTAGE() { return invoke<Any>(0x3D3D8B3BE5A83D35); } // 0x3D3D8B3BE5A83D35 0x3E9C4CBE
}
...
namespace SCRIPT
{
	...
	static void TRIGGER_SCRIPT_EVENT(int p0, Any* argsStruct, int argsStructSize, int bitset) { invoke<Void>(0x5AE99C571D5BBE5D, p0, argsStruct, argsStructSize, bitset); } // 0x5AE99C571D5BBE5D 0x54763B35
...
namespace UI
{
	...
	static void _SET_LOADING_PROMPT_TEXT_ENTRY(char* string) { invoke<Void>(0xABA17D7CE615ADBF, string); } // 0xABA17D7CE615ADBF 0xCB7C8994
	...
	static void PRELOAD_BUSYSPINNER() { invoke<Void>(0xC65AB383CD91DF98); } // 0xC65AB383CD91DF98 0x71077FBD
	static BOOL _IS_LOADING_PROMPT_BEING_DISPLAYED() { return invoke<BOOL>(0xD422FCC5F239A915); } // 0xD422FCC5F239A915 0xB8B3A5D0
	static Any BUSYSPINNER_IS_DISPLAYING() { return invoke<Any>(0xB2A592B04648A9CB); } // 0xB2A592B04648A9CB
	...
	static void THEFEED_ONLY_SHOW_TOOLTIPS(BOOL toggle) { invoke<Void>(0x6F1554B0CC2089FA, toggle); } // 0x6F1554B0CC2089FA 0xA7C8594B
	static void THEFEED_SET_SCRIPTED_MENU_HEIGHT(float pos) { invoke<Void>(0x55598D21339CB998, pos); } // 0x55598D21339CB998 0x1DA7E41A
	static void THEFEED_HIDE_THIS_FRAME() { invoke<Void>(0x25F87B30C382FCA7); } // 0x25F87B30C382FCA7 0x1E63088A
	static void THEFEED_FLUSH_QUEUE() { invoke<Void>(0xA8FDB297A8D25FBA); } // 0xA8FDB297A8D25FBA 0x5205C6F5
	static void _CLEAR_NOTIFICATIONS_POS(float pos) { invoke<Void>(0x55598D21339CB998, pos); } // 0x55598D21339CB998 0x1DA7E41A
	static void _REMOVE_NOTIFICATION(int notifactionId) { invoke<Void>(0xBE4390CB40B3E627, notifactionId); } // 0xBE4390CB40B3E627 0xECA8ACB9
	static void THEFEED_FORCE_RENDER_ON() { invoke<Void>(0xA13C11E1B5C06BFC); } // 0xA13C11E1B5C06BFC 0x520FCB6D
	static void THEFEED_FORCE_RENDER_OFF() { invoke<Void>(0x583049884A2EEE3C); } // 0x583049884A2EEE3C 0xC8BAB2F2
	...
	static void THEFEED_SPS_EXTEND_WIDESCREEN_ON() { invoke<Void>(0xD4438C0564490E63); } // 0xD4438C0564490E63 0x709B4BCB
	...
	static void THEFEED_COMMENT_TELEPORT_POOL_ON() { invoke<Void>(0x56C8B608CFD49854); } // 0x56C8B608CFD49854 0xF881AB87
	static void THEFEED_COMMENT_TELEPORT_POOL_OFF() { invoke<Void>(0xADED7F5748ACAFE6); } // 0xADED7F5748ACAFE6 0x1D6859CA
	static void _THEFEED_NEXT_POST_BACKGROUND_COLOR(int hudColorIndex) { invoke<Void>(0x92F0DA1E27DB96DC, hudColorIndex); } // 0x92F0DA1E27DB96DC
	...
	static void _THEFEED_SET_ANIMPOSTFX_COUNT(int flashCount) { invoke<Void>(0x17AD8C9706BDD88A, flashCount); } // 0x17AD8C9706BDD88A 0x24A97AF8
	static void _THEFEED_SET_ANIMPOSTFX_SOUND(BOOL toggle) { invoke<Void>(0x4A0C7C9BB10ABB36, toggle); } // 0x4A0C7C9BB10ABB36 0x44018EDB
	static void THEFEED_RESET_ALL_PARAMETERS() { invoke<Void>(0xFDD85225B2DEA55E); } // 0xFDD85225B2DEA55E 0xA4524B23
	static void THEFEED_FREEZE_NEXT_POST() { invoke<Void>(0xFDEC055AB549E328); } // 0xFDEC055AB549E328 0xAFA1148B
	static void THEFEED_CLEAR_FROZEN_POST() { invoke<Void>(0x80FE4F3AB4E1B62A); } // 0x80FE4F3AB4E1B62A 0x3CD4307C
	static void _THEFEED_SET_FLUSH_ANIMPOSTFX(BOOL toggle) { invoke<Void>(0xBAE4F9B97CD43B30, toggle); } // 0xBAE4F9B97CD43B30
	static void _THEFEED_ADD_TXD_REF(char* txdString1, char* txnString1, char* txdString2, char* txnString2) { invoke<Void>(0x317EBA71D7543F52, txdString1, txnString1, txdString2, txnString2); } // 0x317EBA71D7543F52
	static void _SET_NOTIFICATION_TEXT_ENTRY(char* type) { invoke<Void>(0x202709F4C58A0424, type); } // 0x202709F4C58A0424 0x574EE85C
	static int END_TEXT_COMMAND_THEFEED_POST_STATS(char* statTitle, int iconEnum, BOOL stepVal, int barValue, BOOL isImportant, char* picTxd, char* picTxn) { return invoke<int>(0x2B7E9A4EAAA93C89, statTitle, iconEnum, stepVal, barValue, isImportant, picTxd, picTxn); } // 0x2B7E9A4EAAA93C89 0xED130FA1
	...
	static int _END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT_ENTRY(char* picTxd, char* picTxn, BOOL flash, int iconType, char* entryText, char* text) { return invoke<int>(0xC6F580E4C94926AC, picTxd, picTxn, flash, iconType, entryText, text); } // 0xC6F580E4C94926AC
	static int END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT_TU(char* picName1, char* picName2, BOOL flash, int iconType, char* sender, char* subject, float duration) { return invoke<int>(0x1E6611149DB3DB6B, picName1, picName2, flash, iconType, sender, subject, duration); } // 0x1E6611149DB3DB6B 0x0EB382B7
	...
	static int END_TEXT_COMMAND_THEFEED_POST_AWARD(char* textureDict, char* textureName, int rpBonus, int colorOverlay, char* titleLabel) { return invoke<int>(0xAA295B6F28BD587D, textureDict, textureName, rpBonus, colorOverlay, titleLabel); } // 0xAA295B6F28BD587D 0x02DED2B8
	static Any END_TEXT_COMMAND_THEFEED_POST_CREWTAG(BOOL crewTypeIsPrivate, BOOL crewTagContainsRockstar, int* crewTag, int rank, BOOL hasFounderStatus, BOOL isImportant, int clanHandle, int r, int g, int b) { return invoke<Any>(0x97C9E4E7024A8F2C, crewTypeIsPrivate, crewTagContainsRockstar, crewTag, rank, hasFounderStatus, isImportant, clanHandle, r, g, b); } // 0x97C9E4E7024A8F2C 0xA9CCEF66
	static int END_TEXT_COMMAND_THEFEED_POST_CREWTAG_WITH_GAME_NAME(BOOL crewTypeIsPrivate, BOOL crewTagContainsRockstar, int* crewTag, int rank, BOOL isLeader, BOOL isImportant, int clanHandle, char* gamerStr, int r, int g, int b) { return invoke<int>(0x137BC35589E34E1E, crewTypeIsPrivate, crewTagContainsRockstar, crewTag, rank, isLeader, isImportant, clanHandle, gamerStr, r, g, b); } // 0x137BC35589E34E1E 0x88B9B909
	static Any END_TEXT_COMMAND_THEFEED_POST_UNLOCK(char* chTitle, int iconType, char* chSubtitle) { return invoke<Any>(0x33EE12743CCD6343, chTitle, iconType, chSubtitle); } // 0x33EE12743CCD6343 0xE05E7052
	static Any END_TEXT_COMMAND_THEFEED_POST_UNLOCK_TU(char* chTitle, int iconType, char* chSubtitle, BOOL isImportant) { return invoke<Any>(0xC8F3AAF93D0600BF, chTitle, iconType, chSubtitle, isImportant); } // 0xC8F3AAF93D0600BF 0x4FA43BA4
	static Any END_TEXT_COMMAND_THEFEED_POST_UNLOCK_TU_WITH_COLOR(char* chTitle, int iconType, char* chSubtitle, BOOL isImportant, int titleColor, BOOL p5) { return invoke<Any>(0x7AE0589093A2E088, chTitle, iconType, chSubtitle, isImportant, titleColor, p5); } // 0x7AE0589093A2E088 0x8C90D22F
	...
	static Any END_TEXT_COMMAND_THEFEED_POST_CREW_RANKUP(char* chTitle, char* clanTxd, char* clanTxn, BOOL isImportant, BOOL showSubtitle) { return invoke<Any>(0x8EFCCF6EC66D85E4, chTitle, clanTxd, clanTxn, isImportant, showSubtitle); } // 0x8EFCCF6EC66D85E4
	static Any END_TEXT_COMMAND_THEFEED_POST_VERSUS_TU(char* ch1TXD, char* ch1TXN, int val1, char* ch2TXD, char* ch2TXN, int val2) { return invoke<Any>(0xB6871B0555B02996, ch1TXD, ch1TXN, val1, ch2TXD, ch2TXN, val2); } // 0xB6871B0555B02996 0x5E93FBFA
	static Any _END_TEXT_COMMAND_THEFEED_POST_REPLAY_ICON(int eType, int iIcon, char* sTitle) { return invoke<Any>(0xD202B92CBF1D816F, eType, iIcon, sTitle); } // 0xD202B92CBF1D816F
	static Any _END_TEXT_COMMAND_THEFEED_POST_REPLAY_INPUT(int eType, char* sIcon, char* sSubtitle) { return invoke<Any>(0xDD6CB2CCE7C2735C, eType, sIcon, sSubtitle); } // 0xDD6CB2CCE7C2735C
	static void _SET_SUBTITLE_TEXT_ENTRY(char* GxtEntry) { invoke<Void>(0xB87A37EEB7FAA67D, GxtEntry); } // 0xB87A37EEB7FAA67D 0xF42C43C7
	static void _DRAW_SUBTITLE_TIMED(int time, BOOL p1) { invoke<Void>(0x9D77056A530643F6, time, p1); } // 0x9D77056A530643F6 0x38F82261
	static void _SET_TEXT_ENTRY_CONDITIONAL(char* text) { invoke<Void>(0x853648FD1063A213, text); } // 0x853648FD1063A213 0xDD524A11
	...
	static int _GET_TEXT_SCREEN_LINE_COUNT(float screenPosX, float screenPosY) { return invoke<int>(0x9040DFB09BE75706, screenPosX, screenPosY); } // 0x9040DFB09BE75706 0xAA318785
	...
	static void _BEGIN_TEXT_COMMAND_UNK(char* p0) { invoke<Void>(0xE124FA80A759019C, p0); } // 0xE124FA80A759019C 0x550665AE
	static void _END_TEXT_COMMAND_UNK() { invoke<Void>(0xFCC75460ABA29378); } // 0xFCC75460ABA29378 0x67785AF2
	static void BEGIN_TEXT_COMMAND_OVERRIDE_BUTTON_TEXT(char* gxtEntry) { invoke<Void>(0x8F9EE5687F8EECCD, gxtEntry); } // 0x8F9EE5687F8EECCD 0xBF855650
	...
	static void SET_COLOUR_OF_NEXT_TEXT_COMPONENT(int hudColorIndex) { invoke<Void>(0x39BBF623FC803EAC, hudColorIndex); } // 0x39BBF623FC803EAC 0x6F1A1901
	...
	static int GET_LENGTH_OF_LITERAL_STRING_IN_BYTES(char* string) { return invoke<int>(0x43E4111189E54F0E, string); } // 0x43E4111189E54F0E 0x7DBC0764
	...
	static void DISPLAY_HUD_WHEN_PAUSED_THIS_FRAME() { invoke<Void>(0x402F9ED62087E898); } // 0x402F9ED62087E898 0xC47AB1B0
	...
	static void SET_RADAR_ZOOM_TO_BLIP(Blip blip, float zoom) { invoke<Void>(0xF98E4B3E56AFC7B1, blip, zoom); } // 0xF98E4B3E56AFC7B1 0x25EC28C0
	...
	static void SET_SCRIPT_VARIABLE_HUD_COLOUR(int r, int g, int b, int a) { invoke<Void>(0xD68A5FF8A3A89874, r, g, b, a); } // 0xD68A5FF8A3A89874 0x0E41E45C
	static void _SET_SCRIPT_VARIABLE_2_HUD_COLOUR(int r, int g, int b, int a) { invoke<Void>(0x16A304E6CB2BFAB9, r, g, b, a); } // 0x16A304E6CB2BFAB9 0x6BE3ACA8
	...
	static BOOL GET_STANDARD_BLIP_ENUM_ID() { return invoke<BOOL>(0x4A9923385BDB9DAD); } // 0x4A9923385BDB9DAD 0x87871CE0
	...
	static Vector3 GET_BLIP_INFO_ID_COORD(int p0) { return invoke<Vector3>(0xFA7C7F0AADF25D09, p0); } // 0xFA7C7F0AADF25D09 0xB7374A66
	...
	static void ALLOW_SONAR_BLIPS(BOOL p0) { invoke<Void>(0x60734CC207C9833C, p0); } // 0x60734CC207C9833C 0xE7E1E32B
	...
	static BOOL DOES_BLIP_HAVE_GPS_ROUTE(Blip blip) { return invoke<BOOL>(0xDD2238F57B977751, blip); } // 0xDD2238F57B977751 0x3E47F357
	static void SET_BLIP_HIDDEN_ON_LEGEND(Blip blip, BOOL toggle) { invoke<Void>(0x54318C915D27E4CE, blip, toggle); } // 0x54318C915D27E4CE 0x43996428
	...
	static BOOL IS_HOVERING_OVER_MISSION_CREATOR_BLIP() { return invoke<BOOL>(0x4167EFE0527D706E); } // 0x4167EFE0527D706E 0xC5EB849A
	static void SHOW_START_MISSION_INSTRUCTIONAL_BUTTON(BOOL p0) { invoke<Void>(0xF1A6C18B35BCADE6, p0); } // 0xF1A6C18B35BCADE6 0xA2CAAB4F
	...
	static void SHOW_HEIGHT_ON_BLIP(Blip blip, BOOL toggle) { invoke<Void>(0x75A16C3DA34F1245, blip, toggle); } // 0x75A16C3DA34F1245 0x1D99F676
	...
	static void SHOW_CREW_INDICATOR_ON_BLIP(Blip blip, BOOL toggle) { invoke<Void>(0xDCFB5D4DB8BF367E, blip, toggle); } // 0xDCFB5D4DB8BF367E 0xABBE1E45
	static void _SET_BLIP_DISPLAY_INDICATOR_ON_BLIP(Blip blip, BOOL p1) { invoke<Void>(0xC4278F70131BAA6D, blip, p1); } // 0xC4278F70131BAA6D 0x6AA6A1CC
	...
	static void SET_RADIUS_BLIP_EDGE(Any p0, BOOL p1) { invoke<Void>(0x25615540D894B814, p0, p1); } // 0x25615540D894B814 0x40E25DB8
	...
	static void _DELETE_WAYPOINT() { invoke<Void>(0xD8E694757BCEA8E9); } // 0xD8E694757BCEA8E9 0x62BABF2C
	...
	static void _SHOW_SIGNIN_UI() { invoke<Void>(0x60E892BA4F5BDCA4); } // 0x60E892BA4F5BDCA4
	...
	static Any _IS_MINIMAP_IN_INTERIOR() { return invoke<Any>(0x9049FE339D5F6F6F); } // 0x9049FE339D5F6F6F 0x199DED14
	static void _DISABLE_RADAR_THIS_FRAME() { invoke<Void>(0x5FBAE526203990C9); } // 0x5FBAE526203990C9 0x1A4318F7
	static void HIDE_MINIMAP_INTERIOR_MAP_THIS_FRAME() { invoke<Void>(0x20FE7FDFEEAD38C0); } // 0x20FE7FDFEEAD38C0 0xCE36E3FE
	...
	static void SET_MULTIPLAYER_WALLET_CASH() { invoke<Void>(0xC2D15BEF167E27BC); } // 0xC2D15BEF167E27BC 0xF4F3C796
	static void REMOVE_MULTIPLAYER_WALLET_CASH() { invoke<Void>(0x95CF81BD06EE1887); } // 0x95CF81BD06EE1887 0x7BFFE82F
	...
	static void _HUD_WEAPON_WHEEL_IGNORE_SELECTION() { invoke<Void>(0x0AFC4AF510774B47); } // 0x0AFC4AF510774B47 0xB26FED2B
	static Hash _HUD_WEAPON_WHEEL_GET_SELECTED_HASH() { return invoke<Hash>(0xA48931185F0536FE); } // 0xA48931185F0536FE 0x22E9F555
	static void _HUD_WEAPON_WHEEL_SET_SLOT_HASH(Hash weaponHash) { invoke<Void>(0x72C1056D678BB7D8, weaponHash); } // 0x72C1056D678BB7D8 0x83B608A0
	static Any _HUD_WEAPON_WHEEL_GET_SLOT_HASH(int weaponTypeIndex) { return invoke<Any>(0xA13E93403F26C812, weaponTypeIndex); } // 0xA13E93403F26C812
	static void _HUD_WEAPON_WHEEL_IGNORE_CONTROL_INPUT(BOOL toggle) { invoke<Void>(0x14C9FDCC41F81F63, toggle); } // 0x14C9FDCC41F81F63 0xE70D1F43
	...
	static void SET_RACE_TRACK_RENDER(BOOL toggle) { invoke<Void>(0x1EAC5F91BCBC5073, toggle); } // 0x1EAC5F91BCBC5073 0xFB9BABF5
	static void CLEAR_GPS_RACE_TRACK() { invoke<Void>(0x7AA5B4CE533C858B); } // 0x7AA5B4CE533C858B 0x40C59829
	static void START_GPS_CUSTOM_ROUTE(int hudColor, BOOL displayOnFoot, BOOL followPlayer) { invoke<Void>(0xDB34E8D56FC13B08, hudColor, displayOnFoot, followPlayer); } // 0xDB34E8D56FC13B08 0x7F93799B
	static void ADD_POINT_TO_GPS_CUSTOM_ROUTE(float x, float y, float z) { invoke<Void>(0x311438A071DD9B1A, x, y, z); } // 0x311438A071DD9B1A 0xEEBDFE55
	static void SET_GPS_CUSTOM_ROUTE_RENDER(BOOL toggle, int radarThickness, int mapThickness) { invoke<Void>(0x900086F371220B6F, toggle, radarThickness, mapThickness); } // 0x900086F371220B6F 0xDA0AF00E
	static void CLEAR_GPS_CUSTOM_ROUTE() { invoke<Void>(0xE6DE0561D9232A64); } // 0xE6DE0561D9232A64 0xCF2E3E24
	static void START_GPS_MULTI_ROUTE(int hudColor, BOOL routeFromPlayer, BOOL displayOnFoot) { invoke<Void>(0x3D3D15AF7BCAAF83, hudColor, routeFromPlayer, displayOnFoot); } // 0x3D3D15AF7BCAAF83 0xC3DCBEDB
	static void ADD_POINT_TO_GPS_MULTI_ROUTE(float x, float y, float z) { invoke<Void>(0xA905192A6781C41B, x, y, z); } // 0xA905192A6781C41B 0xFE485135
	static void SET_GPS_MULTI_ROUTE_RENDER(BOOL toggle) { invoke<Void>(0x3DDA37128DD1ACA8, toggle); } // 0x3DDA37128DD1ACA8 0xE87CBE4C
	static void CLEAR_GPS_MULTI_ROUTE() { invoke<Void>(0x67EEDEA1B9BAFD94); } // 0x67EEDEA1B9BAFD94 0x0D9969E4
	...
	static void FLASH_MINIMAP_DISPLAY_WITH_COLOR(int hudColorIndex) { invoke<Void>(0x6B1DE27EE78E6A19, hudColorIndex); } // 0x6B1DE27EE78E6A19 0x79A6CAF6
	...
	static float GET_MINIMAP_FOW_DISCOVERY_RATIO() { return invoke<float>(0xE0130B41D3CF4574); } // 0xE0130B41D3CF4574 0xA4098ACC
	...
	static void SET_MINIMAP_FOW_REVEAL_COORDINATE(float x, float y, float z) { invoke<Void>(0x0923DBF87DFF735E, x, y, z); } // 0x0923DBF87DFF735E 0xE010F081
	static void SET_MINIMAP_GOLF_COURSE(int hole) { invoke<Void>(0x71BDB63DBAF8DA59, hole); } // 0x71BDB63DBAF8DA59 0x5133A750
	static void SET_MINIMAP_GOLF_COURSE_OFF() { invoke<Void>(0x35EDD5B2E3FF01C0); } // 0x35EDD5B2E3FF01C0 0x20FD3E87
	...
	static void SET_HEALTH_HUD_DISPLAY_VALUES(int health, int capacity, BOOL wasAdded) { invoke<Void>(0x3F5CC444DCAAA8F2, health, capacity, wasAdded); } // 0x3F5CC444DCAAA8F2 0x7FB6FB2A
	static void SET_MAX_HEALTH_HUD_DISPLAY(int p0) { invoke<Void>(0x975D66A0BC17064C, p0); } // 0x975D66A0BC17064C 0xF07D8CEF
	static void SET_MAX_ARMOUR_HUD_DISPLAY(int p0) { invoke<Void>(0x06A320535F5F0248, p0); } // 0x06A320535F5F0248 0x827F14DE
	...
	static BOOL IS_SCRIPTED_HUD_COMPONENT_HIDDEN_THIS_FRAME(int id) { return invoke<BOOL>(0x09C0403ED9A751C2, id); } // 0x09C0403ED9A751C2 0xE8C8E535
	...
	static void _HIDE_AREA_AND_VEHICLE_NAME_THIS_FRAME() { invoke<Void>(0xA4DEDE28B1814289); } // 0xA4DEDE28B1814289 0x52746FE1
	...
	static Any GET_HUD_SCREEN_POSITION_FROM_WORLD_POSITION(float worldX, float worldY, float worldZ, float* screenX, float* screenY) { return invoke<Any>(0xF9904D11F1ACBEC3, worldX, worldY, worldZ, screenX, screenY); } // 0xF9904D11F1ACBEC3 0xFE9A39F8
	static void OPEN_REPORTUGC_MENU() { invoke<Void>(0x523A590C1A3CC0D3); } // 0x523A590C1A3CC0D3 0x10DE5150
	static void FORCE_CLOSE_REPORTUGC_MENU() { invoke<Void>(0xEE4C0E6DBC6F2C6F); } // 0xEE4C0E6DBC6F2C6F 0x67649EE0
	static BOOL IS_REPORTUGC_MENU_OPEN() { return invoke<BOOL>(0x9135584D09A3437E); } // 0x9135584D09A3437E 0x9D2C94FA
	static BOOL IS_FLOATING_HELP_TEXT_ON_SCREEN(int hudIndex) { return invoke<BOOL>(0x2432784ACA090DA4, hudIndex); } // 0x2432784ACA090DA4 0x45472FD5
	static void SET_FLOATING_HELP_TEXT_SCREEN_POSITION(int hudIndex, float p1, float p2) { invoke<Void>(0x7679CC1BCEBE3D4C, hudIndex, p1, p2); } // 0x7679CC1BCEBE3D4C 0x198F32D7
	static void SET_FLOATING_HELP_TEXT_WORLD_POSITION(int hudIndex, float x, float y, float z) { invoke<Void>(0x784BA7E0ECEB4178, hudIndex, x, y, z); } // 0x784BA7E0ECEB4178 0x93045157
	static void SET_FLOATING_HELP_TEXT_TO_ENTITY(int hudIndex, Entity entity, float p2, float p3) { invoke<Void>(0xB094BC1DB4018240, hudIndex, entity, p2, p3); } // 0xB094BC1DB4018240 0x18B012B7
	...
	static void CREATE_MP_GAMER_TAG_WITH_CREW_COLOR(Player player, char* username, BOOL pointedClanTag, BOOL isRockstarClan, char* clanTag, int clanFlag, int r, int g, int b) { invoke<Void>(0x6DD05E9D83EFA4C9, player, username, pointedClanTag, isRockstarClan, clanTag, clanFlag, r, g, b); } // 0x6DD05E9D83EFA4C9 0xC969F2D0
	...
	static void _SET_MP_GAMER_TAG(int headDisplayId, BOOL p1) { invoke<Void>(0xEE76FF7E6A0166B0, headDisplayId, p1); } // 0xEE76FF7E6A0166B0 0x767DED29
	static void _SET_MP_GAMER_TAG_ICONS(int gamerTagId, BOOL p1) { invoke<Void>(0xA67F9C46D612B6F1, gamerTagId, p1); } // 0xA67F9C46D612B6F1 0xB01A5434
	...
	static BOOL _IS_VALID_MP_GAMER_TAG_MOVIE(int gamerTagId) { return invoke<BOOL>(0xEB709A36958ABE0D, gamerTagId); } // 0xEB709A36958ABE0D 0xF11414C4
	static void SET_MP_GAMER_TAG_BIG_TEXT(int gamerTagId, char* string) { invoke<Void>(0x7B7723747CCB55B6, gamerTagId, string); } // 0x7B7723747CCB55B6 0x939218AB
	static Any GET_CURRENT_WEBPAGE_ID() { return invoke<Any>(0x01A358D9128B7A86); } // 0x01A358D9128B7A86 0xAB5B7C18
	...
	static BOOL _IS_WARNING_MESSAGE_ACTIVE_2() { return invoke<BOOL >(0xAF42195A42C63BBA); } // 0xAF42195A42C63BBA
	...
	static BOOL _SET_WARNING_MESSAGE_LIST_ROW(int index, char* name, int cash, int rp, int lvl, int colour) { return invoke<BOOL>(0x0C5A80A9E096D529, index, name, cash, rp, lvl, colour); } // 0x0C5A80A9E096D529
	static BOOL _0xDAF87174BE7454FF(Any p0) { return invoke<BOOL>(0xDAF87174BE7454FF, p0); } // 0xDAF87174BE7454FF
	static void _REMOVE_WARNING_MESSAGE_LIST_ITEMS() { invoke<Void>(0x6EF54AB721DC6242); } // 0x6EF54AB721DC6242
	static BOOL IS_WARNING_MESSAGE_ACTIVE() { return invoke<BOOL>(0xE18B138FABC53103); } // 0xE18B138FABC53103 0x94C834AD
	static void CLEAR_DYNAMIC_PAUSE_MENU_ERROR_MESSAGE() { invoke<Void>(0x7792424AA0EAC32E); } // 0x7792424AA0EAC32E 0x2F9A309C
	static void _RACE_GALLERY_NEXT_BLIP_SPRITE(int spriteId) { invoke<Void>(0x1EAE6DD17B7A5EFA, spriteId); } // 0x1EAE6DD17B7A5EFA 0x13E7A5A9
	static Any _RACE_GALLERY_ADD_BLIP(float x, float y, float z) { return invoke<Any>(0x551DF99658DB6EE8, x, y, z); } // 0x551DF99658DB6EE8 0x786CA0A2
	static void _CLEAR_RACE_GALLERY_BLIPS() { invoke<Void>(0x2708FC083123F9FF); } // 0x2708FC083123F9FF 0xCBEC9369
	static Any FORCE_SONAR_BLIPS_THIS_FRAME() { return invoke<Any>(0x1121BFA1A1A522A8); } // 0x1121BFA1A1A522A8 0x3F4AFB13
	...
	static void SUPPRESS_FRONTEND_RENDERING_THIS_FRAME() { invoke<Void>(0xBA751764F0821256); } // 0xBA751764F0821256 0x7F349900
	static void _ALLOW_PAUSE_MENU_WHEN_DEAD_THIS_FRAME() { invoke<Void>(0xCC3FDDED67BCFC63); } // 0xCC3FDDED67BCFC63 0x630CD8EE
	...
	static void PAUSE_MENU_ACTIVATE_CONTEXT(Hash hash) { invoke<Void>(0xDD564BDD0472C936, hash); } // 0xDD564BDD0472C936 0x9FE8FD5E
	static void OBJECT_DECAL_TOGGLE(Hash hash) { invoke<Void>(0x444D8CF241EC25C5, hash); } // 0x444D8CF241EC25C5 0x0029046E
	static BOOL PAUSE_MENU_IS_CONTEXT_ACTIVE(Hash contextHash) { return invoke<BOOL>(0x84698AB38D0C6636, contextHash); } // 0x84698AB38D0C6636 0xC51BC42F
	...
	static Any IS_FRONTEND_READY_FOR_CONTROL() { return invoke<Any>(0x3BAB9A4E4F2FF5C7); } // 0x3BAB9A4E4F2FF5C7 0xD3BF3ABD
	...
	static void SET_PAUSE_MENU_PED_LIGHTING(BOOL state) { invoke<Void>(0x3CA6050692BC61B0, state); } // 0x3CA6050692BC61B0 0x127310EB
	static void SET_PAUSE_MENU_PED_SLEEP_STATE(BOOL state) { invoke<Void>(0xECF128344E9FF9F1, state); } // 0xECF128344E9FF9F1 0x8F45D327
	...
	static Any IS_ONLINE_POLICIES_MENU_ACTIVE() { return invoke<Any>(0x6F72CD94F7B5B68C); } // 0x6F72CD94F7B5B68C 0x9D4934F4
	static void OPEN_SOCIAL_CLUB_MENU() { invoke<Void>(0x75D3691713C3B05A); } // 0x75D3691713C3B05A 0x57218529
	static void CLOSE_SOCIAL_CLUB_MENU() { invoke<Void>(0xD2B32BE3FC1626C6); } // 0xD2B32BE3FC1626C6 0x5F86AA39
	static void SET_SOCIAL_CLUB_TOUR(char* p0) { invoke<Void>(0x9E778248D6685FE0, p0); } // 0x9E778248D6685FE0 0x7AD67C95
	...
	static void _FORCE_CLOSE_TEXT_INPUT_BOX() { invoke<Void>(0x8817605C2BA76200); } // 0x8817605C2BA76200
	...
	static void FLAG_PLAYER_CONTEXT_IN_TOURNAMENT(BOOL toggle) { invoke<Void>(0xCEF214315D276FD1, toggle); } // 0xCEF214315D276FD1 0xFF06772A
	static void SET_PED_HAS_AI_BLIP(Ped ped, BOOL hasCone) { invoke<Void>(0xD30C50DF888D58B5, ped, hasCone); } // 0xD30C50DF888D58B5 0x96C4C4DD
	static BOOL DOES_PED_HAVE_AI_BLIP(Ped ped) { return invoke<BOOL>(0x15B8ECF844EE67ED, ped); } // 0x15B8ECF844EE67ED 0x3BE1257F
	static void SET_PED_AI_BLIP_GANG_ID(Ped ped, int gangId) { invoke<Void>(0xE52B8E7F85D39A08, ped, gangId); } // 0xE52B8E7F85D39A08 0xD8E31B1A
	...
	static void SET_PED_AI_BLIP_FORCED_ON(Ped ped, BOOL toggle) { invoke<Void>(0x0C4BBF625CA98C4E, ped, toggle); } // 0x0C4BBF625CA98C4E 0xFFDF46F0
	static void SET_PED_AI_BLIP_NOTICE_RANGE(Ped ped, float range) { invoke<Void>(0x97C65887D4B37FA9, ped, range); } // 0x97C65887D4B37FA9 0xF9DC2AF7
	static Any _GET_AI_BLIP_2(Ped ped) { return invoke<Any>(0x7CD934010E115C2C, ped); } // 0x7CD934010E115C2C 0x06349065
	static Blip _GET_AI_BLIP(Ped ped) { return invoke<Blip>(0x56176892826A4FE8, ped); } // 0x56176892826A4FE8 0xCA52CF43
	static BOOL _HAS_DIRECTOR_MODE_BEEN_TRIGGERED() { return invoke<BOOL>(0xA277800A9EAE340E); } // 0xA277800A9EAE340E
	static void _SET_DIRECTOR_MODE_CLEAR_TRIGGERED_FLAG() { invoke<Void>(0x2632482FD6B9AB87); } // 0x2632482FD6B9AB87
	static void _SET_PLAYER_IS_IN_DIRECTOR_MODE(BOOL toggle) { invoke<Void>(0x808519373FD336A3, toggle); } // 0x808519373FD336A3
	static void _0x04655F9D075D0AE5(BOOL toggle) { invoke<Void>(0x04655F9D075D0AE5, toggle); } // 0x04655F9D075D0AE5
}

namespace GRAPHICS
{
	static void _FORCE_GROUND_SNOW_PASS(BOOL toggle) { invoke<Void>(0x6E9EF3A33C8899F8, toggle); }// 0x6E9EF3A33C8899F8 b3095
	...
	static Any BEGIN_TAKE_HIGH_QUALITY_PHOTO() { return invoke<Any>(0xA67C35C56EB1BD9D); } // 0xA67C35C56EB1BD9D 0x47B0C137
	static Any GET_STATUS_OF_TAKE_HIGH_QUALITY_PHOTO() { return invoke<Any>(0x0D6CA79EEEBD8CA3); } // 0x0D6CA79EEEBD8CA3 0x65376C9B
	...
	static void ADD_TCMODIFIER_OVERRIDE(char* modifierName1, char* modifierName2) { invoke<Void>(0x1A8E2C8B9CF4549C, modifierName1, modifierName2); } // 0x1A8E2C8B9CF4549C 0xE8F538B5
	static Any SAVE_HIGH_QUALITY_PHOTO(int unused) { return invoke<Any>(0x3DEC726C25A11BAC, unused); } // 0x3DEC726C25A11BAC 0x3B15D33C
	static Any GET_STATUS_OF_SAVE_HIGH_QUALITY_PHOTO() { return invoke<Any>(0x0C0C4E81E1AC60A0); } // 0x0C0C4E81E1AC60A0 0xEC5D0317
	...
	static Any GET_MAXIMUM_NUMBER_OF_CLOUD_PHOTOS() { return invoke<Any>(0xDC54A7AF8B3A14EF); } // 0xDC54A7AF8B3A14EF 0x239272BD
	static Any _GET_CURRENT_NUMBER_OF_PHOTOS() { return invoke<Any>(0x473151EBC762C6DA); } // 0x473151EBC762C6DA 0x21DBF0C9
	...
	static void FADE_UP_PED_LIGHT(float p0) { invoke<Void>(0xC9B18B4619F48F7B, p0); } // 0xC9B18B4619F48F7B 0x93628786
	static void UPDATE_LIGHTS_ON_ENTITY(Object object) { invoke<Void>(0xDEADC0DEDEADC0DE, object); } // 0xDEADC0DEDEADC0DE
	...
	static void SET_SCRIPT_GFX_DRAW_BEHIND_PAUSEMENU(BOOL flag) { invoke<Void>(0xC6372ECD45D73BCD, flag); } // 0xC6372ECD45D73BCD 0xF8FBCC25
	...
	static Any GET_REQUESTINGNIGHTVISION() { return invoke<Any>(0x35FB78DC42B7BD21); } // 0x35FB78DC42B7BD21
	...
	static BOOL _WORLD3D_TO_SCREEN2D(float worldX, float worldY, float worldZ, float* screenX, float* screenY) { return invoke<BOOL>(0x34E82F05DF2974F5, worldX, worldY, worldZ, screenX, screenY); } // 0x34E82F05DF2974F5 0x1F950E4B
	...
	static void DISABLE_OCCLUSION_THIS_FRAME() { invoke<Void>(0x3669F1B198DCAA4F); } // 0x3669F1B198DCAA4F 0x0DCC0B8B
	...
	static void _GRASS_LOD_SHRINK_SCRIPT_AREAS(float x, float y, float z, float radius, float p4, float p5, float p6) { invoke<Void>(0x6D955F6A9E0295B1, x, y, z, radius, p4, p5, p6); } // 0x6D955F6A9E0295B1
	static void _GRASS_LOD_RESET_SCRIPT_AREAS() { invoke<Void>(0x302C91AB2D477F7E); } // 0x302C91AB2D477F7E
	...
	static void _CASCADESHADOWS_SET_TYPE(char* type) { invoke<Void>(0xB11D94BC55F41932, type); } // 0xB11D94BC55F41932 0xDE10BA1F
	static void _CASCADESHADOWS_RESET_TYPE() { invoke<Void>(0x27CB772218215325); } // 0x27CB772218215325
	...
	static void GOLF_TRAIL_SET_ENABLED(BOOL toggle) { invoke<Void>(0xA51C4B86B71652AE, toggle); } // 0xA51C4B86B71652AE 0x5D3BFFC9
	static void GOLF_TRAIL_SET_PATH(float p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7, BOOL p8) { invoke<Void>(0x312342E1A4874F3F, p0, p1, p2, p3, p4, p5, p6, p7, p8); } // 0x312342E1A4874F3F 0xD9653728
	static void GOLF_TRAIL_SET_RADIUS(float p0, float p1, float p2) { invoke<Void>(0x2485D34E50A22E84, p0, p1, p2); } // 0x2485D34E50A22E84 0x72BA8A14
	static void GOLF_TRAIL_SET_COLOUR(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, int p10, int p11) { invoke<Void>(0x12995F2E53FFA601, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); } // 0x12995F2E53FFA601 0x804F444C
	static void GOLF_TRAIL_SET_TESSELLATION(Any p0, Any p1) { invoke<Void>(0xDBAA5EC848BA2D46, p0, p1); } // 0xDBAA5EC848BA2D46 0xBB1A1294
	static void _0xC0416B061F2B7E5E(BOOL p0) { invoke<Void>(0xC0416B061F2B7E5E, p0); } // 0xC0416B061F2B7E5E 0x1A1A72EF
	static void GOLF_TRAIL_SET_FIXED_CONTROL_POINT(int type, float xPos, float yPos, float zPos, float p4, int red, int green, int blue, int alpha) { invoke<Void>(0xB1BB03742917A5D6, type, xPos, yPos, zPos, p4, red, green, blue, alpha); } // 0xB1BB03742917A5D6 0x3BB12B75
	static void GOLF_TRAIL_SET_SHADER_PARAMS(float p0, float p1, float p2, float p3, float p4) { invoke<Void>(0x9CFDD90B2B844BF7, p0, p1, p2, p3, p4); } // 0x9CFDD90B2B844BF7 0x4EA70FB4
	static void GOLF_TRAIL_SET_FACING(BOOL p0) { invoke<Void>(0x06F761EA47C1D3ED, p0); } // 0x06F761EA47C1D3ED 0x0D830DC7
	static Any GOLF_TRAIL_GET_MAX_HEIGHT() { return invoke<Any>(0xA4819F5E23E2FFAD); } // 0xA4819F5E23E2FFAD 0xA08B46AD
	static Vector3 GOLF_TRAIL_GET_VISUAL_CONTROL_POINT(int p0) { return invoke<Vector3>(0xA4664972A9B8F8BA, p0); } // 0xA4664972A9B8F8BA 0xECD470F0
	...
	static void SEETHROUGH_SET_HEATSCALE(int index, float heatScale) { invoke<Void>(0xD7D0B00177485411, index, heatScale); } // 0xD7D0B00177485411 0x654F0287
	...
	static void DISABLE_SCREENBLUR_FADE() { invoke<Void>(0xDE81239437E8C5A8); } // 0xDE81239437E8C5A8 0xDB7AECDA
	static float IS_PARTICLE_FX_DELAYED_BLINK() { return invoke<float>(0x5CCABFFCA31DDE33); } // 0x5CCABFFCA31DDE33 0xEA432A94
	static Any IS_SCREENBLUR_FADE_RUNNING() { return invoke<Any>(0x7B226C785A52A0A9); } // 0x7B226C785A52A0A9 0x926B8734
	...
	static Any GET_TOGGLE_PAUSED_RENDERPHASES_STATUS() { return invoke<Any>(0xEB3DAC2C86001E5E); } // 0xEB3DAC2C86001E5E
	static void RESET_PAUSED_RENDERPHASES() { invoke<Void>(0xE1C8709406F2C41C); } // 0xE1C8709406F2C41C 0x0113EAE4
	static void _0x851CD923176EBA7C() { invoke<Void>(0x851CD923176EBA7C); } // 0x851CD923176EBA7C 0xDCBA251B
	static void SET_HIDOF_OVERRIDE(BOOL p0, BOOL p1, float nearplaneOut, float nearplaneIn, float farplaneOut, float farplaneIn) { invoke<Void>(0xBA3D65906822BED5, p0, p1, nearplaneOut, nearplaneIn, farplaneOut, farplaneIn); } // 0xBA3D65906822BED5 0x513D444B
	...
	static BOOL START_PARTICLE_FX_NON_LOOPED_AT_COORD(char* effectName, float xPos, float yPos, float zPos, float xRot, float yRot, float zRot, float scale, BOOL xAxis, BOOL yAxis, BOOL zAxis) { return invoke<BOOL>(0x25129531F77B9ED3, effectName, xPos, yPos, zPos, xRot, yRot, zRot, scale, xAxis, yAxis, zAxis); } // 0x25129531F77B9ED3 0xDD79D679
	...
	static void SET_PARTICLE_FX_BULLET_IMPACT_SCALE(float p0) { invoke<Void>(0x27E32866E9A5C416, p0); } // 0x27E32866E9A5C416
	...
	static void _SET_PTFX_ASSET_OLD_TO_NEW(char* oldAsset, char* newAsset) { invoke<Void>(0xEA1E2D93F6F75ED9, oldAsset, newAsset); } // 0xEA1E2D93F6F75ED9
	static void RESET_PARTICLE_FX_OVERRIDE(char* name) { invoke<Void>(0x89C8553DD3274AAE, name); } // 0x89C8553DD3274AAE
	...
	static int ADD_DECAL(Any p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7, float p8, float p9, float p10, float p11, float p12, float p13, float p14, float p15, float p16, BOOL p17, BOOL p18, BOOL p19) { return invoke<int>(0xB302244A1839BDAD, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19); } // 0xB302244A1839BDAD 0xEAD0C412
	...
	static void START_PETROL_TRAIL_DECALS(float p0) { invoke<Void>(0x99AC7F0D8B9C893D, p0); } // 0x99AC7F0D8B9C893D 0xE3938B0B
	static void ADD_PETROL_TRAIL_DECAL_INFO(float x, float y, float z, float p3) { invoke<Void>(0x967278682CB6967A, x, y, z, p3); } // 0x967278682CB6967A 0xBAEC6ADD
	static void END_PETROL_TRAIL_DECALS() { invoke<Void>(0x0A123435A26C36CD); } // 0x0A123435A26C36CD 0xCCCA6855
	static void REMOVE_DECAL(int decal) { invoke<Void>(0xED3F346429CCD659, decal); } // 0xED3F346429CCD659 0xA4363188
	static BOOL IS_DECAL_ALIVE(int decal) { return invoke<BOOL>(0xC694D74949CAFD0C, decal); } // 0xC694D74949CAFD0C 0xCDD4A61A
	...
	static void SET_DISABLE_DECAL_RENDERING_THIS_FRAME() { invoke<Void>(0x4B5CFC83122DF602); } // 0x4B5CFC83122DF602 0xA706E84D
	static BOOL GET_IS_PETROL_DECAL_IN_RANGE(float xCoord, float yCoord, float zCoord, float p3) { return invoke<BOOL>(0x2F09F7976C512404, xCoord, yCoord, zCoord, p3); } // 0x2F09F7976C512404 0x242C6A04
	static void PATCH_DECAL_DIFFUSE_MAP(int decalType, char* textureDict, char* textureName) { invoke<Void>(0x8A35C742130C6080, decalType, textureDict, textureName); } // 0x8A35C742130C6080 0x335695CF
	static void UNPATCH_DECAL_DIFFUSE_MAP(int decalType) { invoke<Void>(0xB7ED70C49521A61D, decalType); } // 0xB7ED70C49521A61D 0x7B786555
	...
	static void REMOVE_VEHICLE_CREW_EMBLEM(Vehicle vehicle, int p1) { invoke<Void>(0xD2300034310557E4, vehicle, p1); } // 0xD2300034310557E4 0x667046A8
	static int GET_VEHICLE_CREW_EMBLEM_REQUEST_STATE(Vehicle vehicle, int p1) { return invoke<int>(0xFE26117A5841B2FF, vehicle, p1); } // 0xFE26117A5841B2FF 0x4F4D76E8
	...
	static void OVERRIDE_INTERIOR_SMOKE_NAME(char* name) { invoke<Void>(0x2A2A52824DB96700, name); } // 0x2A2A52824DB96700 0x0F486429
	static void OVERRIDE_INTERIOR_SMOKE_LEVEL(float level) { invoke<Void>(0x1600FD8CF72EBC12, level); } // 0x1600FD8CF72EBC12 0xD87CC710
	static void OVERRIDE_INTERIOR_SMOKE_END() { invoke<Void>(0xEFB55E7C25D3B3BE); } // 0xEFB55E7C25D3B3BE 0xE29EE145
	static void _REGISTER_NOIR_SCREEN_EFFECT_THIS_FRAME() { invoke<Void>(0xA44FF770DFBC5DAE); } // 0xA44FF770DFBC5DAE
	...
	static void PRESET_INTERIOR_AMBIENT_CACHE(char* p0) { invoke<Void>(0xD7021272EB0A451E, p0); } // 0xD7021272EB0A451E
	...
	static int GET_TIMECYCLE_TRANSITION_MODIFIER_INDEX() { return invoke<int>(0x459FD2C8D0AB78BC); } // 0x459FD2C8D0AB78BC 0x03C44E4B
	...
	static void SET_CURRENT_PLAYER_TCMODIFIER(char* modifierName) { invoke<Void>(0xBBF327DED94E4DEB, modifierName); } // 0xBBF327DED94E4DEB 0x85BA15A4
	static void SET_PLAYER_TCMODIFIER_TRANSITION(float value) { invoke<Void>(0xBDEB86F4D5809204, value); } // 0xBDEB86F4D5809204 0x9559BB38
	static void SET_NEXT_PLAYER_TCMODIFIER(char* modifierName) { invoke<Void>(0xBF59707B3E5ED531, modifierName); } // 0xBF59707B3E5ED531 0x554BA16E
	static void _0x15E33297C3E8DC60(Any p0) { invoke<Void>(0x15E33297C3E8DC60, p0); } // 0x15E33297C3E8DC60 0x805BAB08
	static void _SET_EXTRA_TIMECYCLE_MODIFIER(char* modifierName) { invoke<Void>(0x5096FD9CCB49056D, modifierName); } // 0x5096FD9CCB49056D 0x908A335E
	static void _CLEAR_EXTRA_TIMECYCLE_MODIFIER() { invoke<Void>(0x92CCC17A7A2285DA); } // 0x92CCC17A7A2285DA 0x6776720A
	...
	static int _REQUEST_SCALEFORM_MOVIE3(char* scaleformName) { return invoke<int>(0xBD06C611BB9048C2, scaleformName); } // 0xBD06C611BB9048C2
	...
	static BOOL _PUSH_SCALEFORM_MOVIE_FUNCTION_N(char* functionName) { return invoke<BOOL>(0xAB58C27C2E6123C6, functionName); } // 0xAB58C27C2E6123C6 0xF6015178
	static BOOL BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND_HEADER(char* functionName) { return invoke<BOOL>(0xB9449845F73F5E9C, functionName); } // 0xB9449845F73F5E9C 0x5E219B67
	...
	static int GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(int method_return) { return invoke<int>(0x2DE7EFA66B906036, method_return); } // 0x2DE7EFA66B906036 0x2CFB0E6D
	static char* GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_STRING(int scaleform) { return invoke<char*>(0xE1E258829A885245, scaleform); } // 0xE1E258829A885245 0x516862EB
	...
	static void SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(char* string) { invoke<Void>(0xE83A3E3557A56640, string); } // 0xE83A3E3557A56640 0xCCBF0334
	static BOOL _0x5E657EF1099EDD65(Any p0) { return invoke<BOOL>(0x5E657EF1099EDD65, p0); } // 0x5E657EF1099EDD65 0x91A081A1
	static void SCALEFORM_MOVIE_METHOD_ADD_PARAM_LATEST_BRIEF_STRING(int value) { invoke<Void>(0xEC52C631A1831C03, value); } // 0xEC52C631A1831C03 0x83A9811D
	...
	static void REMOVE_SCALEFORM_SCRIPT_HUD_MOVIE(int hudComponent) { invoke<Void>(0xF44A5456AC3F4F97, hudComponent); } // 0xF44A5456AC3F4F97 0x03D87600
	...
	static void SET_TV_CHANNEL_PLAYLIST(int tvChannel, char* playlistName, BOOL restart) { invoke<Void>(0xF7B38B8305F1FE8B, tvChannel, playlistName, restart); } // 0xF7B38B8305F1FE8B 0xB262DE67
	static void SET_TV_CHANNEL_PLAYLIST_AT_HOUR(int tvChannel, char* playlistName, int hour) { invoke<Void>(0x2201C576FACAEBE8, tvChannel, playlistName, hour); } // 0x2201C576FACAEBE8 0x78C4DCBE
	static void CLEAR_TV_CHANNEL_PLAYLIST(int tvChannel) { invoke<Void>(0xBEB3D46BB7F043C0, tvChannel); } // 0xBEB3D46BB7F043C0 0xCBE7068F
	...
	static void ENABLE_MOVIE_KEYFRAME_WAIT(BOOL toggle) { invoke<Void>(0x74C180030FDE4B69, toggle); } // 0x74C180030FDE4B69 0x796DE696
	...
	static BOOL UI3DSCENE_IS_AVAILABLE() { return invoke<BOOL>(0xD3A10FC7FD8D98CD); } // 0xD3A10FC7FD8D98CD 0xE40A0F1A
	static BOOL UI3DSCENE_PUSH_PRESET(char* presetName) { return invoke<BOOL>(0xF1CEA8A4198D8E9A, presetName); } // 0xF1CEA8A4198D8E9A 0x2E7D9B98
	...
	static void _0x108BE26959A9D9BB(BOOL toggle) { invoke<Void>(0x108BE26959A9D9BB, toggle); } // 0x108BE26959A9D9BB 0x24A7A7F6
	static void TERRAINGRID_ACTIVATE(BOOL toggle) { invoke<Void>(0xA356990E161C9E65, toggle); } // 0xA356990E161C9E65 0xA1CB6C94
	static void TERRAINGRID_SET_PARAMS(float x, float y, float z, float p3, float rotation, float p5, float width, float height, float p8, float scale, float glowIntensity, float normalHeight, float heightDiff) { invoke<Void>(0x1C4FC5752BCD8E48, x, y, z, p3, rotation, p5, width, height, p8, scale, glowIntensity, normalHeight, heightDiff); } // 0x1C4FC5752BCD8E48 0x3B637AA7
	static void TERRAINGRID_SET_COLOURS(int lowR, int lowG, int lowB, int lowAlpha, int R, int G, int B, int Alpha, int highR, int highG, int highB, int highAlpha) { invoke<Void>(0x5CE62918F8D703C7, lowR, lowG, lowB, lowAlpha, R, G, B, Alpha, highR, highG, highB, highAlpha); } // 0x5CE62918F8D703C7 0xDF552973
	...
	static int _GET_SCREEN_EFFECT_IS_ACTIVE(char* effectName) { return invoke<int>(0x36AD3E690DA5ACEB, effectName); } // 0x36AD3E690DA5ACEB 0x089D5921
	static void _STOP_ALL_SCREEN_EFFECTS() { invoke<Void>(0xB4EDDC19532BFB85); } // 0xB4EDDC19532BFB85 0x4E6D875B
	static void _ANIMPOSTFX_STOP_AND_DO_UNK(char* effectName) { invoke<Void>(0xD2209BE128B5418C, effectName); } // 0xD2209BE128B5418C
}
...
namespace STATS
{
	...
	static int _STAT_GET_PACKED_BOOL_MASK(int p0) { return invoke<int>(0xF4D8E7AC2A27758C, p0); } // 0xF4D8E7AC2A27758C 0xDFC25D66
	static int _STAT_GET_PACKED_INT_MASK(int p0) { return invoke<int>(0x94F12ABF9C79E339, p0); } // 0x94F12ABF9C79E339 0xCA160BCC
	static Hash GET_PACKED_BOOL_STAT_KEY(int index, BOOL spStat, BOOL charStat, int character) { return invoke<Hash>(0x80C75307B1C42837, index, spStat, charStat, character); } // 0x80C75307B1C42837 0xB5BF87B2
	static Hash GET_PACKED_INT_STAT_KEY(int index, BOOL spStat, BOOL charStat, int character) { return invoke<Hash>(0x61E111E323419E07, index, spStat, charStat, character); } // 0x61E111E323419E07 0x1F938864
	static Hash _GET_PACKED_TITLE_UPDATE_BOOL_STAT_KEY(int index, BOOL spStat, BOOL charStat, int character) { return invoke<Hash>(0xC4BB08EE7907471E, index, spStat, charStat, character); } // 0xC4BB08EE7907471E 0x3F8E893B
	static Hash _GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(int index, BOOL spStat, BOOL charStat, int character) { return invoke<Hash>(0xD16C2AD6B8E32854, index, spStat, charStat, character); } // 0xD16C2AD6B8E32854 0xFB93C5A2
	...
	static void PLAYSTATS_BACKGROUND_SCRIPT_ACTION(char* action, int value) { invoke<Void>(0x5009DFD741329729, action, value); } // 0x5009DFD741329729 0x61ECC465
	...
	static void _PLAYSTATS_START_OFFLINE_MODE() { invoke<Void>(0x098760C7461724CD); } // 0x098760C7461724CD 0x896CDF8D
	...
	static BOOL _0x6DEE77AFF8C21BD1(Any* playerAccountId, Any* posixTime) { return invoke<BOOL>(0x6DEE77AFF8C21BD1, playerAccountId, posixTime); } // 0x6DEE77AFF8C21BD1 0x489E27E7
	...
	static void _PLAYSTATS_CRATE_DROP(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x1CAE5D2E3F9A07F0, p0, p1, p2, p3, p4, p5); } // 0x1CAE5D2E3F9A07F0 0x6602CED6
	...
	static void _PLAYSTATS_HOLD_UP(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xCB00196B31C39EB1, p0, p1, p2, p3); } // 0xCB00196B31C39EB1 0x759E0EC9
	static void _PLAYSTATS_IMP_EXP(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x2B69F5074C894811, p0, p1, p2, p3); } // 0x2B69F5074C894811 0x62073DF7
	...
	static void PLAYSTATS_WEAPON_MODE_CHANGE(Any weaponHash, Any componentHashTo, Any componentHashFrom) { invoke<Void>(0xE95C8A1875A02CA4, weaponHash, componentHashTo, componentHashFrom); } // 0xE95C8A1875A02CA4 0x79716890
	...
	static void _PLAYSTATS_HEIST_SAVE_CHEAT(Any hash, int p1) { invoke<Void>(0xF4FF020A08BC8863, hash, p1); } // 0xF4FF020A08BC8863
	static void _PLAYSTATS_DIRECTOR_MODE(Any* p0) { invoke<Void>(0x46326E13DA4E0546, p0); } // 0x46326E13DA4E0546
	...
	static Any LEADERBOARDS_READ_ANY_PENDING() { return invoke<Any>(0xA31FD15197B192BD); } // 0xA31FD15197B192BD 0x1789437B
	...
	static BOOL LEADERBOARDS2_READ_RANK_PREDICTION(Any* p0, Any* p1, Any* p2) { return invoke<BOOL>(0xC38DC1E90D22547C, p0, p1, p2); } // 0xC38DC1E90D22547C 0x9BEC3401
	static BOOL _LEADERBOARDS2_READ_BY_PLATFORM(Any* p0, char* gamerHandleCsv, char* platformName) { return invoke<BOOL>(0xF1AE5DCDBFCA2721, p0, gamerHandleCsv, platformName); } // 0xF1AE5DCDBFCA2721
	...
	static void LEADERBOARDS_WRITE_ADD_COLUMN(Any p0, Any p1, float p2) { invoke<Void>(0x0BCA1D2C47B0D269, p0, p1, p2); } // 0x0BCA1D2C47B0D269 0x7524E27B
	static void LEADERBOARDS_WRITE_ADD_COLUMN_LONG(Any p0, Any p1, Any p2) { invoke<Void>(0x2E65248609523599, p0, p1, p2); } // 0x2E65248609523599 0x1C5CCC3A
	...
	static Any LEADERBOARDS_GET_CACHE_NUMBER_OF_ROWS(Any p0) { return invoke<Any>(0x58A651CD201D89AD, p0); } // 0x58A651CD201D89AD 0xCE7CB520
	...
	static void _UPDATE_STAT_INT(char* statHash, int value, int p2) { invoke<Void>(0x11FF1C80276097ED, statHash, value, p2); } // 0x11FF1C80276097ED 0x4AC39C6C
	static void _UPDATE_STAT_FLOAT(Any statHash, float value, int p2) { invoke<Void>(0x30A6614C1F7799B8, statHash, value, p2); } // 0x30A6614C1F7799B8 0x3E69E7C3
	...
	static BOOL LEADERBOARDS2_WRITE_DATA_FOR_EVENT_TYPE(Any* p0, Any* p1) { return invoke<BOOL>(0xC980E62E33DF1D5C, p0, p1); } // 0xC980E62E33DF1D5C 0x62C19A3D
	...
	static BOOL _STAT_MIGRATE_SAVE(char* platformName) { return invoke<BOOL>(0xA5C80D8E768A9E66, platformName); } // 0xA5C80D8E768A9E66
	...
	static Any STAT_SAVE_MIGRATION_STATUS_START() { return invoke<Any>(0xC70DDCE56D0D3A99); } // 0xC70DDCE56D0D3A99 0x54E775E0
	static Any STAT_GET_SAVE_MIGRATION_STATUS(Any* data) { return invoke<Any>(0x886913BBEACA68C1, data); } // 0x886913BBEACA68C1 0xE3F0D62D
	static Any _STAT_SAVE_MIGRATION_CANCEL() { return invoke<Any>(0x4FEF53183C3C6414); } // 0x4FEF53183C3C6414
	static Any _STAT_GET_CANCEL_SAVE_MIGRATION_STATUS() { return invoke<Any>(0x567384DFA67029E6); } // 0x567384DFA67029E6
	static BOOL _STAT_SAVE_MIGRATION_CONSUME_CONTENT_UNLOCK(Any contentId, char* srcPlatform, char* srcGamerHandle) { return invoke<BOOL>(0x3270F67EED31FBC1, contentId, srcPlatform, srcGamerHandle); } // 0x3270F67EED31FBC1
	static Any _STAT_GET_SAVE_MIGRATION_CONSUME_CONTENT_UNLOCK_STATUS(Any* p0) { return invoke<Any>(0xCE5AA445ABA8DEE0, p0); } // 0xCE5AA445ABA8DEE0
	...
	static void _SET_HAS_CONTENT_UNLOCKS_FLAGS(int value) { invoke<Void>(0xDAC073C7901F9E15, value); } // 0xDAC073C7901F9E15
	static void _SET_SAVE_MIGRATION_TRANSACTION_ID(int transactionId) { invoke<Void>(0xF6792800AC95350D, transactionId); } // 0xF6792800AC95350D
}
...
namespace MOBILE
{
	...
	static BOOL _NET_GAMESERVER_CATALOG_ITEM_EXISTS(char* name) { return invoke<BOOL>(0xBD4D7EAF8A30F637, name); } // 0xBD4D7EAF8A30F637
	static BOOL _NET_GAMESERVER_CATALOG_ITEM_EXISTS_HASH(Hash hash) { return invoke<BOOL>(0x247F0F73A182EA0B, hash); } // 0x247F0F73A182EA0B
}
...
namespace PATHFIND
{
	...
	static void _SET_ALL_PATHS_CACHE_BOUNDINGSTRUCT(BOOL toggle) { invoke<Void>(0x228E5C6AD4D74BFD, toggle); } // 0x228E5C6AD4D74BFD 0xD6A3B458
	static BOOL _ARE_PATH_NODES_LOADED_IN_AREA(float p0, float p1, float p2, float p3) { return invoke<BOOL>(0xF7B79A50B905A30D, p0, p1, p2, p3); } // 0xF7B79A50B905A30D 0x86E80A17
	static BOOL _REQUEST_PATHS_PREFER_ACCURATE_BOUNDINGSTRUCT(float x1, float y1, float x2, float y2) { return invoke<BOOL>(0x07FB139B592FA687, x1, y1, x2, y2); } // 0x07FB139B592FA687 0x2CDA5012
	...
	static void SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(float multiplier) { invoke<Void>(0x0B919E1FB47CC4E0, multiplier); } // 0x0B919E1FB47CC4E0 0x3C5085E4
	...
	static Vector3* GENERATE_DIRECTIONS_TO_COORD(float x, float y, float z, BOOL p3, float* p4, float* p5, float* p6) { return invoke<Vector3*>(0xF90125F1F79ECDF8, x, y, z, p3, p4, p5, p6); } // 0xF90125F1F79ECDF8 0xED35C094
	static void SET_IGNORE_NO_GPS_FLAG(BOOL ignore) { invoke<Void>(0x72751156E7678833, ignore); } // 0x72751156E7678833 0xB72CF194
	static void _SET_IGNORE_SECONDARY_ROUTE_NODES(BOOL toggle) { invoke<Void>(0x1FC289A0C3FF470F, toggle); } // 0x1FC289A0C3FF470F 0x90DF7A4C
	...
	static Any GET_GPS_BLIP_ROUTE_LENGTH() { return invoke<Any>(0xBBB45C3CF5C8AA85); } // 0xBBB45C3CF5C8AA85 0x4B770634
	static Any GET_GPS_BLIP_ROUTE_FOUND() { return invoke<Any>(0x869DAACBBE9FA006); } // 0x869DAACBBE9FA006 0x286F82CC
	static Any _GET_POINT_ON_ROAD_SIDE(float x, float y, float z, int p3, Vector3* outPosition) { return invoke<Any>(0x16F46FB18C8009E4, x, y, z, p3, outPosition); } // 0x16F46FB18C8009E4 0xF6422F9A
	...
	static int GET_NEXT_GPS_DISABLED_ZONE_INDEX(int index) { return invoke<int>(0xD3A6A0EF48823A8C, index); } // 0xD3A6A0EF48823A8C
	static void SET_GPS_DISABLED_ZONE_AT_INDEX(float x1, float y1, float z1, float x2, float y2, float z2, int index) { invoke<Void>(0xD0BC1C6FB18EE154, x1, y1, z1, x2, y2, z2, index); } // 0xD0BC1C6FB18EE154
	static void CLEAR_GPS_DISABLED_ZONE_AT_INDEX(int index) { invoke<Void>(0x2801D0012266DF07, index); } // 0x2801D0012266DF07
	...
	static float _GET_HEIGHTMAP_TOP_Z_FOR_POSITION(float x, float y) { return invoke<float>(0x29C24BFBED8AB8FB, x, y); } // 0x29C24BFBED8AB8FB 0x3FE8C5A0
	static float _GET_HEIGHTMAP_TOP_Z_FOR_AREA(float x1, float y1, float x2, float y2) { return invoke<float>(0x8ABE8608576D9CE3, x1, y1, x2, y2); } // 0x8ABE8608576D9CE3 0x3ED21C90
	static float _GET_HEIGHTMAP_BOTTOM_Z_FOR_POSITION(float x, float y) { return invoke<float>(0x336511A34F2E5185, x, y); } // 0x336511A34F2E5185 0xA07C5B7D
	static float _GET_HEIGHTMAP_BOTTOM_Z_FOR_AREA(float x1, float y1, float x2, float y2) { return invoke<float>(0x3599D741C9AC6310, x1, y1, x2, y2); } // 0x3599D741C9AC6310 0x76751DD4
...
namespace CONTROLS
{
	...
	static float GET_CONTROL_UNBOUND_NORMAL(int padIndex, int control) { return invoke<float>(0x5B84D09CEC5209C5, padIndex, control); } // 0x5B84D09CEC5209C5 0xC49343BB
	...
	static float GET_DISABLED_CONTROL_UNBOUND_NORMAL(int padIndex, int control) { return invoke<float>(0x4F8A26A890FD62FB, padIndex, control); } // 0x4F8A26A890FD62FB 0xF2A65A4C
	static int _GET_TIME_SINCE_LAST_INPUT(int inputGroup) { return invoke<int>(0xD7D22F5592AED8BA, inputGroup); } // 0xD7D22F5592AED8BA 0x0E8EF929
	...
	static char* GET_CONTROL_GROUP_INSTRUCTIONAL_BUTTON(int padIndex, int controlGroup, BOOL p2) { return invoke<char*>(0x80C2FD58D720C801, padIndex, controlGroup, p2); } // 0x80C2FD58D720C801 0x3EE71F6A
	static void _SET_CONTROL_GROUP_COLOR(int padIndex, int red, int green, int blue) { invoke<Void>(0x8290252FFF36ACB5, padIndex, red, green, blue); } // 0x8290252FFF36ACB5
	...
	static int _GET_LOCAL_PLAYER_AIM_STATE_2() { return invoke<int>(0x59B9A7AF4C95133C); } // 0x59B9A7AF4C95133C
	static BOOL GET_IS_USING_ALTERNATE_DRIVEBY() { return invoke<BOOL>(0x0F70731BACCFBB96); } // 0x0F70731BACCFBB96
	static BOOL GET_ALLOW_MOVEMENT_WHILE_ZOOMED() { return invoke<BOOL>(0xFC859E2374407556); } // 0xFC859E2374407556
	...
	static BOOL _SWITCH_TO_INPUT_MAPPING_SCHEME(char* name) { return invoke<BOOL>(0x3D42B92563939375, name); } // 0x3D42B92563939375 0xD2C80B2E
	static BOOL _SWITCH_TO_INPUT_MAPPING_SCHEME_2(char* name) { return invoke<BOOL>(0x4683149ED1DDE7A1, name); } // 0x4683149ED1DDE7A1 0xBBFC9050
	static void _RESET_INPUT_MAPPING_SCHEME() { invoke<Void>(0x643ED62D5EA3BEBD); } // 0x643ED62D5EA3BEBD 0x42140FF9
	static void _DISABLE_INPUT_GROUP(int inputGroup) { invoke<Void>(0x7F4724035FDCA1DD, inputGroup); } // 0x7F4724035FDCA1DD 0x2CEDE6C5
}

namespace DATAFILE
{
	static void DATAFILE_WATCH_REQUEST_ID(int id) { invoke<Void>(0xAD6875BBC0FC899C, id); } // 0xAD6875BBC0FC899C 0x621388FF
	static void DATAFILE_CLEAR_WATCH_LIST() { invoke<Void>(0x6CC86E78358D5119); } // 0x6CC86E78358D5119
	static BOOL DATAFILE_IS_VALID_REQUEST_ID(int index) { return invoke<BOOL>(0xFCCAE5B92A830878, index); } // 0xFCCAE5B92A830878
	static BOOL DATAFILE_HAS_LOADED_FILE_DATA(Any p0) { return invoke<BOOL>(0x15FF52B809DB2353, p0); } // 0x15FF52B809DB2353
	static BOOL DATAFILE_HAS_VALID_FILE_DATA(Any p0) { return invoke<BOOL>(0xF8CC1EBE0B62E29F, p0); } // 0xF8CC1EBE0B62E29F
	static BOOL DATAFILE_SELECT_ACTIVE_FILE(Any p0) { return invoke<BOOL>(0x22DA66936E0FFF37, p0); } // 0x22DA66936E0FFF37 0xB41064A4
	static BOOL DATAFILE_DELETE_REQUESTED_FILE(Any p0) { return invoke<BOOL>(0x8F5EA1C01D65A100, p0); } // 0x8F5EA1C01D65A100 0x9DB63CFF
	static BOOL UGC_CREATE_CONTENT(char* data, BOOL dataCount, char* contentName, char* description, char* tagsCsv, char* contentTypeName, BOOL publish) { return invoke<BOOL>(0xC84527E235FCA219, data, dataCount, contentName, description, tagsCsv, contentTypeName, publish); } // 0xC84527E235FCA219 0xF09157B0
	static BOOL UGC_CREATE_MISSION(char* contentName, char* description, char* tagsCsv, char* contentTypeName, BOOL publish) { return invoke<BOOL>(0xA5EFC3E847D60507, contentName, description, tagsCsv, contentTypeName, publish); } // 0xA5EFC3E847D60507 0xD96860FC
	static BOOL UGC_UPDATE_CONTENT(char* contentId, Any* data, BOOL dataCount, char* contentName, char* description, char* tagsCsv, char* contentTypeName) { return invoke<BOOL>(0x648E7A5434AF7969, contentId, data, dataCount, contentName, description, tagsCsv, contentTypeName); } // 0x648E7A5434AF7969 0x459F2683
	static BOOL UGC_UPDATE_MISSION(char* contentId, char* contentName, char* description, char* tagsCsv, char* contentTypeName) { return invoke<BOOL>(0x4645DE9980999E93, contentId, contentName, description, tagsCsv, contentTypeName); } // 0x4645DE9980999E93 0xDBB83E2B
	static BOOL UGC_SET_PLAYER_DATA(char* contentId, float rating, char* contentTypeName) { return invoke<BOOL>(0x692D808C34A82143, contentId, rating, contentTypeName); } // 0x692D808C34A82143 0xBB6321BD
	static BOOL DATAFILE_SELECT_UGC_DATA(int p0) { return invoke<BOOL>(0xA69AC4ADE82B57A4, p0); } // 0xA69AC4ADE82B57A4 0xE8D56DA2
	static BOOL DATAFILE_SELECT_UGC_STATS(int p0, BOOL p1) { return invoke<BOOL>(0x9CB0BFA7A9342C3D, p0, p1); } // 0x9CB0BFA7A9342C3D 0xCB6A351E
	static BOOL DATAFILE_SELECT_UGC_PLAYER_DATA(int p0) { return invoke<BOOL>(0x52818819057F2B40, p0); } // 0x52818819057F2B40 0xA4D1B30E
	static BOOL DATAFILE_SELECT_CREATOR_STATS(int p0) { return invoke<BOOL>(0x01095C95CD46B624, p0); } // 0x01095C95CD46B624 0xB8515B2F
	...
	static void DATAFILE_STORE_MISSION_HEADER() { invoke<Void>(0x2ED61456317B8178); } // 0x2ED61456317B8178 0x4E03F632
	static void DATAFILE_FLUSH_MISSION_HEADER() { invoke<Void>(0xC55854C7D7274882); } // 0xC55854C7D7274882 0xF11F956F
	static char* DATAFILE_GET_FILE_DICT() { return invoke<char*>(0x906B778CA1DC72B6); } // 0x906B778CA1DC72B6 0x86DDF9C2
	static BOOL DATAFILE_START_SAVE_TO_CLOUD(char* filename) { return invoke<BOOL>(0x83BCCE3224735F05, filename); } // 0x83BCCE3224735F05 0x768CBB35
	static BOOL DATAFILE_UPDATE_SAVE_TO_CLOUD(BOOL* p0) { return invoke<BOOL>(0x4DFDD9EB705F8140, p0); } // 0x4DFDD9EB705F8140 0x0B4087F7
...
namespace FIRE
{
	...
	static Any IS_EXPLOSION_ACTIVE_IN_AREA(int explosionType, float x1, float y1, float z1, float x2, float y2, float z2) { return invoke<Any>(0x6070104B699B2EF4, explosionType, x1, x1, z1, x2, y2, z2); } // 0x6070104B699B2EF4
...
namespace ROPE
{
	...
	static void ROPE_SET_UPDATE_ORDER(int ropeId, Any p1) { invoke<Void>(0xDC57A637A20006ED, ropeId, p1); } // 0xDC57A637A20006ED 0x80DB77A7
	static void _0x36CCB9BE67B970FD(int ropeId, BOOL p1) { invoke<Void>(0x36CCB9BE67B970FD, ropeId, p1); } // 0x36CCB9BE67B970FD 0xC67D5CF6
	static BOOL _0x84DE3B5FB3E666F0(Any* ropeId) { return invoke<BOOL>(0x84DE3B5FB3E666F0, ropeId); } // 0x84DE3B5FB3E666F0 0x7A18BB9C
	...
	static BOOL _DOES_ROPE_BELONG_TO_THIS_SCRIPT(int ropeId) { return invoke<BOOL>(0x271C9D3ACA5D6409, ropeId); } // 0x271C9D3ACA5D6409
	static void _0xBC0CE682D4D05650(int ropeId, int p1, float p2, float p3, float p4, float p5, float p6, float p7, float p8, float p9, float p10, float p11, float p12, float p13) { invoke<Void>(0xBC0CE682D4D05650, ropeId, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13); } // 0xBC0CE682D4D05650 0x106BA127
	...
	static void _0xB743F735C03D7810(int ropeId, int p1) { invoke<Void>(0xB743F735C03D7810, ropeId, p1); } // 0xB743F735C03D7810 0x686672DD
...
namespace WORLDPROBE
{
	...
	static Any START_SHAPE_TEST_BOUNDING_BOX(Entity entity, int flags1, int flags2) { return invoke<Any>(0x052837721A854EC7, entity, flags1, flags2); } // 0x052837721A854EC7 0xCEEAD94B
	static Any START_SHAPE_TEST_BOX(float x, float y, float z, float x1, float y2, float z2, float rotX, float rotY, float rotZ, Any p9, Any p10, Any entity, Any p12) { return invoke<Any>(0xFE466162C4401D18, x, y, z, x1, y2, z2, rotX, rotY, rotZ, p9, p10, entity, p12); } // 0xFE466162C4401D18 0x249BC876
	static Any START_SHAPE_TEST_BOUND(Entity entity, int flags1, int flags2) { return invoke<Any>(0x37181417CE7C8900, entity, flags1, flags2); } // 0x37181417CE7C8900 0x13BC46C0
	...
	static int START_SHAPE_TEST_SWEPT_SPHERE(float x1, float y1, float z1, float x2, float y2, float z2, float radius, int flags, Entity entity, Any p9) { return invoke<int>(0xE6AC6C45FBE83004, x1, y1, z1, x2, y2, z2, radius, flags, entity, p9); } // 0xE6AC6C45FBE83004 0x4559460A
	static Any _START_SHAPE_TEST_SURROUNDING_COORDS(Vector3* pVec1, Vector3* pVec2, int flag, Entity entity, int flag2) { return invoke<Any>(0xFF6BE494C7987F34, pVec1, pVec2, flag, entity, flag2); } // 0xFF6BE494C7987F34
	...
	static int _GET_SHAPE_TEST_RESULT_EX(int rayHandle, BOOL* hit, Vector3* endCoords, Vector3* surfaceNormal, Hash* _materialHash, Entity* entityHit) { return invoke<int>(0x65287525D951F6BE, rayHandle, hit, endCoords, surfaceNormal, _materialHash, entityHit); } // 0x65287525D951F6BE 0x4301E10C
	static void RELEASE_SCRIPT_GUID_FROM_ENTITY(Entity entity) { invoke<Void>(0x2B3334BCA57CD799, entity); } // 0x2B3334BCA57CD799 0xEC2AAF06
}
...
namespace NETWORK
{
	...
	static Any NETWORK_HAS_SOCIAL_CLUB_ACCOUNT() { return invoke<Any>(0x67A5589628E0CFF6); } // 0x67A5589628E0CFF6 0x66EC713F
	...
	static BOOL _NETWORK_HAS_AGE_RESTRICTED_PROFILE() { return invoke<BOOL>(0x1353F87E89946207); } // 0x1353F87E89946207
	static BOOL NETWORK_HAVE_USER_CONTENT_PRIVILEGES(Any p0) { return invoke<BOOL>(0x72D918C99BCACC54, p0); } // 0x72D918C99BCACC54 0x1F88819D
	...
	static Any NETWORK_GET_AGE_GROUP() { return invoke<Any>(0x9614B71F8ADB982B); } // 0x9614B71F8ADB982B
	static Any _NETWORK_HAVE_ONLINE_PRIVILEGE_2() { return invoke<Any>(0x5EA784D197556507); } // 0x5EA784D197556507
	...
	static Any NETWORK_JOIN_PREVIOUSLY_FAILED_SESSION() { return invoke<Any>(0x59DF79317F85A7E0); } // 0x59DF79317F85A7E0
	static Any NETWORK_JOIN_PREVIOUSLY_FAILED_TRANSITION() { return invoke<Any>(0xFFE1E5B792D92B34); } // 0xFFE1E5B792D92B34
	static void NETWORK_SESSION_SET_MATCHMAKING_GROUP(int matchmakingGroup) { invoke<Void>(0x49EC8030F5015F8B, matchmakingGroup); } // 0x49EC8030F5015F8B 0x3C3E2AB6
	static void NETWORK_SESSION_SET_MATCHMAKING_GROUP_MAX(int playerType, int playerCount) { invoke<Void>(0x8B6A4DD0AF9CE215, playerType, playerCount); } // 0x8B6A4DD0AF9CE215 0x5F29A7E0
	static int NETWORK_SESSION_GET_MATCHMAKING_GROUP_FREE(int p0) { return invoke<int>(0x56CE820830EF040B, p0); } // 0x56CE820830EF040B 0x36EAD960
	static void _0xCAE55F48D3D7875C(int p0) { invoke<Void>(0xCAE55F48D3D7875C, p0); } // 0xCAE55F48D3D7875C 0x5BE529F7
	...
	static void NETWORK_SESSION_SET_MATCHMAKING_PROPERTY_ID(BOOL p0) { invoke<Void>(0x3F52E880AAF6C8CA, p0); } // 0x3F52E880AAF6C8CA 0xB3D9A67F
	static void NETWORK_SESSION_SET_MATCHMAKING_MENTAL_STATE(Any p0) { invoke<Void>(0xF1EEA2DDA9FFA69D, p0); } // 0xF1EEA2DDA9FFA69D 0x6CC062FC
	static void _0x1153FA02A659051C() { invoke<Void>(0x1153FA02A659051C); } // 0x1153FA02A659051C 0x57F9BC83
	static void NETWORK_SESSION_VALIDATE_JOIN(BOOL p0) { invoke<Void>(0xC19F6C8E7865A6FF, p0); } // 0xC19F6C8E7865A6FF 0xF3768F90
	...
	static BOOL _NETWORK_GET_GAMER_STATUS(Any* p0) { return invoke<BOOL>(0x85A0EF54A500882C, p0); } // 0x85A0EF54A500882C 0x42BD0780
	...
	static BOOL NETWORK_GET_GAMER_STATUS_RESULT(Any* p0, Any p1) { return invoke<BOOL>(0x02A8BEC6FD9AF660, p0, p1); } // 0x02A8BEC6FD9AF660 0xB5ABC4B4
	static void NETWORK_CLEAR_GET_GAMER_STATUS() { invoke<Void>(0x86E0660E4F5C956D); } // 0x86E0660E4F5C956D 0x3F7EDBBD
	...
	static Any _NETWORK_ACCEPT_INVITE() { return invoke<Any>(0x62A0296C1BB1CEB3); } // 0x62A0296C1BB1CEB3 0x0907A6BF
	static Any NETWORK_SESSION_WAS_INVITED() { return invoke<Any>(0x23DFB504655D0CE4); } // 0x23DFB504655D0CE4 0x6A0BEA60
	...
	static void NETWORK_BLOCK_JOIN_QUEUE_INVITES(BOOL toggle) { invoke<Void>(0xCFEB8AF24FC1D0BB, toggle); } // 0xCFEB8AF24FC1D0BB
	...
	static void NETWORK_SET_SCRIPT_READY_FOR_EVENTS(BOOL toggle) { invoke<Void>(0x7AC752103856FB20, toggle); } // 0x7AC752103856FB20 0xA639DCA2
	static Any NETWORK_IS_OFFLINE_INVITE_PENDING() { return invoke<Any>(0x74698374C45701D2); } // 0x74698374C45701D2 0x70ED476A
	...
	static Any NETWORK_SESSION_GET_PRIVATE_SLOTS() { return invoke<Any>(0x53AFD64C6758F2F9); } // 0x53AFD64C6758F2F9
	...
	static void NETWORK_SESSION_VOICE_CONNECT_TO_PLAYER(Any* globalPtr) { invoke<Void>(0xABD5E88B8A2D3DB2, globalPtr); } // 0xABD5E88B8A2D3DB2 0x9DFD89E6
	...
	static void NETWORK_SESSION_VOICE_SET_TIMEOUT(int timeout) { invoke<Void>(0x5B8ED3DB018927B1, timeout); } // 0x5B8ED3DB018927B1 0x6EFC2FD0
	static Any NETWORK_SESSION_IS_IN_VOICE_SESSION() { return invoke<Any>(0x855BC38818F6F684); } // 0x855BC38818F6F684 0x60AA4AA1
	static Any _0xB5D3453C98456528() { return invoke<Any>(0xB5D3453C98456528); } // 0xB5D3453C98456528
	static BOOL NETWORK_SESSION_IS_VOICE_SESSION_BUSY() { return invoke<BOOL>(0xEF0912DDF7C4CB4B); } // 0xEF0912DDF7C4CB4B 0x132CA01E
	static Any NETWORK_SEND_TEXT_MESSAGE(char* message, int* networkHandle) { return invoke<Any>(0x3A214F2EC889B100, message, networkHandle); } // 0x3A214F2EC889B100 0xAFFEA720
	...
	static BOOL NETWORK_IS_ACTIVITY_SPECTATOR_FROM_HANDLE(Player* networkHandle) { return invoke<BOOL>(0x2763BBAA72A7BCB9, networkHandle); } // 0x2763BBAA72A7BCB9 0x58F1DF7D
	...
	static Any NETWORK_IS_TRANSITION_CLOSED_FRIENDS() { return invoke<Any>(0x6512765E3BE78C50); } // 0x6512765E3BE78C50
	static Any NETWORK_IS_TRANSITION_CLOSED_CREW() { return invoke<Any>(0x0DBD5D7E3C5BEC3B); } // 0x0DBD5D7E3C5BEC3B
	static BOOL NETWORK_IS_TRANSITION_SOLO() { return invoke<BOOL>(0x5DC577201723960A); } // 0x5DC577201723960A
	static BOOL NETWORK_IS_TRANSITION_PRIVATE() { return invoke<BOOL>(0x5A6AA44FF8E931E6); } // 0x5A6AA44FF8E931E6
	...
	static void NETWORK_APPLY_TRANSITION_PARAMETER_STRING(int p0, char* string, BOOL p2) { invoke<Void>(0xEBEFC2E77084F599, p0, string, p2); } // 0xEBEFC2E77084F599 0xE0C28DB5
	static BOOL NETWORK_SEND_TRANSITION_GAMER_INSTRUCTION(int* netHandle, char* p1, int p2, int p3, BOOL p4) { return invoke<BOOL>(0x31D1D2B858D25E6B, netHandle, p1, p2, p3, p4); } // 0x31D1D2B858D25E6B 0x468B0884
	...
	static BOOL NETWORK_IS_TRANSITION_HOST_FROM_HANDLE(int* netHandle) { return invoke<BOOL>(0x6B5C83BA3EFE6A10, netHandle); } // 0x6B5C83BA3EFE6A10 0x0E2854C4
	static BOOL NETWORK_GET_TRANSITION_HOST(int* netHandle) { return invoke<BOOL>(0x65042B9774C4435E, netHandle); } // 0x65042B9774C4435E 0x73098D40
	...
	static Any NETWORK_IS_TRANSITION_OPEN_TO_MATCHMAKING() { return invoke<Any>(0x37A4494483B9F5C9); } // 0x37A4494483B9F5C9 0xC901AA9F
	static void NETWORK_SET_TRANSITION_VISIBILITY_LOCK(BOOL p0, BOOL p1) { invoke<Void>(0x0C978FDA19692C2C, p0, p1); } // 0x0C978FDA19692C2C
	static Any NETWORK_IS_TRANSITION_VISIBILITY_LOCKED() { return invoke<Any>(0xD0A484CB2F829FBE); } // 0xD0A484CB2F829FBE
	...
	static BOOL _NETWORK_SEND_PRESENCE_INVITE(Any* theirNetHandle, Any* p1, Any p2, Any p3) { return invoke<BOOL>(0xC3C7A6AFDB244624, theirNetHandle, p1, p2, p3); } // 0xC3C7A6AFDB244624 0x8B99B72B
	...
	static Any NETWORK_GET_PRESENCE_INVITE_CONTENT_ID(Any p0) { return invoke<Any>(0x24409FC4C55CB22D, p0); } // 0x24409FC4C55CB22D 0xA4302183
	static Any NETWORK_GET_PRESENCE_INVITE_PLAYLIST_LENGTH(Any p0) { return invoke<Any>(0xD39B3FFF8FFDD5BF, p0); } // 0xD39B3FFF8FFDD5BF 0x51B2D848
	static Any NETWORK_GET_PRESENCE_INVITE_PLAYLIST_CURRENT(Any p0) { return invoke<Any>(0x728C4CC7920CD102, p0); } // 0x728C4CC7920CD102 0x4677C656
	static BOOL NETWORK_GET_PRESENCE_INVITE_FROM_ADMIN(Any p0) { return invoke<BOOL>(0x3DBF2DF0AEB7D289, p0); } // 0x3DBF2DF0AEB7D289 0xF5E3401C
	static BOOL NETWORK_GET_PRESENCE_INVITE_IS_TOURNAMENT(Any p0) { return invoke<BOOL>(0x8806CEBFABD3CE05, p0); } // 0x8806CEBFABD3CE05 0x7D593B4C
	...
	static void _NETWORK_SET_INVITE_ON_CALL_FOR_INVITE_MENU(Any* p0) { invoke<Void>(0x66F010A4B031A331, p0); } // 0x66F010A4B031A331
	static BOOL _NETWORK_CHECK_DATA_MANAGER_SUCCEEDED_FOR_HANDLE(Any p0, Any* p1) { return invoke<BOOL>(0x44B37CDCAE765AAE, p0, p1); } // 0x44B37CDCAE765AAE
	...
	static BOOL _NETWORK_SET_CURRENT_DATA_MANAGER_HANDLE(Any* p0) { return invoke<BOOL>(0x796A87B3B68D1F3D, p0); } // 0x796A87B3B68D1F3D
	//static BOOL NETWORK_IS_IN_PLATFORM_PARTY() { return invoke<BOOL>(0x2FC5650B0271CB57); } // 0x2FC5650B0271CB57 0xA812B6CB
	static int _NETWORK_GET_PLATFORM_PARTY_UNK() { return invoke<int>(0x01ABCE5E7CBDA196); } // 0x01ABCE5E7CBDA196
	static int NETWORK_GET_PLATFORM_PARTY_MEMBERS(Any* data, int dataSize) { return invoke<int>(0x120364DE2845DAF8, data, dataSize); } // 0x120364DE2845DAF8 0xF30E5814
	static Any NETWORK_IS_IN_PLATFORM_PARTY_CHAT() { return invoke<Any>(0xFD8B834A8BA05048); } // 0xFD8B834A8BA05048 0xC6609191
	static BOOL NETWORK_IS_CHATTING_IN_PLATFORM_PARTY(Player* networkHandle) { return invoke<BOOL>(0x8DE9945BCC9AEC52, networkHandle); } // 0x8DE9945BCC9AEC52 0x51367B34
	...
	static BOOL _TRIGGER_SCRIPT_CRC_CHECK_ON_PLAYER(Player player, int p1, Hash scriptHash) { return invoke<BOOL>(0x46FB3ED415C7641C, player, p1, scriptHash); } // 0x46FB3ED415C7641C 0xF9A51B92
	...
	static void NETWORK_APPLY_PED_SCAR_DATA(Ped ped, int p1) { invoke<Void>(0xE66C690248F11150, ped, p1); } // 0xE66C690248F11150 0x4818ACD0
	...
	static void NETWORK_FINISH_BROADCASTING_DATA() { invoke<Void>(0x64F62AFB081E260D); } // 0x64F62AFB081E260D 0xA71A1D2A
	...
	static int NETWORK_GET_TOTAL_NUM_PLAYERS() { return invoke<int>(0xCF61D4B4702EE9EB); } // 0xCF61D4B4702EE9EB 0xF4F13B06
	...
	static BOOL NETWORK_IS_SCRIPT_ACTIVE(char* scriptName, Any p1, BOOL p2, Any p3) { return invoke<BOOL>(0x9D40DF90FAD26098, scriptName, p1, p2, p3); } // 0x9D40DF90FAD26098 0x4A65250C
	...
	static BOOL NETWORK_IS_PLAYER_A_PARTICIPANT_ON_SCRIPT(Player p0, char* script, Player p2) { return invoke<BOOL>(0x1AD5B71586B94820, p0, script, p2); } // 0x1AD5B71586B94820 0xCEA55F4C
	...
	static void NETWORK_DISABLE_INVINCIBLE_FLASHING(int participantID, BOOL p1) { invoke<Void>(0x9DD368BF06983221, participantID, p1); } // 0x9DD368BF06983221 0x8D27280E
	static void NETWORK_SET_LOCAL_PLAYER_SYNC_LOOK_AT(BOOL toggle) { invoke<Void>(0x524FF0AEFF9C3973, toggle); } // 0x524FF0AEFF9C3973 0xB72F086D
	...
	static BOOL NETWORK_IS_DOOR_NETWORKED(Hash doorHash) { return invoke<BOOL>(0xC01E93FAC20C3346, doorHash); } // 0xC01E93FAC20C3346
	...
	static Hash NETWORK_HASH_FROM_PLAYER_HANDLE(Player player) { return invoke<Hash>(0xBC1D768F2F5D6C05, player); } // 0xBC1D768F2F5D6C05
	...
	static BOOL NETWORK_PLAYER_INDEX_IS_CHEATER(Player player) { return invoke<BOOL>(0x565E430DB3B05BEC, player); } // 0x565E430DB3B05BEC 0xD265B049
	...
	static BOOL NETWORK_ADD_FRIEND(Any* p0, char* p1) { return invoke<BOOL>(0x8E02D73914064223, p0, p1); } // 0x8E02D73914064223 0x20E5B3EE
	...
	static void NETWORK_SET_PLAYER_IS_PASSIVE(BOOL toggle) { invoke<Void>(0x1B857666604B1A74, toggle); } // 0x1B857666604B1A74
	static BOOL NETWORK_GET_PLAYER_OWNS_WAYPOINT(Player player) { return invoke<BOOL>(0x82377B65E943F72D, player); } // 0x82377B65E943F72D 0xB802B671
	...
	static BOOL NETWORK_IS_LOCAL_TALKING() { return invoke<BOOL>(0xC0D2AF00BCC234CA); } // 0xC0D2AF00BCC234CA
	...
	static BOOL _NETWORK_CAN_VIEW_GAMER_USER_CONTENT(Any* networkHandle) { return invoke<BOOL>(0xB57A49545BA53CE7, networkHandle); } // 0xB57A49545BA53CE7
	static BOOL _NETWORK_HAS_VIEW_GAMER_USER_CONTENT_RESULT(Any* networkHandle) { return invoke<BOOL>(0xCCA4318E1AB03F1F, networkHandle); } // 0xCCA4318E1AB03F1F
	static BOOL _NETWORK_CAN_PLAY_MULTIPLAYER_WITH_GAMER(Any* networkHandle) { return invoke<BOOL>(0x07DD29D5E22763F1, networkHandle); } // 0x07DD29D5E22763F1
	static BOOL _NETWORK_CAN_GAMER_PLAY_MULTIPLAYER_WITH_ME(Any* networkHandle) { return invoke<BOOL>(0x135F9B7B7ADD2185, networkHandle); } // 0x135F9B7B7ADD2185
	...
	static void NETWORK_OVERRIDE_TEAM_RESTRICTIONS(int team, BOOL toggle) { invoke<Void>(0x6F697A66CE78674E, team, toggle); } // 0x6F697A66CE78674E 0xC8CC9E75
	...
	static void NETWORK_SET_NO_SPECTATOR_CHAT(BOOL toggle) { invoke<Void>(0xF46A1E03E8755980, toggle); } // 0xF46A1E03E8755980 0xD33AFF79
	...
	static void NETWORK_OVERRIDE_SEND_RESTRICTIONS(Player player, BOOL toggle) { invoke<Void>(0x97DD4C5944CC2E6A, player, toggle); } // 0x97DD4C5944CC2E6A
	static void NETWORK_OVERRIDE_SEND_RESTRICTIONS_ALL(BOOL toggle) { invoke<Void>(0x57B192B4D4AD23D5, toggle); } // 0x57B192B4D4AD23D5 0x2F98B405
	...
	static void NETWORK_OVERRIDE_RECEIVE_RESTRICTIONS_ALL(BOOL toggle) { invoke<Void>(0x0FF2862B61A58AF9, toggle); } // 0x0FF2862B61A58AF9 0x1BCD3DDF
	...
	static void NETWORK_CLEAR_VOICE_PROXIMITY_OVERRIDE() { invoke<Void>(0xF03755696450470C); } // 0xF03755696450470C 0x7F9B9052
	...
	static Any NETWORK_GET_TIMEOUT_TIME() { return invoke<Any>(0x5ED0356A0CE3A34F); } // 0x5ED0356A0CE3A34F 0xE1F86C6A
	...
	static BOOL NETWORK_CLAN_PLAYER_IS_ACTIVE(int* netHandle) { return invoke<BOOL>(0xB124B57F571D8F18, netHandle); } // 0xB124B57F571D8F18 0xAB8319A3
	static BOOL NETWORK_CLAN_PLAYER_GET_DESC(int* desc, int p1, int* netHandle) { return invoke<BOOL>(0xEEE6EACBE8874FBA, desc, p1, netHandle); } // 0xEEE6EACBE8874FBA 0x6EE4A282
	static BOOL NETWORK_CLAN_IS_ROCKSTAR_CLAN(int* clanDesc, int bufferSize) { return invoke<BOOL>(0x7543BB439F63792B, clanDesc, bufferSize); } // 0x7543BB439F63792B 0x54E79E9C
	static void NETWORK_CLAN_GET_UI_FORMATTED_TAG(int* clanDesc, int bufferSize, int* formattedTag) { invoke<Void>(0xF45352426FF3A4F0, clanDesc, bufferSize, formattedTag); } // 0xF45352426FF3A4F0 0xF633805A
	static int NETWORK_CLAN_GET_LOCAL_MEMBERSHIPS_COUNT() { return invoke<int>(0x1F471B79ACC90BEF); } // 0x1F471B79ACC90BEF 0x807B3450
	static BOOL NETWORK_CLAN_GET_MEMBERSHIP_DESC(int* memberDesc, Any p1) { return invoke<BOOL>(0x48DE78AF2C8885B8, memberDesc, p1); } // 0x48DE78AF2C8885B8 0x3369DD1F
	static BOOL NETWORK_CLAN_DOWNLOAD_MEMBERSHIP(int* netHandle) { return invoke<BOOL>(0xA989044E70010ABE, netHandle); } // 0xA989044E70010ABE 0x8E8CB520
	...
	static BOOL NETWORK_CLAN_JOIN(int clanHandle) { return invoke<BOOL>(0x9FAAA4F4FC71F87F, clanHandle); } // 0x9FAAA4F4FC71F87F 0x79C916C5
	...
	static BOOL NETWORK_CLAN_GET_EMBLEM_TXD_NAME(Player* netHandle, Any* txdName) { return invoke<BOOL>(0x5835D9CD92E83184, netHandle, txdName); } // 0x5835D9CD92E83184 0xBA672146
	static BOOL NETWORK_CLAN_REQUEST_EMBLEM(Any p0) { return invoke<BOOL>(0x13518FF1C6B28938, p0); } // 0x13518FF1C6B28938 0x7963FA4D
	static BOOL NETWORK_CLAN_IS_EMBLEM_READY(Any p0, Any* p1) { return invoke<BOOL>(0xA134777FF7F33331, p0, p1); } // 0xA134777FF7F33331 0x88B13CDC
	static void NETWORK_CLAN_RELEASE_EMBLEM(Any p0) { invoke<Void>(0x113E6E3E50E286B0, p0); } // 0x113E6E3E50E286B0 0xD6E3D5EA
	...
	static void SET_NETWORK_CUTSCENE_ENTITIES(BOOL toggle) { invoke<Void>(0xAAA553E7DD28A457, toggle); } // 0xAAA553E7DD28A457
	...
	static BOOL IS_NETWORK_ID_OWNED_BY_PARTICIPANT(int netId) { return invoke<BOOL>(0xA1607996431332DF, netId); } // 0xA1607996431332DF 0xEA5176C0
	...
	static BOOL NETWORK_IS_PLAYER_FADING(Player player) { return invoke<BOOL>(0x631DC5DFF4B110E3, player); } // 0x631DC5DFF4B110E3
	static BOOL NETWORK_IS_ENTITY_FADING(Entity entity) { return invoke<BOOL>(0x422F32CC7E56ABAD, entity); } // 0x422F32CC7E56ABAD
	...
	static Any GET_MAX_NUM_NETWORK_PEDS() { return invoke<Any>(0x0C1F7D49C39D2289); } // 0x0C1F7D49C39D2289 0x744AC008
	static Any GET_MAX_NUM_NETWORK_VEHICLES() { return invoke<Any>(0x0AFCE529F69B21FF); } // 0x0AFCE529F69B21FF 0xC3A12135
	static Any GET_MAX_NUM_NETWORK_PICKUPS() { return invoke<Any>(0xA72835064DD63E4C); } // 0xA72835064DD63E4C 0x6A036061
	static int GET_NETWORK_TIME() { return invoke<int>(0x7A5487FE9FAA6B48); } // 0x7A5487FE9FAA6B48 0x998103C2
	static int GET_NETWORK_TIME_ACCURATE() { return invoke<int>(0x89023FBBF9200E9F); } // 0x89023FBBF9200E9F 0x98AA48E5
	...
	static void NETWORK_SET_IN_SPECTATOR_MODE(BOOL active, Player playerPed) { invoke<Void>(0x423DE3854BB50894, active, playerPed); } // 0x423DE3854BB50894 0x5C4C8458
	...
	static void NETWORK_SET_IN_FREE_CAM_MODE(BOOL toggle) { invoke<Void>(0xFC18DB55AE19E046, toggle); } // 0xFC18DB55AE19E046 0xA7E36020
	static void NETWORK_SET_CHOICE_MIGRATE_OPTIONS(BOOL toggle, Player player) { invoke<Void>(0x5C707A667DF8B9FA, toggle, player); } // 0x5C707A667DF8B9FA 0x64235620
	...
	static void SET_NETWORK_VEHICLE_AS_GHOST(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x6274C4712850841E, vehicle, toggle); } // 0x6274C4712850841E 0xEA235081
	...
	static Any NETWORK_QUERY_RESPAWN_RESULTS(Any* p0) { return invoke<Any>(0x3C891A251567DFCE, p0); } // 0x3C891A251567DFCE 0x90700C7D
	...
	static Any NETWORK_GET_RESPAWN_RESULT_FLAGS(Any p0) { return invoke<Any>(0x6C34F1208B8923FD, p0); } // 0x6C34F1208B8923FD 0x03287FD2
	static void NETWORK_START_SOLO_TUTORIAL_SESSION() { invoke<Void>(0x17E0198B3882C2CB); } // 0x17E0198B3882C2CB 0x408A9436
	...
	static BOOL NETWORK_IS_TUTORIAL_SESSION_CHANGE_PENDING() { return invoke<BOOL>(0x35F0B98A8387274D); } // 0x35F0B98A8387274D 0xA003C40B
	static int NETWORK_GET_PLAYER_TUTORIAL_SESSION_INSTANCE(Player player) { return invoke<int>(0x3B39236746714134, player); } // 0x3B39236746714134 0x5E1020CC
	...
	static void NETWORK_CONCEAL_PLAYER(Player player, BOOL toggle, BOOL p2) { invoke<Void>(0xBBDF066252829606, player, toggle, p2); } // 0xBBDF066252829606 0x72052DB3
	static BOOL NETWORK_IS_PLAYER_CONCEALED(Player player) { return invoke<BOOL>(0x919B3C98ED8292F9, player); } // 0x919B3C98ED8292F9 0xB0313590
	...
	static Any NETWORK_ADD_ENTITY_DISPLAYED_BOUNDARIES(float p0, float p1, float p2, float p3, float p4, float p5) { return invoke<Any>(0x25B99872D588A101, p0, p1, p2, p3, p4, p5); } // 0x25B99872D588A101 0x4C2C2B12
	static BOOL NETWORK_REMOVE_ENTITY_AREA(Any p0) { return invoke<BOOL>(0x93CF869BAA0C4874, p0); } // 0x93CF869BAA0C4874 0xEAB97F25
	static BOOL NETWORK_ENTITY_AREA_DOES_EXIST(int areaHandle) { return invoke<BOOL>(0xE64A3CA08DFA37A9, areaHandle); } // 0xE64A3CA08DFA37A9 0x69956127
	static BOOL _0x4DF7CFFF471A7FB1(Any p0) { return invoke<BOOL>(0x4DF7CFFF471A7FB1, p0); } // 0x4DF7CFFF471A7FB1 0xCB1CD6D3
	static BOOL NETWORK_ENTITY_AREA_IS_OCCUPIED(int areaHandle) { return invoke<BOOL>(0x4A2D4E8BF4265B0F, areaHandle); } // 0x4A2D4E8BF4265B0F 0xC6D53AA0
	...
	static int NETWORK_GET_TUNABLE_CLOUD_CRC() { return invoke<int>(0x10BD227A753B0D84); } // 0x10BD227A753B0D84 0x231CFD12
	...
	static int _0x7DB53B37A2F211A0() { return invoke<int>(0x7DB53B37A2F211A0); } // 0x7DB53B37A2F211A0 0x053BB329
	static void NETWORK_RESET_BODY_TRACKER() { invoke<Void>(0x72433699B4E6DD64); } // 0x72433699B4E6DD64 0x3914463F
	static int _NETWORK_GET_NUM_BODY_TRACKERS() { return invoke<int>(0xD38C4A6D047C019D); } // 0xD38C4A6D047C019D 0x17CBC608
	...
	static void NETWORK_OVERRIDE_COORDS_AND_HEADING(Entity entity, float x, float y, float z, float heading) { invoke<Void>(0xA7E30DE9272B6D49, entity, x, y, z, heading); } // 0xA7E30DE9272B6D49 0x644141C5
	static void NETWORK_DISABLE_PROXIMITY_MIGRATION(int netID) { invoke<Void>(0x407091CF6037118E, netID); } // 0x407091CF6037118E
	...
	static void NETWORK_CACHE_LOCAL_PLAYER_HEAD_BLEND_DATA() { invoke<Void>(0xBD0BE0BFC927EAC1); } // 0xBD0BE0BFC927EAC1
	static BOOL NETWORK_HAS_CACHED_PLAYER_HEAD_BLEND_DATA(Player player) { return invoke<BOOL>(0x237D5336A9A54108, player); } // 0x237D5336A9A54108
	static BOOL NETWORK_APPLY_CACHED_PLAYER_HEAD_BLEND_DATA(Ped ped, Player player) { return invoke<BOOL>(0x99B72C7ABDE5C910, ped, player); } // 0x99B72C7ABDE5C910
	static int GET_NUM_COMMERCE_ITEMS() { return invoke<int>(0xF2EAC213D5EA0623); } // 0xF2EAC213D5EA0623 0x965EA007
	static BOOL IS_COMMERCE_DATA_VALID() { return invoke<BOOL>(0xEA14EEF5B7CD2C30); } // 0xEA14EEF5B7CD2C30 0xEEFC8A55
	...
	static char* GET_COMMERCE_ITEM_ID(int index) { return invoke<char*>(0x662635855957C411, index); } // 0x662635855957C411 0x4ACF110C
	static char* GET_COMMERCE_ITEM_NAME(Any p0) { return invoke<char*>(0xB4271092CA7EDF48, p0); } // 0xB4271092CA7EDF48 0x1AA3A0D5
	static Any GET_COMMERCE_PRODUCT_PRICE(int index) { return invoke<Any>(0xCA94551B50B4932C, index); } // 0xCA94551B50B4932C 0x37877757
	static int GET_COMMERCE_ITEM_NUM_CATS(int index) { return invoke<Any>(0x2A7776C709904AB0, index); } // 0x2A7776C709904AB0 0x1CF89DA5
	static char* GET_COMMERCE_ITEM_CAT(int index, int index2) { return invoke<char*>(0x6F44CBF56D79FAC0, index, index2); } // 0x6F44CBF56D79FAC0 0x16E53875
	static void OPEN_COMMERCE_STORE(char* p0, char* p1) { invoke<Void>(0x58C21165F6545892, p0, p1); } // 0x58C21165F6545892 0x365C50EE
	static BOOL IS_COMMERCE_STORE_OPEN() { return invoke<BOOL>(0x2EAC52B4019E2782); } // 0x2EAC52B4019E2782 0x25E2DBA9
	static void SET_STORE_ENABLED(BOOL toggle) { invoke<Void>(0x9641A9FF718E9C5E, toggle); } // 0x9641A9FF718E9C5E 0xC1F6443B
	static BOOL REQUEST_COMMERCE_ITEM_IMAGE(int index) { return invoke<BOOL>(0xA2F952104FC6DD4B, index); } // 0xA2F952104FC6DD4B 0x1FDC75DC
	static void RELEASE_ALL_COMMERCE_ITEM_IMAGES() { invoke<Void>(0x72D0706CD6CCDB58); } // 0x72D0706CD6CCDB58 0xCA7A0A49
	static char* GET_COMMERCE_ITEM_TEXTURENAME(int index) { return invoke<char*>(0x722F5D28B61C5EA8, index); } // 0x722F5D28B61C5EA8 0x44A58B0A
	static BOOL IS_STORE_AVAILABLE_TO_USER() { return invoke<BOOL>(0x883D79C4071E18B3); } // 0x883D79C4071E18B3 0xD32FA11F
	...
	static int CLOUD_DELETE_MEMBER_FILE(char* p0) { return invoke<int>(0xC64DED7EF0D2FE37, p0); } // 0xC64DED7EF0D2FE37 0x2B7B57B3
	static BOOL CLOUD_HAS_REQUEST_COMPLETED(int handle) { return invoke<BOOL>(0x4C61B39930D045DA, handle); } // 0x4C61B39930D045DA 0xBAF52DD8
	static BOOL CLOUD_DID_REQUEST_SUCCEED(int handle) { return invoke<BOOL>(0x3A3D5568AF297CD5, handle); } // 0x3A3D5568AF297CD5 0x9B9AFFF1
	static void CLOUD_CHECK_AVAILABILITY() { invoke<Void>(0x4F18196C8D38768D); } // 0x4F18196C8D38768D 0xC38E9DB0
	static BOOL CLOUD_IS_CHECKING_AVAILABILITY() { return invoke<BOOL>(0xC7ABAC5DE675EE3B); } // 0xC7ABAC5DE675EE3B 0x32A4EB22
	...
	//static void _CLEAR_LAUNCH_PARAMS() { invoke<Void>(0x966DD84FB6A46017); } // 0x966DD84FB6A46017
	static BOOL UGC_COPY_CONTENT(Any* p0, Any* p1) { return invoke<BOOL>(0x152D90E4C1B4738A, p0, p1); } // 0x152D90E4C1B4738A 0x08243B79
	static Any _0x9FEDF86898F100E9() { return invoke<Any>(0x9FEDF86898F100E9); } // 0x9FEDF86898F100E9 0x798D6C27
	static Any UGC_HAS_CREATE_FINISHED() { return invoke<Any>(0x5E24341A7F92A74B); } // 0x5E24341A7F92A74B 0xE69E8D0D
	static Any _0x24E4E51FC16305F9() { return invoke<Any>(0x24E4E51FC16305F9); } // 0x24E4E51FC16305F9 0x742075FE
	static Any UGC_GET_CREATE_RESULT() { return invoke<Any>(0xFBC5E768C7A77A6A); } // 0xFBC5E768C7A77A6A 0xCE569932
	static Any UGC_GET_CREATE_CONTENT_ID() { return invoke<Any>(0xC55A0B40FFB1ED23); } // 0xC55A0B40FFB1ED23 0x82146BE9
	static void UGC_CLEAR_CREATE_RESULT() { invoke<Void>(0x17440AA15D1D3739); } // 0x17440AA15D1D3739 0x133FF2D5
	static BOOL UGC_QUERY_MY_CONTENT(Any p0, Any p1, Any* p2, Any p3, Any p4, Any p5) { return invoke<BOOL>(0x9BF438815F5D96EA, p0, p1, p2, p3, p4, p5); } // 0x9BF438815F5D96EA 0xCBA7242F
	...
	static BOOL UGC_QUERY_BY_CONTENT_ID(char* contentId, BOOL latestVersion, char* contentTypeName) { return invoke<BOOL>(0x158EC424F35EC469, contentId, latestVersion, contentTypeName); } // 0x158EC424F35EC469 0xDED82A6E
	static BOOL UGC_QUERY_BY_CONTENT_IDS(Any* data, int count, BOOL latestVersion, char* contentTypeName) { return invoke<BOOL>(0xC7397A83F7A2A462, data, count, latestVersion, contentTypeName); } // 0xC7397A83F7A2A462
	static BOOL _UGC_QUERY_RECENTLY_CREATED_CONTENT(int offset, int count, char* contentTypeName, int p3) { return invoke<BOOL>(0x6D4CB481FAC835E8, offset, count, contentTypeName, p3); } // 0x6D4CB481FAC835E8 0x40CF0783
	static BOOL UGC_GET_BOOKMARKED_CONTENT(Any p0, Any p1, Any* p2, Any* p3) { return invoke<BOOL>(0xD5A4B59980401588, p0, p1, p2, p3); } // 0xD5A4B59980401588 0x4609D596
	static BOOL UGC_GET_MY_CONTENT(Any p0, Any p1, Any* p2, Any* p3) { return invoke<BOOL>(0x3195F8DD0D531052, p0, p1, p2, p3); } // 0x3195F8DD0D531052 0x4C2C0D1F
	static BOOL UGC_GET_FRIEND_CONTENT(Any p0, Any p1, Any* p2, Any* p3) { return invoke<BOOL>(0xF9E1CCAE8BA4C281, p0, p1, p2, p3); } // 0xF9E1CCAE8BA4C281 0x9EFBD5D1
	static BOOL UGC_GET_CREW_CONTENT(Any p0, Any p1, Any p2, Any* p3, Any* p4) { return invoke<BOOL>(0x9F6E2821885CAEE2, p0, p1, p2, p3, p4); } // 0x9F6E2821885CAEE2 0xA6D8B798
	static BOOL UGC_GET_GET_BY_CATEGORY(Any p0, Any p1, Any p2, Any* p3, Any* p4) { return invoke<BOOL>(0x678BB03C1A3BD51E, p0, p1, p2, p3, p4); } // 0x678BB03C1A3BD51E 0x67E74842
	...
	static void UGC_CANCEL_QUERY() { invoke<Void>(0xE9B99B6853181409); } // 0xE9B99B6853181409 0x021D5A94
	static Any UGC_IS_GETTING() { return invoke<Any>(0xD53ACDBEF24A46E8); } // 0xD53ACDBEF24A46E8 0x4908A514
	static Any UGC_HAS_GET_FINISHED() { return invoke<Any>(0x02ADA21EA2F6918F); } // 0x02ADA21EA2F6918F 0x50296140
	...
	static Any UGC_GET_QUERY_RESULT() { return invoke<Any>(0xEDF7F927136C224B); } // 0xEDF7F927136C224B 0xCC2356E3
	static Any UGC_GET_CONTENT_NUM() { return invoke<Any>(0xE0A6138401BCB837); } // 0xE0A6138401BCB837 0x2DE69817
	static Any UGC_GET_CONTENT_TOTAL() { return invoke<Any>(0x769951E2455E2EB5); } // 0x769951E2455E2EB5 0x81BD8D3B
	static Any UGC_GET_CONTENT_HASH() { return invoke<Any>(0x3A17A27D75C74887); } // 0x3A17A27D75C74887 0x8E1D8F78
	static void UGC_CLEAR_QUERY_RESULTS() { invoke<Void>(0xBA96394A0EECFA65); } // 0xBA96394A0EECFA65 0x0D35DD93
	...
	static Any UGC_GET_CONTENT_USER_NAME(Any p0) { return invoke<Any>(0x703F12425ECA8BF5, p0); } // 0x703F12425ECA8BF5 0xB9137BA7
	...
	static Any UGC_GET_CONTENT_NAME(Any p0) { return invoke<Any>(0xBF09786A7FCAB582, p0); } // 0xBF09786A7FCAB582 0xA5A0C695
	static int _GET_CONTENT_DESCRIPTION_HASH(Any p0) { return invoke<int>(0x7CF0448787B23758, p0); } // 0x7CF0448787B23758 0x91534C6E
	static char* UGC_GET_CONTENT_PATH(int p0, Any p1) { return invoke<char*>(0xBAF6BABF9E7CCC13, p0, p1); } // 0xBAF6BABF9E7CCC13 0x744A9EA5
	static void UGC_GET_CONTENT_UPDATED_DATE(Any p0, Any* p1) { invoke<Void>(0xCFD115B373C0DF63, p0, p1); } // 0xCFD115B373C0DF63 0xA19A238D
	...
	static Any UGC_GET_CONTENT_LANGUAGE(Any p0) { return invoke<Any>(0x32DD916F3F7C9672, p0); } // 0x32DD916F3F7C9672 0xA2C5BD9D
	static BOOL UGC_GET_CONTENT_IS_PUBLISHED(Any p0) { return invoke<BOOL>(0x3054F114121C21EA, p0); } // 0x3054F114121C21EA 0xA850DDE1
	static BOOL UGC_GET_CONTENT_IS_VERIFIED(Any p0) { return invoke<BOOL>(0xA9240A96C74CCA13, p0); } // 0xA9240A96C74CCA13 0x8F6754AE
	static Any UGC_GET_CONTENT_RATING(Any p0, Any p1) { return invoke<Any>(0x1ACCFBA3D8DAB2EE, p0, p1); } // 0x1ACCFBA3D8DAB2EE 0x1E34953F
	static Any UGC_GET_CONTENT_RATING_COUNT(Any p0, Any p1) { return invoke<Any>(0x759299C5BB31D2A9, p0, p1); } // 0x759299C5BB31D2A9 0x771FE190
	static Any UGC_GET_CONTENT_RATING_POSITIVE_COUNT(Any p0, Any p1) { return invoke<Any>(0x87E5C46C187FE0AE, p0, p1); } // 0x87E5C46C187FE0AE 0x3276D9D3
	static Any UGC_GET_CONTENT_RATING_NEGATIVE_COUNT(Any p0, Any p1) { return invoke<Any>(0x4E548C0D7AE39FF9, p0, p1); } // 0x4E548C0D7AE39FF9 0x41A0FB02
	static BOOL UGC_GET_CONTENT_HAS_PLAYER_RECORD(Any p0) { return invoke<BOOL>(0x70EA8DA57840F9BE, p0); } // 0x70EA8DA57840F9BE 0x11DC0F27
	static BOOL UGC_GET_CONTENT_HAS_PLAYER_BOOKMARKED(Any p0) { return invoke<BOOL>(0x993CBE59D350D225, p0); } // 0x993CBE59D350D225 0x0DEB3F5A
	static int UGC_REQUEST_CONTENT_DATA_FROM_INDEX(int p0, int p1) { return invoke<int>(0x171DF6A0C07FB3DC, p0, p1); } // 0x171DF6A0C07FB3DC 0x84315226
	static int UGC_REQUEST_CONTENT_DATA_FROM_PARAMS(char* contentTypeName, char* contentId, int p2, int p3, int p4) { return invoke<int>(0x7FD2990AF016795E, contentTypeName, contentId, p2, p3, p4); } // 0x7FD2990AF016795E 0x38FC2EEB
	static int UGC_REQUEST_CACHED_DESCRIPTION(int p0) { return invoke<int>(0x5E0165278F6339EE, p0); } // 0x5E0165278F6339EE 0x1C4F9FDB
	...
	static Any UGC_GET_CACHED_DESCRIPTION(Any p0, Any p1) { return invoke<Any>(0x40F7E66472DF3E5C, p0, p1); } // 0x40F7E66472DF3E5C 0x70A2845C
	...
	static BOOL UGC_PUBLISH(char* contentId, char* baseContentId, char* contentTypeName) { return invoke<BOOL>(0x1DE0F5F50D723CAA, contentId, baseContentId, contentTypeName); } // 0x1DE0F5F50D723CAA 0xAD334B40
	static BOOL UGC_SET_BOOKMARKED(char* contentId, BOOL bookmarked, char* contentTypeName) { return invoke<BOOL>(0x274A1519DFC1094F, contentId, bookmarked, contentTypeName); } // 0x274A1519DFC1094F 0x980D45D7
	static BOOL UGC_SET_DELETED(Any* p0, BOOL p1, Any* p2) { return invoke<BOOL>(0xD05D1A6C74DA3498, p0, p1, p2); } // 0xD05D1A6C74DA3498 0x48CCC328
	static Any _0x45E816772E93A9DB() { return invoke<Any>(0x45E816772E93A9DB); } // 0x45E816772E93A9DB 0x8E664EFD
	static Any UGC_HAS_MODIFY_FINISHED() { return invoke<Any>(0x299EF3C576773506); } // 0x299EF3C576773506 0x611E0BE2
	static Any _0x793FF272D5B365F4() { return invoke<Any>(0x793FF272D5B365F4); } // 0x793FF272D5B365F4 0xF0211AC1
	static Any UGC_GET_MODIFY_RESULT() { return invoke<Any>(0x5A0A3D1A186A5508); } // 0x5A0A3D1A186A5508 0x1F0DD8AF
	static void UGC_CLEAR_MODIFY_RESULT() { invoke<Void>(0xA1E5E0204A6FCC70); } // 0xA1E5E0204A6FCC70 0x405ECA16
	...
	static Any UGC_GET_CREATOR_NUM() { return invoke<Any>(0x597F8DBA9B206FC7); } // 0x597F8DBA9B206FC7 0x410C61D1
	static BOOL UGC_POLICIES_MAKE_PRIVATE(Any p0) { return invoke<BOOL>(0x5CAE833B0EE0C500, p0); } // 0x5CAE833B0EE0C500 0x0D4F845D
	static void UGC_CLEAR_OFFLINE_QUERY() { invoke<Void>(0x61A885D3F7CFEE9A); } // 0x61A885D3F7CFEE9A 0xE13C1F7F
	...
	static BOOL UGC_IS_LANGUAGE_SUPPORTED(Any p0) { return invoke<BOOL>(0xF53E48461B71EECB, p0); } // 0xF53E48461B71EECB 0xB4668B23
	...
	static int TITLE_TEXTURE_DOWNLOAD_REQUEST(char* FilePath, char* Name, BOOL p2) { return invoke<Any>(0x0B203B4AFDE53A4F, FilePath, Name, p2); } // 0x0B203B4AFDE53A4F 0x1856D008
	static Any UGC_TEXTURE_DOWNLOAD_REQUEST(Any* p0, Any p1, Any p2, Any p3, Any* p4, BOOL p5) { return invoke<Any>(0x308F96458B7087CC, p0, p1, p2, p3, p4, p5); } // 0x308F96458B7087CC 0x68C9AF69
	...
	static int _GET_STATUS_OF_TEXTURE_DOWNLOAD(int p0) { return invoke<int>(0x8BD6C6DEA20E82C6, p0); } // 0x8BD6C6DEA20E82C6 0x03225BA3
	static BOOL _0x60EDD13EB3AC1FF3() { return invoke<BOOL>(0x60EDD13EB3AC1FF3); } // 0x60EDD13EB3AC1FF3 0x4DEBC227
	static BOOL NETWORK_IS_CABLE_CONNECTED() { return invoke<BOOL>(0xEFFB25453D8600F9); } // 0xEFFB25453D8600F9 0x5C065D55
	static BOOL _NETWORK_GET_ROS_PRIVILEGE_9() { return invoke<BOOL>(0x66B59CFFD78467AF); } // 0x66B59CFFD78467AF 0x0CA1167F
	static BOOL NETWORK_HAVE_ROS_SOCIAL_CLUB_PRIV() { return invoke<BOOL>(0x606E4D3E3CCCF3EB); } // 0x606E4D3E3CCCF3EB 0x424C6E27
	...
	static BOOL NETWORK_HAVE_ROS_LEADERBOARD_WRITE_PRIV() { return invoke<BOOL>(0x422D396F80A96547); } // 0x422D396F80A96547 0xC6EA802E
	static BOOL NETWORK_HAS_ROS_PRIVILEGE(Any p0) { return invoke<BOOL>(0xA699957E60D80214, p0); } // 0xA699957E60D80214 0xFD261E30
	static BOOL NETWORK_HAS_ROS_PRIVILEGE_END_DATE(int p0, int* banType, Vector3* timeData) { return invoke<BOOL>(0xC22912B1D85F26B1, p0, banType, timeData); } // 0xC22912B1D85F26B1 0x8570DD34
	static BOOL _NETWORK_GET_ROS_PRIVILEGE_24() { return invoke<BOOL>(0x593570C289A77688); } // 0x593570C289A77688
	static BOOL _NETWORK_GET_ROS_PRIVILEGE_25() { return invoke<BOOL>(0x91B87C55093DE351); } // 0x91B87C55093DE351
	...
	static void _0xC505036A35AFD01B(BOOL toggle) { invoke<Void>(0xC505036A35AFD01B, toggle); } // 0xC505036A35AFD01B 0xA100CC97
...
namespace NETWORKCASH
{
	...
	static void NETWORK_GIVE_PLAYER_JOBSHARE_CASH(int amount, int* netHandle) { invoke<Void>(0xFB18DF9CB95E0105, amount, netHandle); } // 0xFB18DF9CB95E0105 0xC6047FDB
	static void NETWORK_RECEIVE_PLAYER_JOBSHARE_CASH(int value, int* netHandle) { invoke<Void>(0x56A3B51944C50598, value, netHandle); } // 0x56A3B51944C50598 0x4ED71C1A
	...
	static void _NETWORK_EARN_FROM_BAG(int amount) { invoke<Void>(0xF514621E8EA463D0, amount); } // 0xF514621E8EA463D0 0x30B3EC0A
	...
	static void NETWORK_EARN_FROM_MISSION_H(Any p0, Any* p1) { invoke<Void>(0x61326EE6DF15B0CA, p0, p1); } // 0x61326EE6DF15B0CA 0x5E81F55C
	...
	static void NETWORK_EARN_FROM_BOUNTY(int amount, int* netHandle, Any* p2, Any p3) { invoke<Void>(0x131BB5DA15453ACF, amount, netHandle, p2, p3); } // 0x131BB5DA15453ACF 0x127F2DAE
	...
	static void NETWORK_PAY_MATCH_ENTRY_FEE(int amount, int* matchId, BOOL p2, BOOL p3) { invoke<Void>(0x9346E14F2AF74D46, amount, matchId, p2, p3); } // 0x9346E14F2AF74D46 0x224A3488
	...
	static void NETWORK_SPENT_ROBBED_BY_MUGGER(int  p0, BOOL p1, BOOL p2) { invoke<Void>(0x995A65F15F581359, p0, p1, p2); } // 0x995A65F15F581359 0xE6AAA0D5
	...
	static char* PROCESS_CASH_GIFT(int* p0, int* p1, Any p2) { return invoke<char*>(0x20194D48EAEC9A41, p0, p1, p2); } // 0x20194D48EAEC9A41 0xC5D8B1E9
	...
	static void NETWORK_SPENT_REQUEST_HEIST(Any p0, BOOL p1, BOOL p2) { invoke<Void>(0x9D26502BB97BFE62, p0, p1, p2); } // 0x9D26502BB97BFE62
	...
	static int NETWORK_GET_VC_WALLET_BALANCE(int player) { return invoke<int>(0xA40F9C2623F6A8B5, player); } // 0xA40F9C2623F6A8B5 0x4F5B781C
	static int NETWORK_GET_VC_BALANCE() { return invoke<int>(0x5CBAD97E059E1B94); } // 0x5CBAD97E059E1B94 0xADF8F882
	static char* NETWORK_GET_STRING_BANK_BALANCE() { return invoke<char*>(0xA6FA3979BED01B81); } // 0xA6FA3979BED01B81
	static BOOL _NETWORK_GET_VC_BANK_WALLET_BALANCE_IS_NOT_LESS_THAN(int amount, int characterSlot) { return invoke<BOOL>(0xDC18531D7019A535, amount, characterSlot); } // 0xDC18531D7019A535
	...
	//static int WITHDRAW_VC(int amount) { return invoke<Any>(0xF70EFA14FE091429, amount); } // 0xF70EFA14FE091429 0x8B755993
	//static BOOL DEPOSIT_VC(int amount) { return invoke<BOOL>(0xE260E0BB9CD995AC, amount); } // 0xE260E0BB9CD995AC 0x8F266745
...
namespace DLC1
{
	...
	static BOOL _GET_TATTOO_COLLECTION_DATA(int characterType, int decorationIndex, Any* outComponent) { return invoke<BOOL>(0xFF56381874F82086, characterType, decorationIndex, outComponent); } // 0xFF56381874F82086 0x2E9D628C
	...
	static void GET_SHOP_PED_PROP(Any componentHash, Any* outProp) { invoke<Void>(0x5D5CAFF661DDF6FC, componentHash, outProp); } // 0x5D5CAFF661DDF6FC
	...
	static int GET_SHOP_PED_APPAREL_VARIANT_COMPONENT_COUNT(Hash componentHash) { return invoke<int>(0xC17AD0E5752BECDA, componentHash); } // 0xC17AD0E5752BECDA 0x159751B4
	...
	static Any GET_SHOP_PED_APPAREL_FORCED_PROP_COUNT(Any componentHash) { return invoke<Any>(0x017568A8182D98A6, componentHash); } // 0x017568A8182D98A6
	...
	static void GET_FORCED_PROP(Any componentHash, Any forcedPropIndex, Any* nameHash, Any* enumValue, Any* anchorPoint) { invoke<Void>(0xE1CA84EBF72E691D, componentHash, forcedPropIndex, nameHash, enumValue, anchorPoint); } // 0xE1CA84EBF72E691D
	static BOOL DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Hash componentHash, Hash restrictionTagHash, int componentId) { return invoke<BOOL>(0x341DE7ED1D2A1BFD, componentHash, restrictionTagHash, componentId); } // 0x341DE7ED1D2A1BFD 0x8E2C7FD5
	...
	static BOOL GET_SHOP_PED_OUTFIT_PROP_VARIANT(Any outfit, int slot, Any* item) { return invoke<BOOL>(0xA9F9C2E0FDE11CBB, outfit, slot, item); } // 0xA9F9C2E0FDE11CBB 0x6641A864
	...
	static int GET_DLC_VEHICLE_MOD_LOCK_HASH(int hash) { return invoke<int>(0xC098810437312FFF, hash); } // 0xC098810437312FFF 0x59352658
}
...
namespace DLC2
{
	...
	static BOOL _0x9489659372A81585() { return invoke<BOOL>(0x9489659372A81585); } // 0x9489659372A81585 0xC2169164
	static BOOL _0xA213B11DFF526300() { return invoke<BOOL>(0xA213B11DFF526300); } // 0xA213B11DFF526300 0xF79A97F5
	static BOOL _GET_EXTRA_CONTENT_PACK_HAS_BEEN_INSTALLED() { return invoke<BOOL>(0x8D30F648014A92B5); } // 0x8D30F648014A92B5 0xF69B729C
...
{
	static int SC_INBOX_GET_TOTAL_NUM_MESSAGES() { return invoke<int>(0x03A93FF1A2CA0864); } // 0x03A93FF1A2CA0864 0x6BE5DF29
	...
	static BOOL SC_INBOX_MESSAGE_GET_DATA_INT(Any p0, char* context, int* out) { return invoke<BOOL>(0xA00EFE4082C4056E, p0, context, out); } // 0xA00EFE4082C4056E 0x88068C7C
	static BOOL _SC_INBOX_MESSAGE_GET_DATA_BOOL(Any p0, char* p1) { return invoke<BOOL>(0xFFE5C16F402D851D, p0, p1); } // 0xFFE5C16F402D851D
	static BOOL SC_INBOX_MESSAGE_GET_DATA_STRING(Any p0, char* context, char* out) { return invoke<BOOL>(0x7572EF42FC6A9B6D, p0, context, out); } // 0x7572EF42FC6A9B6D 0x15607620
	static BOOL SC_INBOX_MESSAGE_DO_APPLY(int p0) { return invoke<BOOL>(0x9A2C8064B6C1E41A, p0); } // 0x9A2C8064B6C1E41A 0xEBE420A4
	static char* _SC_INBOX_MESSAGE_GET_STRING(int p0) { return invoke<char*>(0xF3E31D16CBDCB304, p0); } // 0xF3E31D16CBDCB304 0x2C959AF9
	static void _SC_INBOX_MESSAGE_PUSH_GAMER_TO_EVENT_RECIP_LIST(int* networkHandle) { invoke<Void>(0xDA024BDBD600F44A, networkHandle); } // 0xDA024BDBD600F44A 0x0B9A3512
	static void _SC_INBOX_MESSAGE_SEND_UGC_STAT_UPDATE_EVENT(char* data) { invoke<Void>(0xA68D3D229F4F3B06, data); } // 0xA68D3D229F4F3B06 0x75324674
	...
	static BOOL _SC_INBOX_MESSAGE_SEND_BOUNTY_PRESENCE_EVENT(char* data) { return invoke<BOOL>(0x6AFD2CD753FEEF83, data); } // 0x6AFD2CD753FEEF83 0x628F489B
	static BOOL _SC_INBOX_MESSAGE_GET_BOUNTY_DATA(int index, int* outData) { return invoke<BOOL>(0x87E0052F08BD64E6, index, outData); } // 0x87E0052F08BD64E6 0xAB3346B5
	...
	static void _SET_HANDLE_ROCKSTAR_MESSAGE_VIA_SCRIPT(BOOL toggle) { invoke<Void>(0xBFA0A56A817C6C7D, toggle); } // 0xBFA0A56A817C6C7D 0x2FB9F53C
	static BOOL _IS_ROCKSTAR_MESSAGE_READY_FOR_SCRIPT() { return invoke<BOOL>(0xBC1CC91205EC8D6E); } // 0xBC1CC91205EC8D6E 0x6C5738AB
	static char* _ROCKSTAR_MESSAGE_GET_STRING() { return invoke<char*>(0xDF649C4E9AFDD788); } // 0xDF649C4E9AFDD788 0x468668F0
	static BOOL SC_PRESENCE_ATTR_SET_INT(Hash attrHash, int value) { return invoke<BOOL>(0x1F1E9682483697C7, attrHash, value); } // 0x1F1E9682483697C7 0x90C74343
	static BOOL SC_PRESENCE_ATTR_SET_STRING(Hash attrHash, char* value) { return invoke<BOOL>(0x287F1F75D2803595, attrHash, value); } // 0x287F1F75D2803595 0x3ACE6D6B
	...
	static BOOL _SC_GET_IS_PROFILE_ATTRIBUTE_SET(char* name) { return invoke<BOOL>(0x8416FE4E4629D7D7, name); } // 0x8416FE4E4629D7D7 0xDF45B2A7
	static BOOL SC_PROFANITY_CHECK_STRING(char* string, int* token) { return invoke<BOOL>(0x75632C5ECD7ED843, string, token); } // 0x75632C5ECD7ED843 0xDF084A6B
	static BOOL SC_PROFANITY_GET_CHECK_IS_VALID(int token) { return invoke<BOOL>(0x1753344C770358AE, token); } // 0x1753344C770358AE 0xFFED3676
	static int SC_PROFANITY_GET_CHECK_IS_PENDING(int token) { return invoke<int>(0x82E4A58BABC15AE7, token); } // 0x82E4A58BABC15AE7 0xA796D7A7
	static BOOL SC_PROFANITY_GET_STRING_PASSED(int token) { return invoke<BOOL>(0x85535ACF97FC0969, token); } // 0x85535ACF97FC0969 0x09497F31
	static int SC_PROFANITY_GET_STRING_STATUS(int token) { return invoke<int>(0x930DE22F07B1CCE3, token); } // 0x930DE22F07B1CCE3 0x4D8A6521
	...
	static BOOL _SC_GET_HAS_ACHIEVEMENT_BEEN_PASSED(int achievement) { return invoke<BOOL>(0x418DC16FAE452C1C, achievement); } // 0x418DC16FAE452C1C
}

namespace UNK
{
	static int _0xF2CA003F167E21D2() { return invoke<int>(0xF2CA003F167E21D2); } // 0xF2CA003F167E21D2 0x106C8317
	static BOOL _LOADINGSCREEN_GET_LOAD_FREEMODE() { return invoke<BOOL>(0xEF7D17BC6C85264C); } // 0xEF7D17BC6C85264C 0xD87F3A9E
	static void _GET_BROADCAST_FINSHED_LOS_SOUND(BOOL p0) { invoke<Void>(0xB0C56BD3D808D863, p0); } // 0xB0C56BD3D808D863 0xC0B971EA
	static BOOL _LOADINGSCREEN_GET_LOAD_FREEMODE_WITH_EVENT_NAME() { return invoke<BOOL>(0x8AA464D4E0F6ACCD); } // 0x8AA464D4E0F6ACCD 0x94BCAC7C
	...
	static void _LOADINGSCREEN_SET_IS_LOADING_FREEMODE(BOOL toggle) { invoke<Void>(0xC7E7181C09F33B69, toggle); } // 0xC7E7181C09F33B69 0x8C227332
	static void _0xFA1E0E893D915215(BOOL toggle) { invoke<Void>(0xFA1E0E893D915215, toggle); } // 0xFA1E0E893D915215 0x5C350D78
...
namespace UNK1
{
	...
	static void _DISABLE_ROCKSTAR_EDITOR_CAMERA_CHANGES() { invoke<Void>(0xAF66DCEE6609B148); } // 0xAF66DCEE6609B148
	...
	static BOOL _SAVE_RECORDING_CLIP() { return invoke<BOOL>(0x644546EC5287471B); } // 0x644546EC5287471B
...
namespace UNK3
{
	...
	static Any _LOCK_RADIO_STATION(char* radioStation, BOOL toggle) { return invoke<Any>(0x477D9DB48F889591, radioStation, toggle); } // 0x477D9DB48F889591
	...
	static BOOL _NET_GAMESERVER_IS_CATALOG_VALID() { return invoke<BOOL>(0x2B949A1E6AEC8F6A); } // 0x2B949A1E6AEC8F6A
	...
	static BOOL _NET_GAMESERVER_GET_CATALOG_STATE(Any* state) { return invoke<BOOL>(0xCF38DAFBB49EDE5E, state); } // 0xCF38DAFBB49EDE5E
	...
	static BOOL _NET_GAMESERVER_IS_SESSION_VALID(int charSlot) { return invoke<BOOL>(0xB24F0944DA203D9E, charSlot); } // 0xB24F0944DA203D9E
	...
	static BOOL _NET_GAMESERVER_IS_SESSION_REFRESH_PENDING() { return invoke<BOOL>(0x810E8431C0614BF9); } // 0x810E8431C0614BF9
	static BOOL _NET_GAMESERVER_GET_BALANCE(BOOL inventory, BOOL playerbalance) { return invoke<BOOL>(0x35A1B3E1D1315CFA, inventory, playerbalance); } // 0x35A1B3E1D1315CFA
	static BOOL _NET_GAMESERVER_GET_TRANSACTION_MANAGER_DATA(Any* p0, BOOL* p1) { return invoke<BOOL>(0x897433D292B44130, p0, p1); } // 0x897433D292B44130
	...
	static Any _NETWORK_SHOP_BASKET_ADD_ITEM(Player p0, Object p1) { return invoke<Any>(0xF30980718C8ED876, p0, p1); } // 0xF30980718C8ED876
	...
	static BOOL _NETWORK_SHOP_BEGIN_SERVICE(Any* p0, Any p1, Any p2, Any p3, Any p4, Any p5) { return invoke<BOOL>(0x3C5FD37B5499582E, p0, p1, p2, p3, p4, p5); } // 0x3C5FD37B5499582E
	static BOOL _NETWORK_SHOP_END_SERVICE(Any p0) { return invoke<BOOL>(0xE2A99A9B524BEFFF, p0); } // 0xE2A99A9B524BEFFF
	static BOOL _NET_GAMESERVER_DELETE_CHARACTER_SLOT(int slot, BOOL transfer, Any reason) { return invoke<BOOL>(0x51F1A8E48C3D2F6D, slot, transfer, reason); } // 0x51F1A8E48C3D2F6D
	static int _NET_GAMESERVER_DELETE_CHARACTER_SLOT_GET_STATUS() { return invoke<int>(0x0A6D923DFFC9BD89); } // 0x0A6D923DFFC9BD89
	static Any _NETWORK_SHOP_DELETE_SET_TELEMETRY_NONCE_SEED() { return invoke<Any>(0x112CEF1615A1139F); } // 0x112CEF1615A1139F
	static BOOL _NET_GAMESERVER_TRANSFER_BANK_TO_WALLET(int charSlot, int amount) { return invoke<BOOL>(0xD47A2C1BA117471D, charSlot, amount); } // 0xD47A2C1BA117471D
	static BOOL _NET_GAMESERVER_TRANSFER_WALLET_TO_BANK(int charSlot, int amount) { return invoke<BOOL>(0xC2F7FE5309181C7D, charSlot, amount); } // 0xC2F7FE5309181C7D
	static int _NET_GAMESERVER_TRANSFER_CASH_GET_STATUS() { return invoke<int>(0x23789E777D14CE44); } // 0x23789E777D14CE44
	static int _NET_GAMESERVER_TRANSFER_CASH_GET_STATUS_2() { return invoke<int>(0x350AA5EBC03D3BD2); } // 0x350AA5EBC03D3BD2
